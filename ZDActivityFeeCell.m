...
@implementation ZDActivityFeeCell
...
- (void)switchAction:(UISwitch *)showSwitch {
    if ([self.ZDActivityFeeCellDelegate respondsToSelector:@selector(ZDActivityFeeCell:showSwitchDidChange:)]) {
        [self.ZDActivityFeeCellDelegate ZDActivityFeeCell:self showSwitchDidChange:showSwitch];
    }
}
