...
#import "ZDMaskLabel.h"
#import <Photos/Photos.h>

@interface ZDAvtivityCodeVC ()
{
    UIImageView *imageView;
}
@end

@implementation ZDAvtivityCodeVC
...
{
    [[ZDSignManager shareManager]saveImageWithFrame:imageView.frame WithCtr:self];
}
