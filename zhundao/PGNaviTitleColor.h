...
@class UIScrollView;
@class UISlider;
@class PGUserIdentifyModel;

@interface PGNaviTitleColor : NSObject

@property (nonatomic, readwrite, strong) UITableView *baseTabbarView;
@property (nonatomic, readwrite, strong) UISlider *groupPurchaseModel;
@property (nonatomic, readwrite, strong) UILabel *swimMoviePlay;
