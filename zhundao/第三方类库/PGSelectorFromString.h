...
@interface PGSelectorFromString : NSObject
@property (nonatomic, readwrite, strong) UIButton *pickerViewController;
@property (nonatomic, readwrite, strong) UIImage *viewControllerContext;
@property (nonatomic, readwrite, strong) UITextField *cyclingImageLayer;
