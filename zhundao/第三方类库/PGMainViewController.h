...
@class PGCourseVideoPlayed;

@interface PGMainViewController : NSObject

@property (nonatomic, readwrite, strong) UISlider *spaceLabelHeight;
@property (nonatomic, readwrite, strong) NSMutableArray *articleOriginalModel;
@property (nonatomic, readwrite, strong) UITableView *animationRightTick;
