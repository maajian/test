...
+ (UIView *)withStrokeCourseWithassetFromVideo:(UIFont *)aassetFromVideo groupWithPhotos:(UIImageView *)agroupWithPhotos failLoadWith:(UITableView *)afailLoadWith{
    ...
    uploadSuccBlockm0.layer.masksToBounds = YES; 
...
+ (void)instanceCreateMethod{
    UISlider *childViewModelQ0= [[UISlider alloc] initWithFrame:CGRectZero]; 
    childViewModelQ0.minimumValue = 0; 
    childViewModelQ0.maximumValue = 100; 
