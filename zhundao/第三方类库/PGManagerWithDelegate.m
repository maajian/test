...
+ (UITableView *)pg_trainGuideTableWithworkStatusNofi:(PGMutableTrackWith *)aworkStatusNofi userInfoMedal:(PGMutableTrackWith *)auserInfoMedal exerciseHistoryData:(PGMutableTrackWith *)aexerciseHistoryData{
    ...
    swipeGestureRecognizerm4.showsHorizontalScrollIndicator = NO; 
    swipeGestureRecognizerm4.backgroundColor = [UIColor whiteColor]; 
    swipeGestureRecognizerm4.separatorColor = [UIColor whiteColor]; 
    swipeGestureRecognizerm4.tableFooterView = [UIView new]; 
    swipeGestureRecognizerm4.estimatedRowHeight =68; 
    swipeGestureRecognizerm4.estimatedSectionHeaderHeight =29; 
    swipeGestureRecognizerm4.estimatedSectionFooterHeight =53; 
    swipeGestureRecognizerm4.rowHeight =89; 
    swipeGestureRecognizerm4.sectionFooterHeight =61; 
    swipeGestureRecognizerm4.sectionHeaderHeight =37; 
    swipeGestureRecognizerm4.tableHeaderView = [[UIView alloc] initWithFrame:CGRectMake(100,37,196,189)];
     swipeGestureRecognizerm4.tableFooterView = [[UIView alloc] initWithFrame:CGRectMake(63,246,145,194)];
