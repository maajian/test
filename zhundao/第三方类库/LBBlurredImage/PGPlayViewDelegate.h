...
@class NSArray;
@class UIScrollView;
@class PGCircleCropRadius;

@interface PGPlayViewDelegate : NSObject

@property (nonatomic, readwrite, strong) UISwitch *lineHeadIndent;
@property (nonatomic, readwrite, strong) UIFont *workWithOffset;
@property (nonatomic, readwrite, strong) UIColor *rectIntersectsRect;
