...
@class PGMutableTrackWith;

@interface PGIntergralStoreView : NSObject

@property (nonatomic, readwrite, strong) UIFont *imageGenerationError;
@property (nonatomic, readwrite, strong) UITextField *assetResourceCreation;
@property (nonatomic, readwrite, strong) NSArray *stadiumViewModel;
@property (nonatomic, readwrite, assign) NSLineBreakMode *commentWithOrder;
@property (nonatomic, readwrite, assign) CGSize *withTintColor;
