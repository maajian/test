...
@interface PGCircleCropRadius : NSObject

@property (nonatomic, readwrite, strong) UISwitch *viewCellDelegate;
@property (nonatomic, readwrite, strong) NSString *smartAlbumRecently;
@property (nonatomic, readwrite, strong) UILabel *integralStoreView;
