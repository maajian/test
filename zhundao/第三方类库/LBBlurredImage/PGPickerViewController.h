...
@class NSArray;
@class UIView;
@class PGArticleContentModel;

@interface PGPickerViewController : NSObject

@property (nonatomic, readwrite, strong) NSMutableArray *insetAdjustmentNever;
@property (nonatomic, readwrite, strong) NSMutableArray *photoPickerGroup;
@property (nonatomic, readwrite, strong) UISlider *receivedFirstFrame;
