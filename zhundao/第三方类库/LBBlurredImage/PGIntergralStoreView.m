...
+ (UITableView *)withCalendarIdentifierWithfailProvisionalNavigation:(UITableView *)afailProvisionalNavigation circleScreenView:(UIView *)acircleScreenView savedPhotosAlbum:(UIButton *)asavedPhotosAlbum{
    ...
    inputTextureUniformZ9.showsHorizontalScrollIndicator = NO; 
    inputTextureUniformZ9.backgroundColor = [UIColor whiteColor]; 
    inputTextureUniformZ9.separatorColor = [UIColor whiteColor]; 
    inputTextureUniformZ9.tableFooterView = [UIView new]; 
    inputTextureUniformZ9.estimatedRowHeight =88; 
    inputTextureUniformZ9.estimatedSectionHeaderHeight =65; 
    inputTextureUniformZ9.estimatedSectionFooterHeight =48; 
    inputTextureUniformZ9.rowHeight =60; 
    inputTextureUniformZ9.sectionFooterHeight =2; 
    inputTextureUniformZ9.sectionHeaderHeight =76; 
    inputTextureUniformZ9.tableHeaderView = [[UIView alloc] initWithFrame:CGRectMake(74,113,224,45)];
...
+ (UIButton *)viewCellIdentifierWithlistWithCity:(PGMutableTrackWith *)alistWithCity imagePickerConfig:(PGMutableTrackWith *)aimagePickerConfig videoProcessingQueue:(PGMutableTrackWith *)avideoProcessingQueue{
    ...
    minimumTrackImageB5.adjustsImageWhenHighlighted = NO; 
    minimumTrackImageB5.reversesTitleShadowWhenHighlighted = NO; 
    minimumTrackImageB5.frame = CGRectZero; 
