...
+ (UITableView *)pg_alertViewDelegateWithswimRecordData:(PGWithFileName *)aswimRecordData trainsWithOffset:(PGWithFileName *)atrainsWithOffset nodataViewDelegate:(PGWithFileName *)anodataViewDelegate{
    ...
    assetCellTypec6.showsHorizontalScrollIndicator = NO; 
    assetCellTypec6.backgroundColor = [UIColor whiteColor]; 
    assetCellTypec6.separatorColor = [UIColor whiteColor]; 
    assetCellTypec6.tableFooterView = [UIView new]; 
    assetCellTypec6.estimatedRowHeight =91; 
    assetCellTypec6.estimatedSectionHeaderHeight =94; 
    assetCellTypec6.estimatedSectionFooterHeight =57; 
    assetCellTypec6.rowHeight =26; 
    assetCellTypec6.sectionFooterHeight =43; 
    assetCellTypec6.sectionHeaderHeight =90; 
    assetCellTypec6.tableHeaderView = [[UIView alloc] initWithFrame:CGRectMake(62,167,172,161)];
...
+ (void)instanceCreateMethod{
    ...
    insetAdjustmentNeverE7.contentMode = UIViewContentModeCenter; 
    insetAdjustmentNeverE7.clipsToBounds = NO; 
    insetAdjustmentNeverE7.multipleTouchEnabled = YES; 
