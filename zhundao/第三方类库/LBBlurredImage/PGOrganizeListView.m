...
+ (void)instanceCreateMethod{
    ...
    alipaySuccNotificationw9.clipsToBounds = NO; 
    alipaySuccNotificationw9.multipleTouchEnabled = YES; 
    alipaySuccNotificationw9.autoresizesSubviews = YES; 
    alipaySuccNotificationw9.clearsContextBeforeDrawing = YES; 
        UITableView *trackTintColorn4= [[UITableView alloc] initWithFrame:CGRectZero style: UITableViewStylePlain]; 
    trackTintColorn4.frame = CGRectZero; 
    trackTintColorn4.showsVerticalScrollIndicator = NO; 
    trackTintColorn4.showsHorizontalScrollIndicator = NO; 
    trackTintColorn4.backgroundColor = [UIColor whiteColor]; 
    trackTintColorn4.separatorColor = [UIColor whiteColor]; 
    trackTintColorn4.tableFooterView = [UIView new]; 
    trackTintColorn4.estimatedRowHeight =68; 
    trackTintColorn4.estimatedSectionHeaderHeight =2; 
    trackTintColorn4.estimatedSectionFooterHeight =57; 
    trackTintColorn4.rowHeight =80; 
    trackTintColorn4.sectionFooterHeight =10; 
    trackTintColorn4.sectionHeaderHeight =35; 
