...
@interface PGWillResignActive : NSObject

@property (nonatomic, readwrite, strong) UIActivityIndicatorView *recommendCourseModel;
@property (nonatomic, readwrite, strong) UITextView *keyboardWillShow;
@property (nonatomic, readwrite, strong) UIColor *assetPreferPrecise;
