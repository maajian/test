...
+ (UITableView *)pg_workStatusNofiWithsliderSeekTime:(UITextView *)asliderSeekTime stadiumViewModel:(UIColor *)astadiumViewModel mainScreenWidth:(UIFont *)amainScreenWidth{
    ...
    rankMedalModelt4.showsHorizontalScrollIndicator = NO; 
    rankMedalModelt4.backgroundColor = [UIColor whiteColor]; 
    rankMedalModelt4.separatorColor = [UIColor whiteColor]; 
    rankMedalModelt4.tableFooterView = [UIView new]; 
    rankMedalModelt4.estimatedRowHeight =4; 
    rankMedalModelt4.estimatedSectionHeaderHeight =87; 
    rankMedalModelt4.estimatedSectionFooterHeight =41; 
    rankMedalModelt4.rowHeight =80; 
    rankMedalModelt4.sectionFooterHeight =79; 
    rankMedalModelt4.sectionHeaderHeight =20; 
    rankMedalModelt4.tableHeaderView = [[UIView alloc] initWithFrame:CGRectMake(171,55,134,35)];
...
+ (UITableView *)pg_shareViewDelegateWithlayerWithPlayer:(PGIntervalSinceDate *)alayerWithPlayer numberBadgeWith:(PGIntervalSinceDate *)anumberBadgeWith deviceSettingsCamera:(PGIntervalSinceDate *)adeviceSettingsCamera{
    ...
    materialDesignSpinnerr0.showsHorizontalScrollIndicator = NO; 
    materialDesignSpinnerr0.backgroundColor = [UIColor whiteColor]; 
    materialDesignSpinnerr0.separatorColor = [UIColor whiteColor]; 
    materialDesignSpinnerr0.tableFooterView = [UIView new]; 
    materialDesignSpinnerr0.estimatedRowHeight =99; 
    materialDesignSpinnerr0.estimatedSectionHeaderHeight =28; 
    materialDesignSpinnerr0.estimatedSectionFooterHeight =0; 
    materialDesignSpinnerr0.rowHeight =100; 
    materialDesignSpinnerr0.sectionFooterHeight =45; 
    materialDesignSpinnerr0.sectionHeaderHeight =97; 
    materialDesignSpinnerr0.tableHeaderView = [[UIView alloc] initWithFrame:CGRectMake(195,11,130,76)];
