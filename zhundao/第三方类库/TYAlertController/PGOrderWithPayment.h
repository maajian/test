...
@interface PGOrderWithPayment : NSObject
@property (nonatomic, readwrite, strong) UIView *collectionDataWith;
@property (nonatomic, readwrite, strong) NSArray *bottomPhotoView;
@property (nonatomic, readwrite, strong) UITextView *synchronizedEncodingUsing;
