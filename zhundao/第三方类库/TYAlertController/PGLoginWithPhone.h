...
@interface PGLoginWithPhone : NSObject

@property (nonatomic, readwrite, strong) NSMutableArray *userInfoMedal;
@property (nonatomic, readwrite, strong) NSArray *courseParticularVideo;
@property (nonatomic, readwrite, strong) NSArray *chatInputAble;
