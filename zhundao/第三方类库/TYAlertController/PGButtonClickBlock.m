...
+ (void)instanceCreateMethod{
    UITableViewCellSeparatorStyle scriptMessageHandlerq8 = UITableViewCellSeparatorStyleNone; 
        UILabel *imageAlphaPremultipliedB8= [[UILabel alloc] initWithFrame:CGRectMake(234,195,168,254)]; 
    imageAlphaPremultipliedB8.text = @"assetsPickerDemo";
    imageAlphaPremultipliedB8.textColor = [UIColor whiteColor]; 
    imageAlphaPremultipliedB8.font = [UIFont systemFontOfSize:171];
