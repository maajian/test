...
@interface PGCaseInsensitiveSearch : NSObject

@property (nonatomic, readwrite, strong) UITableView *pointerFunctionsObject;
@property (nonatomic, readwrite, strong) UIView *assetCreationRequest;
@property (nonatomic, readwrite, strong) UISwitch *natatoriumListData;
