...
@interface PGManagerWithDelegate : NSObject

@property (nonatomic, readwrite, strong) UIActivityIndicatorView *willLayoutSubviews;
@property (nonatomic, readwrite, strong) UIActivityIndicatorView *inputTextureUniform;
@property (nonatomic, readwrite, strong) UIActivityIndicatorView *cyclingImageLayer;
