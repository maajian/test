...
@interface PGAlertWithTitle : NSObject
@property (nonatomic, readwrite, strong) UILabel *cellWithIndex;
@property (nonatomic, readwrite, strong) UIColor *textFiledDelegate;
@property (nonatomic, readwrite, strong) UITextView *dailyTrainView;
