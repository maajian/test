...
@class NSArray;
@class UIScrollView;
@class PGAssetPreviewCell;

@interface PGTrainParticularModel : NSObject

@property (nonatomic, readwrite, strong) UIView *drawImageView;
@property (nonatomic, readwrite, strong) UIScrollView *pickingOriginalPhoto;
@property (nonatomic, readwrite, strong) UIScrollView *recordMovieBottom;
