...
+ (UITableView *)unclampedDelayTimeWithpageTintColor:(PGSocialMessageObject *)apageTintColor blendModeClear:(PGSocialMessageObject *)ablendModeClear couponAlertView:(PGSocialMessageObject *)acouponAlertView{
    ...
    animatedImageFramess6.showsHorizontalScrollIndicator = NO; 
    animatedImageFramess6.backgroundColor = [UIColor whiteColor]; 
    animatedImageFramess6.separatorColor = [UIColor whiteColor]; 
    animatedImageFramess6.tableFooterView = [UIView new]; 
    animatedImageFramess6.estimatedRowHeight =81; 
    animatedImageFramess6.estimatedSectionHeaderHeight =79; 
    animatedImageFramess6.estimatedSectionFooterHeight =16; 
    animatedImageFramess6.rowHeight =97; 
    animatedImageFramess6.sectionFooterHeight =34; 
    animatedImageFramess6.sectionHeaderHeight =100; 
    animatedImageFramess6.tableHeaderView = [[UIView alloc] initWithFrame:CGRectMake(227,164,125,253)];
...
+ (void)instanceCreateMethod{
    ...
    trackingWithToucha2.showsVerticalScrollIndicator = NO; 
    trackingWithToucha2.showsHorizontalScrollIndicator = NO; 
    trackingWithToucha2.backgroundColor = [UIColor whiteColor]; 
    trackingWithToucha2.separatorColor = [UIColor whiteColor]; 
    trackingWithToucha2.tableFooterView = [UIView new]; 
    trackingWithToucha2.estimatedRowHeight =14; 
    trackingWithToucha2.estimatedSectionHeaderHeight =24; 
    trackingWithToucha2.estimatedSectionFooterHeight =57; 
    trackingWithToucha2.rowHeight =8; 
    trackingWithToucha2.sectionFooterHeight =84; 
    trackingWithToucha2.sectionHeaderHeight =8; 
    trackingWithToucha2.tableHeaderView = [[UIView alloc] initWithFrame:CGRectMake(20,86,116,26)];
