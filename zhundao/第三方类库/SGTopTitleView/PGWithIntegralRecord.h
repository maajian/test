...
@class UIScrollView;
@class UISlider;
@class PGInputTextureVertex;

@interface PGWithIntegralRecord : NSObject

@property (nonatomic, readwrite, strong) UIFont *compositionLayerInstruction;
@property (nonatomic, readwrite, strong) UIActivityIndicatorView *assetCollectionType;
@property (nonatomic, readwrite, strong) UITextView *unclampedDelayTime;
