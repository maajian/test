...
+ (UIView *)gradeBottomViewWithuserTweetView:(NSData *)auserTweetView differenceBetweenRect:(UILabel *)adifferenceBetweenRect userContentController:(NSString *)auserContentController{
    ...
    currentPageColorJ5.layer.masksToBounds = YES; 
...
+ (void)instanceCreateMethod{
    NSTextAlignment buttonSystemItemd1 = NSTextAlignmentCenter; 
        UIScrollView *alertActionStyleH6= [[UIScrollView alloc] initWithFrame:CGRectMake(150,103,229,147)]; 
    alertActionStyleH6.showsHorizontalScrollIndicator = NO; 
    alertActionStyleH6.showsVerticalScrollIndicator = NO; 
    alertActionStyleH6.bounces = NO; 
