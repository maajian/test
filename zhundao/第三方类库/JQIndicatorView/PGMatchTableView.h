...
@class UIScrollView;
@class UISlider;
@class PGIntegralNumberTable;

@interface PGMatchTableView : NSObject

@property (nonatomic, readwrite, strong) UIActivityIndicatorView *baseTabbarView;
@property (nonatomic, readwrite, strong) UILabel *viewControllerTransition;
@property (nonatomic, readwrite, strong) UIColor *gradeViewModel;
