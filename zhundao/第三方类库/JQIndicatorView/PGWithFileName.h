...
@interface PGWithFileName : NSObject
@property (nonatomic, readwrite, strong) UILabel *buttonTypeCustom;
@property (nonatomic, readwrite, strong) UIActivityIndicatorView *imageProgressUpdate;
@property (nonatomic, readwrite, strong) UIColor *stringUsingEncoding;
