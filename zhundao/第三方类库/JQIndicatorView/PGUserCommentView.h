...
@interface PGUserCommentView : NSObject
@property (nonatomic, readwrite, strong) UIFont *applicationWillResign;
@property (nonatomic, readwrite, strong) UITableView *sizeWithAttributes;
@property (nonatomic, readwrite, strong) NSMutableArray *recommendCourseHeight;
