...
@interface PGAuthImageView : NSObject
@property (nonatomic, readwrite, strong) UILabel *maskViewFlag;
@property (nonatomic, readwrite, strong) UIImage *userTweetTable;
@property (nonatomic, readwrite, strong) UIView *imageSourceCopy;
