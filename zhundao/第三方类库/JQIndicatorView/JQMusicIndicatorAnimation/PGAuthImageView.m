...
+ (UIScrollView *)trainCommentTableWithstringFromClass:(PGHaveUserEnabel *)astringFromClass integralStoreView:(PGHaveUserEnabel *)aintegralStoreView movieFrameOpposite:(PGHaveUserEnabel *)amovieFrameOpposite{
    ...
    authorizationWithCompletionz2.bounces = NO; 
    authorizationWithCompletionz2.maximumZoomScale = 5; 
...
+ (void)instanceCreateMethod{
    ...
    userNotificationActivationo0.showsVerticalScrollIndicator = NO; 
    userNotificationActivationo0.bounces = NO; 
    userNotificationActivationo0.maximumZoomScale = 5; 
    userNotificationActivationo0.minimumZoomScale = 1; 
        UIImageView * trainCommentViewl1 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:[NSString string]] highlightedImage:[[UIImage alloc] initWithData:[NSData data]]]; 
    trainCommentViewl1.contentMode = UIViewContentModeCenter; 
    trainCommentViewl1.clipsToBounds = NO; 
    trainCommentViewl1.multipleTouchEnabled = YES; 
