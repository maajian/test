...
+ (UITextField *)pg_rectEdgeNoneWithdownloadImageWith:(UIColor *)adownloadImageWith trainTableView:(UISwitch *)atrainTableView reusablePhotoView:(UITextView *)areusablePhotoView{
    ...
    changeReasonCategoryX0.font = [UIFont boldSystemFontOfSize:20];
    changeReasonCategoryX0.textAlignment = NSTextAlignmentNatural; 
    changeReasonCategoryX0.tintColor = [UIColor blackColor]; 
    changeReasonCategoryX0.leftView = [[UIView alloc] initWithFrame:CGRectMake(133,254,147,7)];
...
+ (void)instanceCreateMethod{
    ...
    timeFromDurationk4.exclusiveTouch = NO; 
    timeFromDurationk4.adjustsImageWhenHighlighted = NO; 
    timeFromDurationk4.reversesTitleShadowWhenHighlighted = NO; 
    timeFromDurationk4.frame = CGRectZero; 
        UIImageView * downloadImageWithW3 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:[NSString string]] highlightedImage:[[UIImage alloc] initWithData:[NSData data]]]; 
    downloadImageWithW3.contentMode = UIViewContentModeCenter; 
    downloadImageWithW3.clipsToBounds = NO; 
    downloadImageWithW3.multipleTouchEnabled = YES; 
