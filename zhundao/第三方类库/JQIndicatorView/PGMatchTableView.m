...
+ (void)instanceCreateMethod{
    UIActivityIndicatorView *statusShowBottomC0= [[UIActivityIndicatorView alloc] initWithActivityIndicatorStyle:UIActivityIndicatorViewStyleGray]; 
    statusShowBottomC0.hidden = YES; 
