...
@interface PGBadgeTextColor : NSObject
@property (nonatomic, readwrite, strong) UIActivityIndicatorView *fragmentShaderString;
@property (nonatomic, readwrite, strong) UITableView *collectionDataWith;
@property (nonatomic, readwrite, strong) UISwitch *likesTableView;
