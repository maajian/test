...
@class UISlider;
@class PGNatatoriumParticularData;
@interface PGScrollViewDeceleration : NSObject
@property (nonatomic, readwrite, strong) NSMutableArray *requestReturnCache;
@property (nonatomic, readwrite, strong) UIColor *collectionTrainTable;
@property (nonatomic, readwrite, strong) UIColor *underlineStyleAttribute;
