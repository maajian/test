...
@interface PGCrashReportEnabled : NSObject
@property (nonatomic, readwrite, strong) UILabel *cellWithIndex;
@property (nonatomic, readwrite, strong) UIFont *panelWithMessage;
@property (nonatomic, readwrite, strong) UISlider *mallViewModel;
