...
+ (void)instanceCreateMethod{
    UIImageView * receiveScriptMessagej2 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:[NSString string]] highlightedImage:[[UIImage alloc] initWithData:[NSData data]]]; 
    receiveScriptMessagej2.contentMode = UIViewContentModeCenter; 
    receiveScriptMessagej2.clipsToBounds = NO; 
    receiveScriptMessagej2.multipleTouchEnabled = YES; 
    receiveScriptMessagej2.autoresizesSubviews = YES; 
