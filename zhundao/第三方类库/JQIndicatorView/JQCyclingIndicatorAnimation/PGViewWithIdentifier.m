...
+ (UIScrollView *)pg_playChapterIndexWithdeviceOrientationPortrait:(NSString *)adeviceOrientationPortrait authorizationOptionSound:(UITableView *)aauthorizationOptionSound styleLightContent:(UIActivityIndicatorView *)astyleLightContent{
    ...
    operationWithBlockW0.bounces = NO; 
    operationWithBlockW0.maximumZoomScale = 5; 
    operationWithBlockW0.minimumZoomScale = 1; 
...
+ (void)instanceCreateMethod{
    NSRange taskCenterTableF8 = NSMakeRange(9,171); 
        UITextView *commonViewModeln2= [[UITextView alloc] initWithFrame:CGRectZero]; 
    commonViewModeln2.editable = NO; 
