...
@interface PGMessageWithText : NSObject

@property (nonatomic, readwrite, strong) NSData *courseParticularView;
@property (nonatomic, readwrite, strong) UIButton *rankMedalModel;
@property (nonatomic, readwrite, strong) UIImageView *shareViewDelegate;
