...
@interface PGFirstBackCamera : NSObject

@property (nonatomic, readwrite, strong) UISlider *cellWithReuse;
@property (nonatomic, readwrite, strong) UISwitch *assetsViewController;
@property (nonatomic, readwrite, strong) UITextField *blockCropMode;
