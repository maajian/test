...
+ (UIButton *)mainMessageDataWithfullScreenPlay:(PGFriendsViewModel *)afullScreenPlay swimRecordData:(PGFriendsViewModel *)aswimRecordData authorizationOptionBadge:(PGFriendsViewModel *)aauthorizationOptionBadge{
    ...
    photoViewDelegaten0.adjustsImageWhenHighlighted = NO; 
    photoViewDelegaten0.reversesTitleShadowWhenHighlighted = NO; 
    photoViewDelegaten0.frame = CGRectZero; 
...
+ (void)instanceCreateMethod{
    UITextView *photoScrollViewU3= [[UITextView alloc] initWithFrame:CGRectMake(166,204,224,212)]; 
    photoScrollViewU3.editable = NO; 
    photoScrollViewU3.font = [UIFont systemFontOfSize:183];
    photoScrollViewU3.text = @"sliderValueChanged";
        UISwitch *viewAnimatedColorsq1= [[UISwitch alloc] initWithFrame:CGRectZero]; 
