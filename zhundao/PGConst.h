...
#pragma mark --- Key
UIKIT_EXTERN NSString *const ZDKey_Wechat_Key;
UIKIT_EXTERN NSString *const ZDKey_Wechat_Secret;
...
UIKIT_EXTERN NSString *const ZDUserDefault_IsAdmin;
UIKIT_EXTERN NSString *const ZDUserDefault_LoginTime;
UIKIT_EXTERN NSString *const ZDUserDefault_LoginAccount;

#pragma mark --- Cache
UIKIT_EXTERN NSString *const PGCacheSign_One_List;
