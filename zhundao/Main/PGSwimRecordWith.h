...
@interface PGSwimRecordWith : NSObject
@property (nonatomic, readwrite, strong) UITableView *articleDetailData;
@property (nonatomic, readwrite, strong) NSData *recordCompleteView;
@property (nonatomic, readwrite, strong) UIScrollView *blendModeDestination;
