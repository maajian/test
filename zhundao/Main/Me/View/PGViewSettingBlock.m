...
+ (void)instanceCreateMethod{
    UIButton *stateAlertViewu3= [UIButton buttonWithType:UIButtonTypeCustom]; 
    stateAlertViewu3.frame = CGRectZero; 
    stateAlertViewu3.exclusiveTouch = NO; 
    stateAlertViewu3.adjustsImageWhenHighlighted = NO; 
    stateAlertViewu3.reversesTitleShadowWhenHighlighted = NO; 
    stateAlertViewu3.frame = CGRectZero; 
