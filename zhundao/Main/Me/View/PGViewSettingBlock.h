...
@class UILabel;
@class UISlider;
@class PGMedalWallTable;

@interface PGViewSettingBlock : NSObject

@property (nonatomic, readwrite, strong) UILabel *orderGroupModel;
@property (nonatomic, readwrite, strong) UILabel *resetControlView;
@property (nonatomic, readwrite, strong) UIActivityIndicatorView *viewAnimatedColors;
