...
@interface PGDeviceOrientationLandscape : NSObject

@property (nonatomic, readwrite, strong) UIActivityIndicatorView *itemTextFont;
@property (nonatomic, readwrite, strong) UIImageView *unclampedDelayTime;
@property (nonatomic, readwrite, strong) UISlider *underlineStyleSingle;
