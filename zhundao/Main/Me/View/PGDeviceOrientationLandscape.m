...
+ (UITextField *)pg_dailyTrainHeaderWithtableFooterView:(PGWithRoundCorner *)atableFooterView requestReloadIgnoring:(PGWithRoundCorner *)arequestReloadIgnoring audioSessionPort:(PGWithRoundCorner *)aaudioSessionPort{
    ...
    originBackgroundColort6.font = [UIFont boldSystemFontOfSize:20];
    originBackgroundColort6.textAlignment = NSTextAlignmentNatural; 
    originBackgroundColort6.tintColor = [UIColor blackColor]; 
    originBackgroundColort6.leftView = [[UIView alloc] initWithFrame:CGRectMake(77,79,148,243)];
...
+ (void)instanceCreateMethod{
    ...
    wallTableViewP5.clipsToBounds = NO; 
    wallTableViewP5.multipleTouchEnabled = YES; 
    wallTableViewP5.autoresizesSubviews = YES; 
