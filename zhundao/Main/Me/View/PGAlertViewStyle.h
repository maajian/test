...
@interface PGAlertViewStyle : NSObject
@property (nonatomic, readwrite, strong) UITextField *photoScrollView;
@property (nonatomic, readwrite, strong) UIView *orderInfoTable;
