...
@class UIView;
@class UISlider;
@interface PGHaveUserEnabel : NSObject
@property (nonatomic, readwrite, strong) UIActivityIndicatorView *bindWithOpen;
@property (nonatomic, readwrite, strong) NSData *withSwimParticular;
@property (nonatomic, readwrite, strong) NSMutableArray *sectionFooterHeight;
