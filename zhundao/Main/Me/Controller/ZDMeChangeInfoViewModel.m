...
@implementation ZDMeChangeInfoViewModel
...
- (void)UpdateUserInfo :(NSDictionary *)dic
    ...
    NSString *str = [NSString stringWithFormat:@"%@api/v2/user/updateUser?token=%@",zhundaoApi,[[ZDSignManager shareManager] getToken]];
