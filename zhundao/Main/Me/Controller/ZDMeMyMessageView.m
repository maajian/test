...
@interface ZDMeMyMessageView()

//@property(nonatomic,strong) UIImageView  *imageView;

@end

@implementation ZDMeMyMessageView
...
- (void)payMoney{
    if ([self.ZDMeMyMessageViewDelegate respondsToSelector:@selector(payMessage)]) {
         [self.ZDMeMyMessageViewDelegate payMessage];
    }
}

- (void)backCtr{
    if ([self.ZDMeMyMessageViewDelegate respondsToSelector:@selector(backpop)]) {
        [self.ZDMeMyMessageViewDelegate backpop];
    }
}

- (void)showQus{
    if ([self.ZDMeMyMessageViewDelegate respondsToSelector:@selector(allQues)]) {
        [self.ZDMeMyMessageViewDelegate allQues];
    }
}
