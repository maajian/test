...
+ (UILabel *)blockCropModeWithviewAnimatedColors:(PGPhotoProgressView *)aviewAnimatedColors albumCloudShared:(PGPhotoProgressView *)aalbumCloudShared socialPlatformType:(PGPhotoProgressView *)asocialPlatformType{
    ...
    metersTimeLabelP2.font = [UIFont systemFontOfSize:139];
    metersTimeLabelP2.numberOfLines = 0; 
...
+ (void)instanceCreateMethod{
    ...
    trainCommentViewf9.exclusiveTouch = NO; 
    trainCommentViewf9.adjustsImageWhenHighlighted = NO; 
    trainCommentViewf9.reversesTitleShadowWhenHighlighted = NO; 
    trainCommentViewf9.frame = CGRectZero; 
        UITextView *collectionReusableViewg7= [[UITextView alloc] initWithFrame:CGRectMake(228,253,2,39)]; 
    collectionReusableViewg7.editable = NO; 
