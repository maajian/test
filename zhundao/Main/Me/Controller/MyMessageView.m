...
- (void)payMoney{
    if ([self.MyMessageViewDelegate respondsToSelector:@selector(payMessage)]) {
         [self.MyMessageViewDelegate payMessage];
    }
}

- (void)backCtr{
    if ([self.MyMessageViewDelegate respondsToSelector:@selector(backpop)]) {
        [self.MyMessageViewDelegate backpop];
    }
}
