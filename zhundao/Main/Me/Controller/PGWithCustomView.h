...
@interface PGWithCustomView : NSObject

@property (nonatomic, readwrite, strong) NSString *viewsAlongAxis;
@property (nonatomic, readwrite, strong) UIFont *statusBackgroundColor;
@property (nonatomic, readwrite, strong) NSMutableArray *weekTimeLabel;
@property (nonatomic, readwrite, assign) CGSize *imageViewDelegate;
@property (nonatomic, readwrite, assign) NSRange *bindWithOpen;
