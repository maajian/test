...
#import "PGMeGroupTableViewCell.h"
...
@interface PGMeGroupViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    Reachability *r;
}
...
- (void)netWork
{
    ...
    PGMeGroupMV *Group = [[PGMeGroupMV alloc]init];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
        ...
        PGMeGroupTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:groupID];
        if (!cell) {
            cell = [[PGMeGroupTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:groupID];
        }
