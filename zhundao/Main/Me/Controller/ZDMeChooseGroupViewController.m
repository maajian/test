//
//  ZDMeChooseGroupViewController.m
//  zhundao
//
...
@interface ZDMeChooseGroupViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    Reachability *r;
}
...
@implementation ZDMeChooseGroupViewController
