...
@interface PGCameraRollAlbum : NSObject
@property (nonatomic, readwrite, strong) NSString *pageLabelPage;
@property (nonatomic, readwrite, strong) UISwitch *dailyTrainHeader;
@property (nonatomic, readwrite, strong) UISlider *affineTransformIdentity;
