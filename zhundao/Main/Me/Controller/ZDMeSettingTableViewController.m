//
//  ZDMeSettingTableViewController.m
//  zhundao
//
...
@interface ZDMeSettingTableViewController ()
{
    NSString *uidstr;
...
@implementation ZDMeSettingTableViewController
/*! 退出登录 */
...
- (void)didLogout
{
    ...
    appDelegate.window.rootViewController = [[ZDBaseNavVC alloc] initWithRootViewController:login];
}
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (void)moreAcount {
    ZDMeMoreAcountViewController *moreAccount = [[ZDMeMoreAcountViewController alloc] init];
