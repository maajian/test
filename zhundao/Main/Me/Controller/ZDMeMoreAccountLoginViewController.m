//
//  ZDMeMoreAccountLoginViewController.m
//  zhundao
//
...
@interface ZDMeMoreAccountLoginViewController ()
...
@implementation ZDMeMoreAccountLoginViewController
...
- (void)getGrade
{
    ...
    [ZD_NetWorkM getDataWithMethod:userstr parameters:nil succ:^(NSDictionary *obj) {
        ...
        [ZDloginMainViewModel getTokenByAccount:_accountTF .text passWord:_passwordTF.text];
