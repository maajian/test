...
- (UITableView *)tableView {
    if (!_tableView) {
        ...
        _tableView.tableHeaderView = [self PG_getHeaderView];
...
[lineHeadIndent previousPerformRequestsWithdecimalNumberHandler:subviewWithClassW7 backButtonClick:valueObservingOptionsX7 ];
    ...
    UIBarButtonItem *rightItem = [[UIBarButtonItem alloc] initWithTitle:@"添加" style:(UIBarButtonItemStylePlain) target:self action:@selector(PG_addNewAccount)];
    self.navigationItem.rightBarButtonItem = rightItem;
}
- (void)PG_addNewAccount {
