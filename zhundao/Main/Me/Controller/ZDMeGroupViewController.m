...
#import "ZDMeGroupMV.h"
#import "ZDMeContactMV.h"
#import "ZDMeGroupModel.h"
#import "ZDMeGroupTableViewCell.h"
...
@interface ZDMeGroupViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    Reachability *r;
}
...
@implementation ZDMeGroupViewController
...
- (UITableView *)tableView
{
    if (!_tableView) {
        ...
        [_tableView registerNib:[UINib nibWithNibName:@"ZDMeGroupTableViewCell" bundle:nil] forCellReuseIdentifier:@"groupID"];
...
- (void)netWork
{
    NSString *str = [NSString stringWithFormat:@"%@api/Contact/PostContactGroup?accessKey=%@",zhundaoApi,[[ZDSignManager shareManager] getaccseekey]];
    ZDMeGroupMV *Group = [[ZDMeGroupMV alloc]init];
    ...
    Group.block = ^(NSArray *array)
    {
        ...
        for (NSDictionary *dic in array) {
            ZDMeGroupModel *model = [ZDMeGroupModel yy_modelWithDictionary:dic];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
        ...
        ZDMeGroupTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:groupID];
        if (!cell) {
            cell = [[ZDMeGroupTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:groupID];
        }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString *str = [NSString stringWithFormat:@"%@api/Contact/DeleteContact/%li?accessKey=%@",zhundaoApi,(long)[idarray[indexPath.row] integerValue],[[ZDSignManager shareManager] getaccseekey]];
...
- (void)setimageWithNameStr :(NSString *)nameStr imageStr :(NSString *)imageStr withCell :(ZDMeGroupTableViewCell *)cell
{
