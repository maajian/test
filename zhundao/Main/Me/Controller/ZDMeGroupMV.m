...
{
    NSString *netstr = [NSString stringWithFormat:@"%@api/Contact/UpdateOrAddContact?accessKey=%@",zhundaoApi,[[ZDSignManager shareManager] getaccseekey]];
