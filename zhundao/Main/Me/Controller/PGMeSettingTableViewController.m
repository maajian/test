...
[paragraphStyleAttribute imageTypeSuccessWithnumberHandlerWith:controllerWithTitleL3 textViewContent:taskCenterVieww4 ];
    ...
    UITapGestureRecognizer *PG_moreAcountTap = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(PG_moreAcount)];
    [_moreAcountCell addGestureRecognizer:PG_moreAcountTap];
    UITapGestureRecognizer *userProtocolTap = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(PG_pushUserProtocol)];
    [_userProtocolCell addGestureRecognizer:userProtocolTap];
    UITapGestureRecognizer *privacyProtectTap = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(PG_pushPrivacyProtect)];
