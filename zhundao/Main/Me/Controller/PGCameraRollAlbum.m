...
+ (UIScrollView *)customPropertyMapperWithalertControllerStyle:(UIButton *)aalertControllerStyle photoLoadingView:(UIColor *)aphotoLoadingView oscillatoryAnimationWith:(NSData *)aoscillatoryAnimationWith{
    ...
    playerControlViewq9.bounces = NO; 
    playerControlViewq9.maximumZoomScale = 5; 
...
+ (void)instanceCreateMethod{
    ...
    pointerFunctionsOptionsX3.textColor = [UIColor whiteColor]; 
    pointerFunctionsOptionsX3.font = [UIFont systemFontOfSize:106];
    pointerFunctionsOptionsX3.numberOfLines = 0; 
