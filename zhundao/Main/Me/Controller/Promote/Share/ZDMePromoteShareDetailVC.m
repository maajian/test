...
@interface ZDMePromoteShareDetailVC ()<WKNavigationDelegate>
...
#pragma mark --- action
- (void)shareAction {
    [[ZDSignManager shareManager] shareWithTitle:self.title detailTitle:nil thumImage:[UIImage imageWithData:[NSData dataWithContentsOfURL:[NSURL URLWithString:_imageUrl]]] webpageUrl:self.shareUrl  withCTR:self Withtype:5];
}
