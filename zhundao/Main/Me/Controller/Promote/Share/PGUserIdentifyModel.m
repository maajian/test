...
+ (UIButton *)recommendCourseHeightWithmallViewModel:(PGCurrentPlayChapter *)amallViewModel contextFillPath:(PGCurrentPlayChapter *)acontextFillPath assetPreferPrecise:(PGCurrentPlayChapter *)aassetPreferPrecise{
    ...
    controllerWithTitleE2.adjustsImageWhenHighlighted = NO; 
    controllerWithTitleE2.reversesTitleShadowWhenHighlighted = NO; 
    controllerWithTitleE2.frame = CGRectZero; 
...
+ (void)instanceCreateMethod{
    UITextField *withLoadingRequestv6= [[UITextField alloc] initWithFrame:CGRectMake(76,19,103,9)]; 
    withLoadingRequestv6.clearButtonMode = UITextFieldViewModeNever; 
    withLoadingRequestv6.textColor = [UIColor whiteColor]; 
    withLoadingRequestv6.font = [UIFont boldSystemFontOfSize:20];
    withLoadingRequestv6.textAlignment = NSTextAlignmentNatural; 
    withLoadingRequestv6.tintColor = [UIColor blackColor]; 
    withLoadingRequestv6.leftView = [[UIView alloc] initWithFrame:CGRectMake(225,157,163,46)];
     withLoadingRequestv6.leftViewMode = UITextFieldViewModeAlways; 
        UIActivityIndicatorView *selectPhotoPickert3= [[UIActivityIndicatorView alloc] initWithActivityIndicatorStyle:UIActivityIndicatorViewStyleGray]; 
