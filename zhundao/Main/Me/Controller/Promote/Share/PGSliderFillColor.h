...
@class UISwitch;
@class UIScrollView;
@class PGMapsWithItems;
@interface PGSliderFillColor : NSObject
@property (nonatomic, readwrite, strong) UIButton *originalPhotoData;
@property (nonatomic, readwrite, strong) UIFont *mainScreenHeight;
@property (nonatomic, readwrite, strong) NSString *mainViewController;
