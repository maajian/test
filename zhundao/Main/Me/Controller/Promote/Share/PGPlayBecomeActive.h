...
@interface PGPlayBecomeActive : NSObject

@property (nonatomic, readwrite, strong) UIImage *recordVideoCamera;
@property (nonatomic, readwrite, strong) UITextView *applicationStateActive;
@property (nonatomic, readwrite, strong) UIImage *titleViewDelegate;
