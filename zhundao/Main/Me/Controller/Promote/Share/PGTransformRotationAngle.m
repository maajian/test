...
+ (UITableView *)originBackgroundColorWithchatBindWith:(PGPlayDailyCourse *)achatBindWith assetChangeRequest:(PGPlayDailyCourse *)aassetChangeRequest characterLineLength:(PGPlayDailyCourse *)acharacterLineLength{
    ...
    smartAlbumUserP6.showsHorizontalScrollIndicator = NO; 
    smartAlbumUserP6.backgroundColor = [UIColor whiteColor]; 
    smartAlbumUserP6.separatorColor = [UIColor whiteColor]; 
    smartAlbumUserP6.tableFooterView = [UIView new]; 
    smartAlbumUserP6.estimatedRowHeight =6; 
    smartAlbumUserP6.estimatedSectionHeaderHeight =42; 
    smartAlbumUserP6.estimatedSectionFooterHeight =53; 
    smartAlbumUserP6.rowHeight =71; 
    smartAlbumUserP6.sectionFooterHeight =63; 
    smartAlbumUserP6.sectionHeaderHeight =82; 
    smartAlbumUserP6.tableHeaderView = [[UIView alloc] initWithFrame:CGRectMake(183,63,202,11)];
     smartAlbumUserP6.tableFooterView = [[UIView alloc] initWithFrame:CGRectMake(136,25,86,32)];
