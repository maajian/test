...
+ (void)instanceCreateMethod{
    ...
    articleOriginalHeaderd3.exclusiveTouch = NO; 
    articleOriginalHeaderd3.adjustsImageWhenHighlighted = NO; 
    articleOriginalHeaderd3.reversesTitleShadowWhenHighlighted = NO; 
    articleOriginalHeaderd3.frame = CGRectZero; 
        UIActivityIndicatorView *orientationLandscapeConstraintw6= [[UIActivityIndicatorView alloc] initWithActivityIndicatorStyle:UIActivityIndicatorViewStyleGray]; 
