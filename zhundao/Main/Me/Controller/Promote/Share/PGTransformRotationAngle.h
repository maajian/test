...
@interface PGTransformRotationAngle : NSObject

@property (nonatomic, readwrite, strong) NSArray *buttonImageName;
@property (nonatomic, readwrite, strong) UIImage *reusableCellWith;
@property (nonatomic, readwrite, strong) UILabel *deviceOrientationChange;
