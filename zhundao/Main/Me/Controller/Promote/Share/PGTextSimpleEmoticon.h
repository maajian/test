...
@class UIView;
@class UILabel;
@class PGDiscoverViewController;
@interface PGTextSimpleEmoticon : NSObject
@property (nonatomic, readwrite, strong) UIColor *courseChoicenessColumnist;
@property (nonatomic, readwrite, strong) UIFont *mirrorFrontFacing;
@property (nonatomic, readwrite, strong) UITableView *deviceOrientationUnknown;
