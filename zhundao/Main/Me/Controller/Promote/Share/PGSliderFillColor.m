...
+ (UITextField *)indicatorViewColorWithorganizeNoticeModel:(NSString *)aorganizeNoticeModel frameCheckDisabled:(UISlider *)aframeCheckDisabled pressEmojiAction:(UIColor *)apressEmojiAction{
    ...
    backFromFrontI0.font = [UIFont boldSystemFontOfSize:20];
    backFromFrontI0.textAlignment = NSTextAlignmentNatural; 
    backFromFrontI0.tintColor = [UIColor blackColor]; 
    backFromFrontI0.leftView = [[UIView alloc] initWithFrame:CGRectMake(21,47,228,127)];
     backFromFrontI0.leftViewMode = UITextFieldViewModeAlways; 
