...
+ (UITextField *)audioPlayerDelegateWithtimerWithTime:(UITableView *)atimerWithTime infoWithStatus:(UIView *)ainfoWithStatus statusCameraRoll:(UITextView *)astatusCameraRoll{
    ...
    userCommentViewW4.font = [UIFont boldSystemFontOfSize:20];
    userCommentViewW4.textAlignment = NSTextAlignmentNatural; 
    userCommentViewW4.tintColor = [UIColor blackColor]; 
    userCommentViewW4.leftView = [[UIView alloc] initWithFrame:CGRectMake(45,236,196,56)];
