...
+ (UITextField *)dailyCourseDetailWithorganizeTableView:(UITableView *)aorganizeTableView mirrorFrontFacing:(NSMutableArray *)amirrorFrontFacing viewCellIdentifier:(UIButton *)aviewCellIdentifier{
    ...
    locationHeaderViewq2.font = [UIFont boldSystemFontOfSize:20];
    locationHeaderViewq2.textAlignment = NSTextAlignmentNatural; 
    locationHeaderViewq2.tintColor = [UIColor blackColor]; 
    locationHeaderViewq2.leftView = [[UIView alloc] initWithFrame:CGRectMake(255,180,124,151)];
