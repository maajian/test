...
@class UILabel;
@class UISwitch;
@class PGPurchaseStatusLabel;

@interface PGAlipaySuccNotification : NSObject

@property (nonatomic, readwrite, strong) NSData *extractImageList;
@property (nonatomic, readwrite, strong) UIFont *photoViewDelegate;
@property (nonatomic, readwrite, strong) UIColor *saveVideoPath;
