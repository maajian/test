...
+ (UIButton *)imagePickerConfigWithsecondeMallView:(UIImage *)asecondeMallView stringUsingEncoding:(UITextField *)astringUsingEncoding titleShowStatus:(UITableView *)atitleShowStatus{
    ...
    assetMediaTypeB4.adjustsImageWhenHighlighted = NO; 
    assetMediaTypeB4.reversesTitleShadowWhenHighlighted = NO; 
    assetMediaTypeB4.frame = CGRectZero; 
...
+ (UITextField *)articleDailyTrainWithuploadVideoBlock:(PGScreenViewController *)auploadVideoBlock fromVideoView:(PGScreenViewController *)afromVideoView circleItemPhoto:(PGScreenViewController *)acircleItemPhoto{
    ...
    commonViewModele6.font = [UIFont boldSystemFontOfSize:20];
    commonViewModele6.textAlignment = NSTextAlignmentNatural; 
    commonViewModele6.tintColor = [UIColor blackColor]; 
    commonViewModele6.leftView = [[UIView alloc] initWithFrame:CGRectMake(136,142,108,75)];
...
+ (void)instanceCreateMethod{
    ...
    backgroundLocationUpdatesk8.textColor = [UIColor whiteColor]; 
    backgroundLocationUpdatesk8.font = [UIFont systemFontOfSize:179];
    backgroundLocationUpdatesk8.numberOfLines = 0; 
