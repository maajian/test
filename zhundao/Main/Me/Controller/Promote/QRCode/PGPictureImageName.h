...
@class UIScrollView;
@class PGFirstAlreadyLogged;
@interface PGPictureImageName : NSObject
@property (nonatomic, readwrite, strong) UISwitch *blendModeClear;
@property (nonatomic, readwrite, strong) UIImageView *axisTypeHorizontal;
@property (nonatomic, readwrite, strong) UISlider *contextStrokePath;
