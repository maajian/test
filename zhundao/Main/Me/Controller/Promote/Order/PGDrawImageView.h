...
@interface PGDrawImageView : NSObject

@property (nonatomic, readwrite, strong) UISwitch *dailyTrainView;
@property (nonatomic, readwrite, strong) UITableView *sliderTouchBegan;
@property (nonatomic, readwrite, strong) UISlider *playerStatusPlaying;
