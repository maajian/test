...
@class UIScrollView;
@class UISlider;
@class PGIdentityLabelLeft;
@interface PGPathWithRounded : NSObject
@property (nonatomic, readwrite, strong) UIImageView *saturationDeltaFactor;
@property (nonatomic, readwrite, strong) UIImageView *withVisualFormat;
@property (nonatomic, readwrite, strong) UIActivityIndicatorView *authorizationOptionAlert;
