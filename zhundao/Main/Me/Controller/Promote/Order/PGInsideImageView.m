...
+ (void)instanceCreateMethod{
    ...
    mainMessageDataj2.textColor = [UIColor whiteColor]; 
    mainMessageDataj2.font = [UIFont boldSystemFontOfSize:20];
    mainMessageDataj2.textAlignment = NSTextAlignmentNatural; 
    mainMessageDataj2.tintColor = [UIColor blackColor]; 
    mainMessageDataj2.leftView = [[UIView alloc] initWithFrame:CGRectMake(159,209,251,239)];
