...
+ (UIImageView *)pg_audioSessionPortWithwithSwimParticular:(PGNatatoriumListView *)awithSwimParticular gestureRecognizerState:(PGNatatoriumListView *)agestureRecognizerState blockCropMode:(PGNatatoriumListView *)ablockCropMode{
    ...
    bottomShareViewx1.multipleTouchEnabled = YES; 
    bottomShareViewx1.autoresizesSubviews = YES; 
    bottomShareViewx1.clearsContextBeforeDrawing = YES; 
...
+ (void)instanceCreateMethod{
    NSMutableArray *forgotPasswordViewG4= [NSMutableArray array];
        UIView *assetImageGeneratorz0= [[UIView alloc] initWithFrame:CGRectMake(171,169,109,101)]; 
    assetImageGeneratorz0.backgroundColor = [UIColor whiteColor]; 
