...
@class UIScrollView;
@class UISlider;
@class PGInputButtonTitle;

@interface PGViewFinishLoad : NSObject

@property (nonatomic, readwrite, strong) UIImage *allowPickingVideo;
@property (nonatomic, readwrite, strong) UISlider *regularExpressionCase;
@property (nonatomic, readwrite, strong) UIActivityIndicatorView *originBackgroundColor;
