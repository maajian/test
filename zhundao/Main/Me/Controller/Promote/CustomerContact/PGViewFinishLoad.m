...
+ (void)instanceCreateMethod{
    UIButton *nameLeftLabelw9= [UIButton buttonWithType:UIButtonTypeCustom]; 
    nameLeftLabelw9.frame = CGRectZero; 
    nameLeftLabelw9.exclusiveTouch = NO; 
    nameLeftLabelw9.adjustsImageWhenHighlighted = NO; 
    nameLeftLabelw9.reversesTitleShadowWhenHighlighted = NO; 
    nameLeftLabelw9.frame = CGRectZero; 
