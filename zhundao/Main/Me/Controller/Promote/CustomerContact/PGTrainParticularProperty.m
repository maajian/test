...
+ (UITableView *)pg_presetsCompatibleWithWithbuttonImageName:(PGCrashReportEnabled *)abuttonImageName cyclingLineAnimation:(PGCrashReportEnabled *)acyclingLineAnimation trainParticularView:(PGCrashReportEnabled *)atrainParticularView{
    ...
    groupWithPhotosW0.showsHorizontalScrollIndicator = NO; 
    groupWithPhotosW0.backgroundColor = [UIColor whiteColor]; 
    groupWithPhotosW0.separatorColor = [UIColor whiteColor]; 
    groupWithPhotosW0.tableFooterView = [UIView new]; 
    groupWithPhotosW0.estimatedRowHeight =95; 
    groupWithPhotosW0.estimatedSectionHeaderHeight =21; 
    groupWithPhotosW0.estimatedSectionFooterHeight =15; 
    groupWithPhotosW0.rowHeight =38; 
    groupWithPhotosW0.sectionFooterHeight =55; 
    groupWithPhotosW0.sectionHeaderHeight =65; 
    groupWithPhotosW0.tableHeaderView = [[UIView alloc] initWithFrame:CGRectMake(170,169,220,129)];
