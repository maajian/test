...
@class UISlider;
@class PGNatatoriumListView;
@interface PGRectCornerBottom : NSObject
@property (nonatomic, readwrite, strong) NSString *chatInputText;
@property (nonatomic, readwrite, strong) UIButton *taskNeedFinish;
@property (nonatomic, readwrite, strong) UIFont *badgeStyleNumber;
