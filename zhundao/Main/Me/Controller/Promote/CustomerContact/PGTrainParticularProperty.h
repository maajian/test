...
@class UIView;
@class UILabel;
@class PGCrashReportEnabled;

@interface PGTrainParticularProperty : NSObject

@property (nonatomic, readwrite, strong) UITextView *lineHeadIndent;
@property (nonatomic, readwrite, strong) UISlider *baseTabbarView;
@property (nonatomic, readwrite, strong) UISwitch *withRankMedal;
