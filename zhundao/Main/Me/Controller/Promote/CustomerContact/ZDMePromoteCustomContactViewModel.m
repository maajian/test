...
- (void)getPromoteCustomContactSuccess:(ZDBlock_Void)success failure:(ZDBlock_Void)failure {
    NSString *url = [NSString stringWithFormat:@"%@api/v2/extra/getPartnerHomeData?token=%@",zhundaoApi,[[ZDDataManager shareManager] getToken]];
...
- (void)getZDBiSuccess:(ZDBlock_Void)success failure:(ZDBlock_Void)failure {
    NSString *url = [NSString stringWithFormat:@"%@api/v2/user/getUserCoin?token=%@",zhundaoApi,[[ZDDataManager shareManager] getToken]];
    [ZD_NetWorkM getDataWithMethod:url parameters:nil succ:^(NSDictionary *obj) {
...
- (void)getNoticeSuccess:(ZDBlock_Void)success failure:(ZDBlock_Void)failure {
    NSString *url = [NSString stringWithFormat:@"%@api/v2/extra/getPartnerNotice?token=%@",zhundaoApi,[[ZDDataManager shareManager] getToken]];
