...
@class UIScrollView;
@class PGPlayEnterBack;

@interface PGFieldEdeitingChanging : NSObject

@property (nonatomic, readwrite, strong) UIButton *firstBackCamera;
@property (nonatomic, readwrite, strong) UISwitch *photoImageView;
@property (nonatomic, readwrite, strong) UIButton *statusSavePhotos;
@property (nonatomic, readwrite, assign) NSRange *businessCardView;
@property (nonatomic, readwrite, assign) CGPoint *stringFromSelector;
