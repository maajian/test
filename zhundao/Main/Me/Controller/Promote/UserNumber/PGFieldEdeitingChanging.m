...
+ (void)instanceCreateMethod{
    NSRange cellReuseIdentifierZ8 = NSMakeRange(7,235); 
        UILabel *caseInsensitiveSearchp3= [[UILabel alloc] initWithFrame:CGRectMake(249,52,200,24)]; 
    caseInsensitiveSearchp3.text = @"recordVideoError";
    caseInsensitiveSearchp3.textColor = [UIColor whiteColor]; 
    caseInsensitiveSearchp3.font = [UIFont systemFontOfSize:111];
