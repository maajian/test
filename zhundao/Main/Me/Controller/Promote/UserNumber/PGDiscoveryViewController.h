...
@class UIView;
@class PGSwimRecordWith;
@interface PGDiscoveryViewController : NSObject
@property (nonatomic, readwrite, strong) UITextField *contextDrawImage;
@property (nonatomic, readwrite, strong) UITableView *movieFrameOpposite;
@property (nonatomic, readwrite, strong) UITextView *courseViewModel;
