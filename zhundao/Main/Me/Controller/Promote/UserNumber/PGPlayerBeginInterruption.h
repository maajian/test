...
@class UIView;
@class UILabel;
@class PGTextAttributedString;

@interface PGPlayerBeginInterruption : NSObject

@property (nonatomic, readwrite, strong) NSArray *axisTypeHorizontal;
@property (nonatomic, readwrite, strong) UIColor *pageTintColor;
@property (nonatomic, readwrite, strong) NSData *courseChoicenessArticle;
