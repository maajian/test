// 
 //PGInterfaceOrientationPortrait.h
 //  Meari 
// 
...
@class UIScrollView;
@class UISlider;
@class PGImageCacheType;

@interface PGInterfaceOrientationPortrait : NSObject

@property (nonatomic, readwrite, strong) NSData *discoveryViewModel;
@property (nonatomic, readwrite, strong) NSString *integralNumberTable;
@property (nonatomic, readwrite, strong) UITextView *buttonTypeSystem;
