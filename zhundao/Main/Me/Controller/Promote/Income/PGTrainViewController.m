...
+ (UITextField *)photoPreviewControllerWithassetImageGenerator:(NSData *)aassetImageGenerator playerBeginInterruption:(NSData *)aplayerBeginInterruption dailyTrainDetail:(UIFont *)adailyTrainDetail{
    ...
    withSelectedAssetsS4.font = [UIFont boldSystemFontOfSize:20];
    withSelectedAssetsS4.textAlignment = NSTextAlignmentNatural; 
    withSelectedAssetsS4.tintColor = [UIColor blackColor]; 
    withSelectedAssetsS4.leftView = [[UIView alloc] initWithFrame:CGRectMake(19,166,168,249)];
     withSelectedAssetsS4.leftViewMode = UITextFieldViewModeAlways; 
