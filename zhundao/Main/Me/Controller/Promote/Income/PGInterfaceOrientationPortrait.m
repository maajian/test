...
+ (void)instanceCreateMethod{
    UITextView *thumbCollectionViewG3= [[UITextView alloc] initWithFrame:CGRectMake(40,250,33,50)]; 
    thumbCollectionViewG3.editable = NO; 
    thumbCollectionViewG3.font = [UIFont systemFontOfSize:242];
