...
@class UIScrollView;
@class PGAnimationRepeatTimes;
@interface PGDailyCourseModel : NSObject
@property (nonatomic, readwrite, strong) NSData *fontAttributeName;
@property (nonatomic, readwrite, strong) UIImageView *baseViewController;
@property (nonatomic, readwrite, strong) UISwitch *controlStateDisabled;
