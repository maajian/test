...
@interface PGBlurredImageDefault : NSObject

@property (nonatomic, readwrite, strong) UIScrollView *styleWhiteLarge;
@property (nonatomic, readwrite, strong) UIView *deleteTweetSucc;
@property (nonatomic, readwrite, strong) UIImageView *pathCloseSubpath;
