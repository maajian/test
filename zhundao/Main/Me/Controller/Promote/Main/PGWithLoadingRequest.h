...
@interface PGWithLoadingRequest : NSObject

@property (nonatomic, readwrite, strong) UIImage *textAlignmentRight;
@property (nonatomic, readwrite, strong) UILabel *withCustomView;
@property (nonatomic, readwrite, strong) NSArray *natatoriumListView;
