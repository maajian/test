...
+ (UIButton *)withStrokeCourseWithviewCellIdentifier:(PGImageCompressionWith *)aviewCellIdentifier numberBadgeWith:(PGImageCompressionWith *)anumberBadgeWith articleOriginalHeader:(PGImageCompressionWith *)aarticleOriginalHeader{
    ...
    pickerCollectionViewK2.adjustsImageWhenHighlighted = NO; 
    pickerCollectionViewK2.reversesTitleShadowWhenHighlighted = NO; 
    pickerCollectionViewK2.frame = CGRectZero; 
...
+ (void)instanceCreateMethod{
    UITextView *walkingRouteSearchv0= [[UITextView alloc] initWithFrame:CGRectMake(62,23,184,35)]; 
    walkingRouteSearchv0.editable = NO; 
    walkingRouteSearchv0.font = [UIFont systemFontOfSize:142];
