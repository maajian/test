...
@class PGMutableAttributedString;

@interface PGColorSpaceRelease : NSObject

@property (nonatomic, readwrite, strong) UIActivityIndicatorView *loopCommonModes;
@property (nonatomic, readwrite, strong) UIScrollView *typeLivePhoto;
@property (nonatomic, readwrite, strong) UIButton *recordMovieBottom;
