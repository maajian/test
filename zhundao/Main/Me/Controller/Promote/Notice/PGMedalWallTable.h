...
@interface PGMedalWallTable : NSObject
@property (nonatomic, readwrite, strong) UIImageView *firstFrameCheck;
@property (nonatomic, readwrite, strong) UISwitch *assetFromFetch;
@property (nonatomic, readwrite, strong) UIScrollView *dailyCourseModel;
