...
@class UIView;
@class UISwitch;
@class PGImageCompressionWith;
@interface PGSuccessWithStatus : NSObject
@property (nonatomic, readwrite, strong) UIScrollView *imageViewWith;
@property (nonatomic, readwrite, strong) UIColor *currentPhotoIndex;
@property (nonatomic, readwrite, strong) NSString *scrollDirectionRight;
