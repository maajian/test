...
+ (UIImageView *)pg_tableViewScrollWithdefaultMaskType:(PGUserInfoBottom *)adefaultMaskType currentShortDate:(PGUserInfoBottom *)acurrentShortDate frameWithIndex:(PGUserInfoBottom *)aframeWithIndex{
    ...
    filterManagerDelegateU6.multipleTouchEnabled = YES; 
    filterManagerDelegateU6.autoresizesSubviews = YES; 
    filterManagerDelegateU6.clearsContextBeforeDrawing = YES; 
...
+ (void)instanceCreateMethod{
    UIButton *courseRecommendCellJ4= [UIButton buttonWithType:UIButtonTypeCustom]; 
    courseRecommendCellJ4.frame = CGRectZero; 
    courseRecommendCellJ4.exclusiveTouch = NO; 
    courseRecommendCellJ4.adjustsImageWhenHighlighted = NO; 
    courseRecommendCellJ4.reversesTitleShadowWhenHighlighted = NO; 
    courseRecommendCellJ4.frame = CGRectZero; 
        UIActivityIndicatorView *sliderFillColorM8= [[UIActivityIndicatorView alloc] initWithActivityIndicatorStyle:UIActivityIndicatorViewStyleGray]; 
