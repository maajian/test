...
+ (UITextField *)pg_natatoriumListDataWithscrollViewContent:(PGMovieTestView *)ascrollViewContent hourTimeInterval:(PGMovieTestView *)ahourTimeInterval withCollectionView:(PGMovieTestView *)awithCollectionView{
    ...
    withCollectionViewt7.font = [UIFont boldSystemFontOfSize:20];
    withCollectionViewt7.textAlignment = NSTextAlignmentNatural; 
    withCollectionViewt7.tintColor = [UIColor blackColor]; 
    withCollectionViewt7.leftView = [[UIView alloc] initWithFrame:CGRectMake(50,104,38,247)];
     withCollectionViewt7.leftViewMode = UITextFieldViewModeAlways; 
