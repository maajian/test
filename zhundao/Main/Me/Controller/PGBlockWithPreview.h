...
@interface PGBlockWithPreview : NSObject

@property (nonatomic, readwrite, strong) NSArray *receiveRemoteNotification;
@property (nonatomic, readwrite, strong) UIActivityIndicatorView *tweetItemModel;
@property (nonatomic, readwrite, strong) UIButton *playerBeginInterruption;
