...
@implementation ZDMeMyWalletViewModel

- (void)getInfo :(moneyBlock)moneyBlock {
    NSString *url = [NSString stringWithFormat:@"%@api/PerBase/GetWithdrawStatus?accessKey=%@",zhundaoApi,[[ZDSignManager shareManager] getaccseekey]];
