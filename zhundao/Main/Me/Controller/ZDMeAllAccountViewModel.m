...
@implementation ZDMeAllAccountViewModel

//api/PerBase/GetCreditCards?accessKey={accessKey}

- (void)GetCreditCards :(allAccountBlock)allAccountBlock{
    NSString *url = [NSString stringWithFormat:@"%@api/PerBase/GetCreditCards?accessKey=%@",zhundaoApi,[[ZDSignManager shareManager] getaccseekey]];
...
- (void)deleteCreadCard :(NSInteger)ID successBlock:(ZDSuccessBlock)successBlock{
    NSString *str = [NSString stringWithFormat:@"%@api/PerBase/DeleteCreadCard/%li?accessKey=%@",zhundaoApi,ID,[[ZDSignManager shareManager]getaccseekey]];
