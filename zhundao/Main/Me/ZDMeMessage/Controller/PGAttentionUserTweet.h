...
@interface PGAttentionUserTweet : NSObject
@property (nonatomic, readwrite, strong) UITextView *keyboardTypeEmail;
@property (nonatomic, readwrite, strong) UIActivityIndicatorView *imageSourceContains;
@property (nonatomic, readwrite, strong) UIScrollView *cacheCourseParticular;
