...
+ (UITableView *)textAlignmentLeftWithcollectionElementKind:(NSMutableArray *)acollectionElementKind withCourseParticular:(UISlider *)awithCourseParticular scrollDirectionRight:(UIColor *)ascrollDirectionRight{
    ...
    activityIndicatorViewF1.showsHorizontalScrollIndicator = NO; 
    activityIndicatorViewF1.backgroundColor = [UIColor whiteColor]; 
    activityIndicatorViewF1.separatorColor = [UIColor whiteColor]; 
    activityIndicatorViewF1.tableFooterView = [UIView new]; 
    activityIndicatorViewF1.estimatedRowHeight =55; 
    activityIndicatorViewF1.estimatedSectionHeaderHeight =4; 
    activityIndicatorViewF1.estimatedSectionFooterHeight =8; 
    activityIndicatorViewF1.rowHeight =66; 
    activityIndicatorViewF1.sectionFooterHeight =42; 
    activityIndicatorViewF1.sectionHeaderHeight =71; 
    activityIndicatorViewF1.tableHeaderView = [[UIView alloc] initWithFrame:CGRectMake(171,42,243,50)];
