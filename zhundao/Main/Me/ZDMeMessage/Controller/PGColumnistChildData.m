...
+ (void)instanceCreateMethod{
    NSMutableArray *directionVerticalMovedN7= [NSMutableArray arrayWithCapacity:0];
        UIScrollView *rankMedalHeaderR7= [[UIScrollView alloc] initWithFrame:CGRectMake(52,21,150,154)]; 
    rankMedalHeaderR7.showsHorizontalScrollIndicator = NO; 
    rankMedalHeaderR7.showsVerticalScrollIndicator = NO; 
    rankMedalHeaderR7.bounces = NO; 
