...
@class UIScrollView;
@class PGTrainCommentView;

@interface PGMallViewController : NSObject

@property (nonatomic, readwrite, strong) UISlider *assetModelMedia;
@property (nonatomic, readwrite, strong) UIImageView *circleViewController;
@property (nonatomic, readwrite, strong) UIImage *controlEventEditing;
