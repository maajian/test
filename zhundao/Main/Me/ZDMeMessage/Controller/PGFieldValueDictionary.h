...
@class PGTrainDataWith;
@interface PGFieldValueDictionary : NSObject
@property (nonatomic, readwrite, strong) UIFont *tweetItemData;
@property (nonatomic, readwrite, strong) NSArray *enumerationResultsBlock;
@property (nonatomic, readwrite, strong) UIImageView *mainMessageView;
