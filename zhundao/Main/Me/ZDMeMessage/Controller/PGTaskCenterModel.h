...
@class UISlider;
@class PGScrollViewDeceleration;

@interface PGTaskCenterModel : NSObject

@property (nonatomic, readwrite, strong) UITextField *allowWithController;
@property (nonatomic, readwrite, strong) NSMutableArray *groupPurchaseOrder;
@property (nonatomic, readwrite, strong) UIScrollView *availableTextureIndex;
