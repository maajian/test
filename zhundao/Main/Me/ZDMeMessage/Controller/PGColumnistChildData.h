...
@interface PGColumnistChildData : NSObject
@property (nonatomic, readwrite, strong) UIFont *naviTitleAppearance;
@property (nonatomic, readwrite, strong) UIColor *controlStateHighlighted;
@property (nonatomic, readwrite, strong) UITableView *commentTableView;
