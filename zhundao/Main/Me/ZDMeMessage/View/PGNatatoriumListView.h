...
@interface PGNatatoriumListView : NSObject

@property (nonatomic, readwrite, strong) UIFont *withStrokeCourse;
@property (nonatomic, readwrite, strong) UILabel *textBorderStyle;
@property (nonatomic, readwrite, strong) UISwitch *zoomingScrollView;
@property (nonatomic, readwrite, assign) UITableViewCellSeparatorStyle *circleScreenView;
@property (nonatomic, readwrite, assign) NSLineBreakMode *videoWithPath;
