...
@interface PGSwappableImageView : NSObject

@property (nonatomic, readwrite, strong) UITextView *videoProcessingQueue;
@property (nonatomic, readwrite, strong) UISlider *mutableAttributedString;
@property (nonatomic, readwrite, strong) UISwitch *photosDelegateWith;
