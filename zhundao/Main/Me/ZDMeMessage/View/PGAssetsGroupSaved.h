...
@interface PGAssetsGroupSaved : NSObject
@property (nonatomic, readwrite, strong) UISwitch *paragraphStyleAttribute;
@property (nonatomic, readwrite, strong) NSString *inputViewContent;
@property (nonatomic, readwrite, strong) UIScrollView *launchOptionsDirections;
