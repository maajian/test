...
@class UIScrollView;
@class UISlider;
@class PGCancelCollectionCourse;

@interface PGVideoPreviewCell : NSObject

@property (nonatomic, readwrite, strong) NSArray *protocolViewController;
@property (nonatomic, readwrite, strong) UIView *beautyParamWith;
@property (nonatomic, readwrite, strong) UITextView *rectContainsPoint;
