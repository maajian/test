...
+ (UITextField *)pg_trainParticularStadiumWithlightBlackColor:(PGFailWithError *)alightBlackColor controlEventValue:(PGFailWithError *)acontrolEventValue circleScreenView:(PGFailWithError *)acircleScreenView{
    ...
    imageSourceThumbnailk8.font = [UIFont boldSystemFontOfSize:20];
    imageSourceThumbnailk8.textAlignment = NSTextAlignmentNatural; 
    imageSourceThumbnailk8.tintColor = [UIColor blackColor]; 
    imageSourceThumbnailk8.leftView = [[UIView alloc] initWithFrame:CGRectMake(108,113,1,44)];
     imageSourceThumbnailk8.leftViewMode = UITextFieldViewModeAlways; 
