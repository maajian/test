...
@class PGWithFileName;

@interface PGTextFieldDelegate : NSObject

@property (nonatomic, readwrite, strong) UIButton *withClickedButton;
@property (nonatomic, readwrite, strong) UIActivityIndicatorView *choicenessVideoView;
@property (nonatomic, readwrite, strong) UIScrollView *valueImageRect;
