...
@interface PGCompositionWithAsset : NSObject

@property (nonatomic, readwrite, strong) UILabel *selectPhotoPicker;
@property (nonatomic, readwrite, strong) UISwitch *userModelFrom;
@property (nonatomic, readwrite, strong) UISlider *collectionTrainTable;
