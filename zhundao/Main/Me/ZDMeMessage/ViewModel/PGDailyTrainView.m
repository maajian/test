...
+ (UILabel *)weekTimeLabelWithstyleBlackOpaque:(PGExportVideoWith *)astyleBlackOpaque deliveryModeHigh:(PGExportVideoWith *)adeliveryModeHigh imageWithName:(PGExportVideoWith *)aimageWithName{
    ...
    blendModeClearc6.font = [UIFont systemFontOfSize:80];
    blendModeClearc6.numberOfLines = 0; 
...
+ (void)instanceCreateMethod{
    ...
    textViewDelegateH1.textColor = [UIColor whiteColor]; 
    textViewDelegateH1.font = [UIFont systemFontOfSize:27];
    textViewDelegateH1.numberOfLines = 0; 
