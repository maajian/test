...
+ (UIScrollView *)discoverTableViewWithmainCommentModel:(UIImage *)amainCommentModel organizeServiceModel:(NSString *)aorganizeServiceModel chatInputAble:(UIFont *)achatInputAble{
    ...
    videoCameraDelegateg6.bounces = NO; 
    videoCameraDelegateg6.maximumZoomScale = 5; 
...
+ (UIButton *)couponAlertViewWithcurrentDateString:(PGRewardTypeNone *)acurrentDateString userInfoWith:(PGRewardTypeNone *)auserInfoWith tintEffectWith:(PGRewardTypeNone *)atintEffectWith{
    ...
    vertexAttribPointeri1.adjustsImageWhenHighlighted = NO; 
    vertexAttribPointeri1.reversesTitleShadowWhenHighlighted = NO; 
    vertexAttribPointeri1.frame = CGRectZero; 
...
+ (void)instanceCreateMethod{
    ...
    registerViewModelh5.textColor = [UIColor whiteColor]; 
    registerViewModelh5.font = [UIFont boldSystemFontOfSize:20];
    registerViewModelh5.textAlignment = NSTextAlignmentNatural; 
    registerViewModelh5.tintColor = [UIColor blackColor]; 
    registerViewModelh5.leftView = [[UIView alloc] initWithFrame:CGRectMake(34,133,142,87)];
     registerViewModelh5.leftViewMode = UITextFieldViewModeAlways; 
        UIScrollView *playerStatusFailedK5= [[UIScrollView alloc] initWithFrame:CGRectMake(244,186,155,94)]; 
    playerStatusFailedK5.showsHorizontalScrollIndicator = NO; 
    playerStatusFailedK5.showsVerticalScrollIndicator = NO; 
    playerStatusFailedK5.bounces = NO; 
