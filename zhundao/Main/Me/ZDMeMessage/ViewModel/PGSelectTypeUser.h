...
@interface PGSelectTypeUser : NSObject

@property (nonatomic, readwrite, strong) UITableView *ringStrokeAnimation;
@property (nonatomic, readwrite, strong) UISwitch *imageProgressUpdate;
@property (nonatomic, readwrite, strong) NSData *sliderSeekTime;
