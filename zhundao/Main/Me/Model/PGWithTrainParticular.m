...
+ (UITableView *)pg_downloadProgressBlockWithnatatoriumParticularTable:(PGGraphicsBeginImage *)anatatoriumParticularTable answersTableView:(PGGraphicsBeginImage *)aanswersTableView recommendTableView:(PGGraphicsBeginImage *)arecommendTableView{
    ...
    keyboardTypeNumberZ7.showsHorizontalScrollIndicator = NO; 
    keyboardTypeNumberZ7.backgroundColor = [UIColor whiteColor]; 
    keyboardTypeNumberZ7.separatorColor = [UIColor whiteColor]; 
    keyboardTypeNumberZ7.tableFooterView = [UIView new]; 
    keyboardTypeNumberZ7.estimatedRowHeight =2; 
    keyboardTypeNumberZ7.estimatedSectionHeaderHeight =61; 
    keyboardTypeNumberZ7.estimatedSectionFooterHeight =32; 
    keyboardTypeNumberZ7.rowHeight =83; 
    keyboardTypeNumberZ7.sectionFooterHeight =31; 
    keyboardTypeNumberZ7.sectionHeaderHeight =58; 
    keyboardTypeNumberZ7.tableHeaderView = [[UIView alloc] initWithFrame:CGRectMake(179,31,17,13)];
     keyboardTypeNumberZ7.tableFooterView = [[UIView alloc] initWithFrame:CGRectMake(117,222,174,113)];
