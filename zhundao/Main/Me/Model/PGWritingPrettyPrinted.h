...
@class UISwitch;
@class UIScrollView;
@class PGViewWillShow;

@interface PGWritingPrettyPrinted : NSObject

@property (nonatomic, readwrite, strong) UIButton *couponTypeIntegral;
@property (nonatomic, readwrite, strong) UISwitch *failLoadWith;
@property (nonatomic, readwrite, strong) UIButton *circleItemPhoto;
