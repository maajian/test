...
@interface PGPurchaseStatusLabel : NSObject

@property (nonatomic, readwrite, strong) UIScrollView *assetPropertyAsset;
@property (nonatomic, readwrite, strong) UISwitch *userNotificationType;
@property (nonatomic, readwrite, strong) UITextView *strokeCourseParticular;
