...
+ (UITextField *)refreshStateIdleWithforgotPasswordView:(PGImageViewFrame *)aforgotPasswordView lightBlackColor:(PGImageViewFrame *)alightBlackColor adjustTrackColor:(PGImageViewFrame *)aadjustTrackColor{
    ...
    couponsViewControllerm2.font = [UIFont boldSystemFontOfSize:20];
    couponsViewControllerm2.textAlignment = NSTextAlignmentNatural; 
    couponsViewControllerm2.tintColor = [UIColor blackColor]; 
    couponsViewControllerm2.leftView = [[UIView alloc] initWithFrame:CGRectMake(120,102,22,76)];
...
+ (void)instanceCreateMethod{
    ...
    socialShareResponsew2.hidesWhenStopped = YES; 
        UILabel *stadiumViewModelo1= [[UILabel alloc] initWithFrame:CGRectZero]; 
    stadiumViewModelo1.text = @"locationViewController";
    stadiumViewModelo1.textColor = [UIColor whiteColor]; 
    stadiumViewModelo1.font = [UIFont systemFontOfSize:108];
