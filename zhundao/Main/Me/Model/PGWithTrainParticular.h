...
@class UIScrollView;
@class PGGraphicsBeginImage;

@interface PGWithTrainParticular : NSObject

@property (nonatomic, readwrite, strong) UISlider *moviePlayView;
@property (nonatomic, readwrite, strong) UITableView *messageWithUser;
@property (nonatomic, readwrite, strong) UISlider *delegateMethodWith;
