...
@class NSArray;
@class UIScrollView;
@class PGPlayBecomeActive;
@interface PGUpdateUserLocation : NSObject
@property (nonatomic, readwrite, strong) UISlider *childViewController;
@property (nonatomic, readwrite, strong) UIFont *animationRightTick;
@property (nonatomic, readwrite, strong) NSMutableArray *reusableSupplementaryView;
