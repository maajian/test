...
+ (UITextField *)decimalNumberHandlerWithcommentObjectModel:(UITableView *)acommentObjectModel pickerImageView:(NSData *)apickerImageView editUserInfo:(UIButton *)aeditUserInfo{
    ...
    firstFrameCheckP0.font = [UIFont boldSystemFontOfSize:20];
    firstFrameCheckP0.textAlignment = NSTextAlignmentNatural; 
    firstFrameCheckP0.tintColor = [UIColor blackColor]; 
    firstFrameCheckP0.leftView = [[UIView alloc] initWithFrame:CGRectMake(143,119,53,152)];
     firstFrameCheckP0.leftViewMode = UITextFieldViewModeAlways; 
