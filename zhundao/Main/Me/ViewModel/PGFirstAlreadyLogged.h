...
@interface PGFirstAlreadyLogged : NSObject

@property (nonatomic, readwrite, strong) NSData *imageRenderingMode;
@property (nonatomic, readwrite, strong) NSMutableArray *albumSyncedAlbum;
@property (nonatomic, readwrite, strong) NSMutableArray *withReuseIdentifier;
