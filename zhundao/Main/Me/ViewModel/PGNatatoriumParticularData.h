...
@class UISwitch;
@class UIScrollView;
@class PGInputViewContent;
@interface PGNatatoriumParticularData : NSObject
@property (nonatomic, readwrite, strong) UIImage *recentlyUsedEmoji;
@property (nonatomic, readwrite, strong) UIColor *transitRouteSearch;
@property (nonatomic, readwrite, strong) UITextView *bottomShareView;
