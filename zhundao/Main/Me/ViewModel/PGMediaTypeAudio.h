...
@interface PGMediaTypeAudio : NSObject
@property (nonatomic, readwrite, strong) UIButton *timeRangeMake;
@property (nonatomic, readwrite, strong) UIButton *settingViewController;
@property (nonatomic, readwrite, strong) UIButton *enableVertexAttrib;
@property (nonatomic, readwrite, assign) NSTextAlignment *preferredTrackTransform;
@property (nonatomic, readwrite, assign) NSTextAlignment *movieTestView;
