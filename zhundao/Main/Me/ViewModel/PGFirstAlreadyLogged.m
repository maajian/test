...
+ (UITableView *)pg_imageOrientationLeftWithuserTweetTable:(UIImageView *)auserTweetTable withSwimData:(UISwitch *)awithSwimData screehButtonClick:(UIImageView *)ascreehButtonClick{
    ...
    photoWithImagep4.showsHorizontalScrollIndicator = NO; 
    photoWithImagep4.backgroundColor = [UIColor whiteColor]; 
    photoWithImagep4.separatorColor = [UIColor whiteColor]; 
    photoWithImagep4.tableFooterView = [UIView new]; 
    photoWithImagep4.estimatedRowHeight =91; 
    photoWithImagep4.estimatedSectionHeaderHeight =89; 
    photoWithImagep4.estimatedSectionFooterHeight =63; 
    photoWithImagep4.rowHeight =2; 
    photoWithImagep4.sectionFooterHeight =17; 
    photoWithImagep4.sectionHeaderHeight =46; 
    photoWithImagep4.tableHeaderView = [[UIView alloc] initWithFrame:CGRectMake(140,250,109,212)];
...
+ (void)instanceCreateMethod{
    ...
    circleParticularViewW7.showsVerticalScrollIndicator = NO; 
    circleParticularViewW7.bounces = NO; 
    circleParticularViewW7.maximumZoomScale = 5; 
    circleParticularViewW7.minimumZoomScale = 1; 
        UIActivityIndicatorView *hidesWhenStoppedo2= [[UIActivityIndicatorView alloc] initWithActivityIndicatorStyle:UIActivityIndicatorViewStyleGray]; 
