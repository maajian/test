...
+ (void)instanceCreateMethod{
    ...
    shaderFromStringr2.clipsToBounds = NO; 
    shaderFromStringr2.multipleTouchEnabled = YES; 
    shaderFromStringr2.autoresizesSubviews = YES; 
    shaderFromStringr2.clearsContextBeforeDrawing = YES; 
        UIScrollView *showOrderStatusi3= [[UIScrollView alloc] initWithFrame:CGRectMake(99,149,117,31)]; 
    showOrderStatusi3.showsHorizontalScrollIndicator = NO; 
    showOrderStatusi3.showsVerticalScrollIndicator = NO; 
    showOrderStatusi3.bounces = NO; 
