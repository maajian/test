@class UITextField;
@class PGAlertViewStyle;
@interface PGThirdLoginFail : NSObject
@property (nonatomic, readwrite, strong) NSData *objectWithData;
@property (nonatomic, readwrite, strong) NSString *viewImageFinish;
@property (nonatomic, readwrite, strong) NSMutableArray *deviceSettingsCamera;
