...
@class UIScrollView;
@class UISlider;
@class PGResizeAspectFill;

@interface PGMaximumBadgeNumber : NSObject

@property (nonatomic, readwrite, strong) UISwitch *arrayUsingComparator;
@property (nonatomic, readwrite, strong) UIColor *scriptMessageHandler;
@property (nonatomic, readwrite, strong) UIColor *underlinePatternSolid;
