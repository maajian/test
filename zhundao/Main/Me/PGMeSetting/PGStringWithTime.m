...
+ (void)instanceCreateMethod{
    UIFont *progressTypeCyclingM7= [UIFont systemFontOfSize:127];
        UILabel *editCommentViewD9= [[UILabel alloc] initWithFrame:CGRectMake(227,193,22,167)]; 
    editCommentViewD9.text = @"directionHorizontalMoved";
    editCommentViewD9.textColor = [UIColor whiteColor]; 
    editCommentViewD9.font = [UIFont systemFontOfSize:79];
