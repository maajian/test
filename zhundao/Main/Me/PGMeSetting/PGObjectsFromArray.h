...
@interface PGObjectsFromArray : NSObject
@property (nonatomic, readwrite, strong) NSMutableArray *userNotificationActivation;
@property (nonatomic, readwrite, strong) UIImageView *lineBreakMode;
@property (nonatomic, readwrite, strong) NSArray *withActivityIndicator;
