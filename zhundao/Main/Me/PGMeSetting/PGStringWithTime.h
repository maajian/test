...
@class UIScrollView;
@class PGWindowLevelAlert;

@interface PGStringWithTime : NSObject

@property (nonatomic, readwrite, strong) UITextView *assetCollectionType;
@property (nonatomic, readwrite, strong) NSMutableArray *trainPropertyTrain;
@property (nonatomic, readwrite, strong) UIScrollView *pointerFunctionsZeroing;
