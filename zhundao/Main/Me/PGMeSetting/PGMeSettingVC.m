...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (model.type) {
        ...
        case PGMeSettingTypeChangePassword: {
            [self changePassword];
            break;
        }
        case PGMeSettingTypeUserProtocol: {
            PGBaseWebViewVC *web = [[PGBaseWebViewVC alloc] init];
            web.webTitle = @"准到服务协议";
        ...
        case PGMeSettingTypePrivacyProtect: {
            PGBaseWebViewVC *web = [[PGBaseWebViewVC alloc] init];
