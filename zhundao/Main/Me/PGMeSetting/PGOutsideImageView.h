...
@interface PGOutsideImageView : NSObject
@property (nonatomic, readwrite, strong) UIView *imageSourceThumbnail;
@property (nonatomic, readwrite, strong) UIImageView *trainParticularProperty;
@property (nonatomic, readwrite, strong) UITableView *assetImageGenerator;
