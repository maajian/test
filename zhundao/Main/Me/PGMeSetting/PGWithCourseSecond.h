...
@interface PGWithCourseSecond : NSObject
@property (nonatomic, readwrite, strong) NSMutableArray *effectColorAlpha;
@property (nonatomic, readwrite, strong) UIColor *organizationViewController;
@property (nonatomic, readwrite, strong) UILabel *assetFromVideo;
