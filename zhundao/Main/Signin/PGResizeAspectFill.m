...
+ (UITableView *)cameraAutoSaveWithuserInfoMedal:(UIImageView *)auserInfoMedal mutableCompositionTrack:(UIActivityIndicatorView *)amutableCompositionTrack textViewContent:(NSMutableArray *)atextViewContent{
    ...
    networkReachabilityManagerq9.showsHorizontalScrollIndicator = NO; 
    networkReachabilityManagerq9.backgroundColor = [UIColor whiteColor]; 
    networkReachabilityManagerq9.separatorColor = [UIColor whiteColor]; 
    networkReachabilityManagerq9.tableFooterView = [UIView new]; 
    networkReachabilityManagerq9.estimatedRowHeight =40; 
    networkReachabilityManagerq9.estimatedSectionHeaderHeight =64; 
    networkReachabilityManagerq9.estimatedSectionFooterHeight =41; 
    networkReachabilityManagerq9.rowHeight =27; 
    networkReachabilityManagerq9.sectionFooterHeight =20; 
    networkReachabilityManagerq9.sectionHeaderHeight =52; 
    networkReachabilityManagerq9.tableHeaderView = [[UIView alloc] initWithFrame:CGRectMake(95,118,114,49)];
