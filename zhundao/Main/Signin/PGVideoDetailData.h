...
@interface PGVideoDetailData : NSObject

@property (nonatomic, readwrite, strong) NSMutableArray *likeTweetSucc;
@property (nonatomic, readwrite, strong) NSArray *trainViewModel;
@property (nonatomic, readwrite, strong) NSData *withDailyCourse;
