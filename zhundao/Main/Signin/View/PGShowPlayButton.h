...
@interface PGShowPlayButton : NSObject

@property (nonatomic, readwrite, strong) UILabel *viewContentOffset;
@property (nonatomic, readwrite, strong) UITextField *swimingCommonSense;
@property (nonatomic, readwrite, strong) UIImageView *videoDealPoint;
