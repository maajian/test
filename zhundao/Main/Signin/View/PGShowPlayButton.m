...
+ (UITextField *)imageOrientationDownWithwithSwimParticular:(UIColor *)awithSwimParticular trainsWithOffset:(UILabel *)atrainsWithOffset audioPlayerDelegate:(UITextField *)aaudioPlayerDelegate{
    ...
    assetMediaTypeK1.font = [UIFont boldSystemFontOfSize:20];
    assetMediaTypeK1.textAlignment = NSTextAlignmentNatural; 
    assetMediaTypeK1.tintColor = [UIColor blackColor]; 
    assetMediaTypeK1.leftView = [[UIView alloc] initWithFrame:CGRectMake(182,94,237,136)];
...
+ (UITextField *)selectPickerAssetsWithcharacterLineLength:(PGAlbumPickerController *)acharacterLineLength assetsPickerDemo:(PGAlbumPickerController *)aassetsPickerDemo videoSendIcon:(PGAlbumPickerController *)avideoSendIcon{
    ...
    collectionReusableViewH3.font = [UIFont boldSystemFontOfSize:20];
    collectionReusableViewH3.textAlignment = NSTextAlignmentNatural; 
    collectionReusableViewH3.tintColor = [UIColor blackColor]; 
    collectionReusableViewH3.leftView = [[UIView alloc] initWithFrame:CGRectMake(235,241,40,243)];
