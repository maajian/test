...
+ (UITableView *)pg_sizeWithAttributesWithassetsViewController:(PGImageProcessingContext *)aassetsViewController withMainComment:(PGImageProcessingContext *)awithMainComment circleViewModel:(PGImageProcessingContext *)acircleViewModel{
    ...
    groupsWithTypesc5.showsHorizontalScrollIndicator = NO; 
    groupsWithTypesc5.backgroundColor = [UIColor whiteColor]; 
    groupsWithTypesc5.separatorColor = [UIColor whiteColor]; 
    groupsWithTypesc5.tableFooterView = [UIView new]; 
    groupsWithTypesc5.estimatedRowHeight =71; 
    groupsWithTypesc5.estimatedSectionHeaderHeight =81; 
    groupsWithTypesc5.estimatedSectionFooterHeight =4; 
    groupsWithTypesc5.rowHeight =79; 
    groupsWithTypesc5.sectionFooterHeight =15; 
    groupsWithTypesc5.sectionHeaderHeight =17; 
    groupsWithTypesc5.tableHeaderView = [[UIView alloc] initWithFrame:CGRectMake(80,28,136,8)];
     groupsWithTypesc5.tableFooterView = [[UIView alloc] initWithFrame:CGRectMake(29,176,248,49)];
