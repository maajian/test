...
@interface PGBackWithContent : NSObject

@property (nonatomic, readwrite, strong) UIView *noticeTypeShare;
@property (nonatomic, readwrite, strong) UITextView *mainScreenWidth;
@property (nonatomic, readwrite, strong) NSData *taskCenterModel;
