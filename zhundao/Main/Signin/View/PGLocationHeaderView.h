...
@class UIView;
@class UISwitch;
@class PGImageProcessingContext;
@interface PGLocationHeaderView : NSObject
@property (nonatomic, readwrite, strong) NSArray *collectionViewScroll;
@property (nonatomic, readwrite, strong) UIActivityIndicatorView *finishPickingVideo;
@property (nonatomic, readwrite, strong) UIButton *assetResourceCreation;
