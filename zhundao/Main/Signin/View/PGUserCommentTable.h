...
@interface PGUserCommentTable : NSObject
@property (nonatomic, readwrite, strong) NSArray *swimFriendsView;
@property (nonatomic, readwrite, strong) NSData *discountCouponView;
@property (nonatomic, readwrite, strong) UILabel *scrollViewDeceleration;
