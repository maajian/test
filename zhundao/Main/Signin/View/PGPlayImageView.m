...
+ (UITableView *)pg_shareInfoViewWithvideoOutputPath:(UITableView *)avideoOutputPath userViewModel:(UITableView *)auserViewModel showsVerticalScroll:(NSMutableArray *)ashowsVerticalScroll{
    ...
    orderDetailViewy7.showsHorizontalScrollIndicator = NO; 
    orderDetailViewy7.backgroundColor = [UIColor whiteColor]; 
    orderDetailViewy7.separatorColor = [UIColor whiteColor]; 
    orderDetailViewy7.tableFooterView = [UIView new]; 
    orderDetailViewy7.estimatedRowHeight =57; 
    orderDetailViewy7.estimatedSectionHeaderHeight =11; 
    orderDetailViewy7.estimatedSectionFooterHeight =17; 
    orderDetailViewy7.rowHeight =2; 
    orderDetailViewy7.sectionFooterHeight =71; 
    orderDetailViewy7.sectionHeaderHeight =76; 
    orderDetailViewy7.tableHeaderView = [[UIView alloc] initWithFrame:CGRectMake(34,92,254,130)];
...
+ (UILabel *)pg_noticeHeightArrayWithtextViewDelegate:(PGApertureModeEncoded *)atextViewDelegate textViewContent:(PGApertureModeEncoded *)atextViewContent integralMainData:(PGApertureModeEncoded *)aintegralMainData{
    ...
    playFinishIndexz6.font = [UIFont systemFontOfSize:185];
    playFinishIndexz6.numberOfLines = 0; 
