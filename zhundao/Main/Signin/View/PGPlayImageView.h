...
@class UIScrollView;
@class UISlider;
@class PGApertureModeEncoded;
@interface PGPlayImageView : NSObject
@property (nonatomic, readwrite, strong) UITextView *objectsHashTable;
@property (nonatomic, readwrite, strong) UIActivityIndicatorView *courseParticularSection;
@property (nonatomic, readwrite, strong) NSArray *willEnterForeground;
