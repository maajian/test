...
@interface PGRankMedalBlock : NSObject
@property (nonatomic, readwrite, strong) UIScrollView *scrollDirectionRight;
@property (nonatomic, readwrite, strong) UIActivityIndicatorView *bindWithOpen;
@property (nonatomic, readwrite, strong) UIScrollView *assetFromVideo;
