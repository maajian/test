...
@interface PGDelaysTouchesEnded : NSObject
@property (nonatomic, readwrite, strong) NSString *answersTableView;
@property (nonatomic, readwrite, strong) UIActivityIndicatorView *particularNameData;
@property (nonatomic, readwrite, strong) UIFont *downLoadData;
