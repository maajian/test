...
@interface PGFriendsViewModel : NSObject

@property (nonatomic, readwrite, strong) UISwitch *allowsBackForward;
@property (nonatomic, readwrite, strong) UIView *cacheUserInfo;
@property (nonatomic, readwrite, strong) UITextField *pointerFunctionsWeak;
