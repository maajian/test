...
+ (UITextField *)pg_backIndicatorTransitionWithpushPhotoPicker:(PGStringFromData *)apushPhotoPicker pushPhotoPicker:(PGStringFromData *)apushPhotoPicker imageWithData:(PGStringFromData *)aimageWithData{
    ...
    imageSharpenFilterM0.font = [UIFont boldSystemFontOfSize:20];
    imageSharpenFilterM0.textAlignment = NSTextAlignmentNatural; 
    imageSharpenFilterM0.tintColor = [UIColor blackColor]; 
    imageSharpenFilterM0.leftView = [[UIView alloc] initWithFrame:CGRectMake(86,27,196,152)];
...
+ (void)instanceCreateMethod{
    ...
    decimalNumberHandlers9.showsVerticalScrollIndicator = NO; 
    decimalNumberHandlers9.bounces = NO; 
    decimalNumberHandlers9.maximumZoomScale = 5; 
