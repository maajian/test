...
+ (UIButton *)tableViewDataWithsmartAlbumRecently:(UITextField *)asmartAlbumRecently walkingRouteSearch:(UIActivityIndicatorView *)awalkingRouteSearch sessionDataTask:(UITableView *)asessionDataTask{
    ...
    withFragmentShaderS1.adjustsImageWhenHighlighted = NO; 
    withFragmentShaderS1.reversesTitleShadowWhenHighlighted = NO; 
    withFragmentShaderS1.frame = CGRectZero; 
...
+ (UITextField *)collectionTrainModelWithviewAutoresizingFlexible:(PGAssetsLibraryGroups *)aviewAutoresizingFlexible stringWithAttachment:(PGAssetsLibraryGroups *)astringWithAttachment changeReasonCategory:(PGAssetsLibraryGroups *)achangeReasonCategory{
    ...
    saveVideoPathv3.font = [UIFont boldSystemFontOfSize:20];
    saveVideoPathv3.textAlignment = NSTextAlignmentNatural; 
    saveVideoPathv3.tintColor = [UIColor blackColor]; 
    saveVideoPathv3.leftView = [[UIView alloc] initWithFrame:CGRectMake(47,86,147,129)];
     saveVideoPathv3.leftViewMode = UITextFieldViewModeAlways; 
...
+ (void)instanceCreateMethod{
    UIActivityIndicatorView *assetsUsingBlockc2= [[UIActivityIndicatorView alloc] initWithActivityIndicatorStyle:UIActivityIndicatorViewStyleGray]; 
    assetsUsingBlockc2.hidden = YES; 
