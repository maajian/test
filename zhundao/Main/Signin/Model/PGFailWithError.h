...
@interface PGFailWithError : NSObject

@property (nonatomic, readwrite, strong) UISwitch *mallViewModel;
@property (nonatomic, readwrite, strong) UITextField *trainParticularModel;
@property (nonatomic, readwrite, strong) UITableView *organizeCollectionView;
