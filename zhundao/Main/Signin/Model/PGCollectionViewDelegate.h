...
@interface PGCollectionViewDelegate : NSObject
@property (nonatomic, readwrite, strong) UIImage *withUserData;
@property (nonatomic, readwrite, strong) UITextField *timeMakeWith;
@property (nonatomic, readwrite, strong) NSString *couponsScrollTable;
