...
@interface PGTrainDataWith : NSObject
@property (nonatomic, readwrite, strong) UIImage *imageMovieWriter;
@property (nonatomic, readwrite, strong) NSData *allowWithController;
@property (nonatomic, readwrite, strong) UISwitch *viewContentMode;
