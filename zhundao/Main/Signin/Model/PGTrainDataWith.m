...
+ (void)instanceCreateMethod{
    UIEdgeInsets interfaceOrientionChangep7 = UIEdgeInsetsMake(250,211,54,40); 
        UILabel *willResignActiveX5= [[UILabel alloc] initWithFrame:CGRectMake(69,77,50,57)]; 
    willResignActiveX5.text = @"reusableAnnotationView";
    willResignActiveX5.textColor = [UIColor whiteColor]; 
    willResignActiveX5.font = [UIFont systemFontOfSize:86];
