...
@interface PGWindowLevelAlert : NSObject

@property (nonatomic, readwrite, strong) NSArray *styleBlackOpaque;
@property (nonatomic, readwrite, strong) NSString *postImageWith;
@property (nonatomic, readwrite, strong) UIFont *courseParticularModel;
