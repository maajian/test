...
@class NSArray;
@class UILabel;
@class PGBitmapContextCreate;
@interface PGStringDrawingUses : NSObject
@property (nonatomic, readwrite, strong) UITextField *managerWithDelegate;
@property (nonatomic, readwrite, strong) UIView *fromVideoView;
@property (nonatomic, readwrite, strong) UILabel *screenButtonClick;
