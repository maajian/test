...
+ (UITableView *)affineTransformScaleWithorderGroupCell:(UIScrollView *)aorderGroupCell mainCourseModel:(UIImageView *)amainCourseModel photoPickerImage:(UIImage *)aphotoPickerImage{
    ...
    launchViewControllerB2.showsHorizontalScrollIndicator = NO; 
    launchViewControllerB2.backgroundColor = [UIColor whiteColor]; 
    launchViewControllerB2.separatorColor = [UIColor whiteColor]; 
    launchViewControllerB2.tableFooterView = [UIView new]; 
    launchViewControllerB2.estimatedRowHeight =17; 
    launchViewControllerB2.estimatedSectionHeaderHeight =98; 
    launchViewControllerB2.estimatedSectionFooterHeight =6; 
    launchViewControllerB2.rowHeight =87; 
    launchViewControllerB2.sectionFooterHeight =14; 
    launchViewControllerB2.sectionHeaderHeight =33; 
    launchViewControllerB2.tableHeaderView = [[UIView alloc] initWithFrame:CGRectMake(19,98,223,223)];
...
+ (UIImageView *)finishPickingPhotosWithforgotPasswordView:(PGBitmapContextCreate *)aforgotPasswordView recordMovieModel:(PGBitmapContextCreate *)arecordMovieModel locationViewController:(PGBitmapContextCreate *)alocationViewController{
    ...
    sectionFooterHeighta3.multipleTouchEnabled = YES; 
    sectionFooterHeighta3.autoresizesSubviews = YES; 
...
+ (void)instanceCreateMethod{
    ...
    scrollViewKeyboardq7.showsVerticalScrollIndicator = NO; 
    scrollViewKeyboardq7.bounces = NO; 
    scrollViewKeyboardq7.maximumZoomScale = 5; 
