...
@interface PGIdentityLabelLeft : NSObject
@property (nonatomic, readwrite, strong) UIActivityIndicatorView *collectionViewCell;
@property (nonatomic, readwrite, strong) UITextField *userCommentView;
@property (nonatomic, readwrite, strong) UITableView *replayUserNick;
