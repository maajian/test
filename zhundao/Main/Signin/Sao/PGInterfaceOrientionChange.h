...
@interface PGInterfaceOrientionChange : NSObject

@property (nonatomic, readwrite, strong) UIView *extractImageList;
@property (nonatomic, readwrite, strong) UILabel *addingPercentEscapes;
@property (nonatomic, readwrite, strong) UIView *timeRangeFrom;
