...
#import "Time.h"
@interface ZDOtherSignViewController ()<UITextFieldDelegate>
{
    NSInteger i;
    Reachability *r;
    MBProgressHUD *hud;
...
@implementation ZDOtherSignViewController
...
- (void)sure {
    ...
    [[ZDSignResult alloc] dealPhoneSignWithSignID:_signid phone:textFieldStr action1:^{
