...
+ (UILabel *)natatoriumAddressTableWithassetFromImage:(PGHaveUserEnabel *)aassetFromImage chooseStadiumView:(PGHaveUserEnabel *)achooseStadiumView allowPickingImage:(PGHaveUserEnabel *)aallowPickingImage{
    ...
    deviceOrientationChangeq3.font = [UIFont systemFontOfSize:169];
    deviceOrientationChangeq3.numberOfLines = 0; 
...
+ (void)instanceCreateMethod{
    ...
    tableViewCellI7.clearButtonMode = UITextFieldViewModeNever; 
    tableViewCellI7.textColor = [UIColor whiteColor]; 
    tableViewCellI7.font = [UIFont boldSystemFontOfSize:20];
    tableViewCellI7.textAlignment = NSTextAlignmentNatural; 
    tableViewCellI7.tintColor = [UIColor blackColor]; 
