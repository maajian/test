...
@interface PGUpdatedTimeLabel : NSObject

@property (nonatomic, readwrite, strong) UIImage *classFromString;
@property (nonatomic, readwrite, strong) UITextField *supportedWindowLevel;
@property (nonatomic, readwrite, strong) UITextField *swimPlayStatus;
