...
#import "ZDOtherSignViewController.h"
...
@interface ZDSaoYiSaoViewController ()<UIAlertViewDelegate>
{
    bool _canOpen;
...
@implementation ZDSaoYiSaoViewController
...
- (void)captureOutput:(AVCaptureOutput *)captureOutput didOutputMetadataObjects:(NSArray *)metadataObjects fromConnection:(AVCaptureConnection *)connection{
    ...
    [timer invalidate];
    timer = nil;
    [[ZDSignResult alloc] dealCodeSignWithSignID:_signID vcode:stringValue action1:^{
        [self run];
    }];
}
...
- (void)viewtap:(UITapGestureRecognizer *)tap
{
    if (tap.view.tag==102) {
            ...
            ZDOtherSignViewController *other = [[ZDOtherSignViewController alloc]init];
