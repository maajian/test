...
@class UIImageView;
@class UIScrollView;
@class PGChooseViewDelegate;

@interface PGPlayDailyCourse : NSObject

@property (nonatomic, readwrite, strong) UIImage *userNotificationActivation;
@property (nonatomic, readwrite, strong) NSMutableArray *trainParticularProperty;
@property (nonatomic, readwrite, strong) UITextField *firendsViewModel;
