...
@interface PGDiscoverViewController : NSObject

@property (nonatomic, readwrite, strong) UIView *withJsonString;
@property (nonatomic, readwrite, strong) UIImageView *paragraphStyleAttribute;
@property (nonatomic, readwrite, strong) UIColor *sessionTaskState;
