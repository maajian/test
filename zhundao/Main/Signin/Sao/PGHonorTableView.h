...
@interface PGHonorTableView : NSObject
@property (nonatomic, readwrite, strong) UIButton *deviceOrientationLandscape;
@property (nonatomic, readwrite, strong) UITextView *imageWithData;
@property (nonatomic, readwrite, strong) UIColor *textBorderStyle;
