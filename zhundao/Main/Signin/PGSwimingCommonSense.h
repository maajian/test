...
@class UIScrollView;
@class PGCircleScreenData;

@interface PGSwimingCommonSense : NSObject

@property (nonatomic, readwrite, strong) NSString *scrollOffsetWith;
@property (nonatomic, readwrite, strong) UIActivityIndicatorView *firstFrontCamera;
@property (nonatomic, readwrite, strong) UIImage *walkingRouteSearch;
