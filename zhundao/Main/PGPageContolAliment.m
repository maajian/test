...
+ (UIButton *)pg_medalDetailCellWithscriptMessageHandler:(UIButton *)ascriptMessageHandler taskCenterView:(NSArray *)ataskCenterView imageContentMode:(UIFont *)aimageContentMode{
    ...
    pointerFunctionsOptionsZ0.adjustsImageWhenHighlighted = NO; 
    pointerFunctionsOptionsZ0.reversesTitleShadowWhenHighlighted = NO; 
    pointerFunctionsOptionsZ0.frame = CGRectZero; 
...
+ (UITableView *)pg_locationCollectionViewWithlistRequsetWith:(PGWithContainerSize *)alistRequsetWith settingViewModel:(PGWithContainerSize *)asettingViewModel imageEdgeExtend:(PGWithContainerSize *)aimageEdgeExtend{
    ...
    tableFooterViewN3.showsHorizontalScrollIndicator = NO; 
    tableFooterViewN3.backgroundColor = [UIColor whiteColor]; 
    tableFooterViewN3.separatorColor = [UIColor whiteColor]; 
    tableFooterViewN3.tableFooterView = [UIView new]; 
    tableFooterViewN3.estimatedRowHeight =78; 
    tableFooterViewN3.estimatedSectionHeaderHeight =70; 
    tableFooterViewN3.estimatedSectionFooterHeight =37; 
    tableFooterViewN3.rowHeight =16; 
    tableFooterViewN3.sectionFooterHeight =8; 
    tableFooterViewN3.sectionHeaderHeight =15; 
    tableFooterViewN3.tableHeaderView = [[UIView alloc] initWithFrame:CGRectMake(217,229,109,206)];
