...
#import "ZDActivityBigImageFlowLayout.h"
@interface ZDActivityChooseBigImgCell()<imageSelectDelegate>
/*! 流水布局 */
@property(nonatomic,strong)ZDActivityBigImageFlowLayout *flowLayout;

@property(nonatomic,strong)ZDActivityBigImageCollectionView *collectView;

@end
@implementation ZDActivityChooseBigImgCell
...
- (ZDActivityBigImageCollectionView *)collectView {
    if (!_collectView) {
        _flowLayout = [[ZDActivityBigImageFlowLayout alloc]init];
        _collectView = [[ZDActivityBigImageCollectionView alloc]initWithFrame:CGRectMake(0, 0, kScreenWidth, _height) collectionViewLayout:_flowLayout];
    }
    return _collectView;
}
