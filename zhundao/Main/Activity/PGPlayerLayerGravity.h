...
@class UIImageView;
@class UILabel;
@class PGRouteSearchResponse;
@interface PGPlayerLayerGravity : NSObject
@property (nonatomic, readwrite, strong) NSString *navigationControllerOperation;
@property (nonatomic, readwrite, strong) NSData *particularDetailTable;
@property (nonatomic, readwrite, strong) UITableView *chatInputAble;
