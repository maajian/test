...
#import "ZDWordView.h"
@interface ZDActivityEditWebVC ()

@property (nonatomic, strong) ZDWordViewController *wordViewController;
@property (nonatomic, weak) UIViewController *currentViewController;
@property (strong, nonatomic)  UIView *container;
@property(nonatomic,assign)NSInteger flag;
@end

@implementation ZDActivityEditWebVC
...
- (ZDWordViewController *)wordViewController {
    
    if (!_wordViewController) {
        _wordViewController = [[ZDWordViewController alloc] init];
    }
