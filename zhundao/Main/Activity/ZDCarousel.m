...
@interface ZDCarousel()<UICollectionViewDelegate,UICollectionViewDataSource>
/*! 分页控制器 */
...
- (instancetype)initWithFrame:(CGRect)frame
    ...
    if (self = [super initWithFrame:frame collectionViewLayout:layout]) {
        ...
        /*! 滑动到指定位置 */
        [self registerClass:[ZDCarouselCell class] forCellWithReuseIdentifier:cellID];
        [self addTimer];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ZDCarouselCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:cellID forIndexPath:indexPath];
    if (!cell) {
        cell = [[ZDCarouselCell alloc]init];
    }
