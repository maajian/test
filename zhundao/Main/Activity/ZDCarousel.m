...
- (instancetype)initWithFrame:(CGRect)frame
    ...
    if (self = [super initWithFrame:frame collectionViewLayout:layout]) {
        ...
        /*! 滑动到指定位置 */
        [self registerClass:[ZDCollectionViewCell class] forCellWithReuseIdentifier:cellID];
        [self addTimer];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ZDCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:cellID forIndexPath:indexPath];
    if (!cell) {
        cell = [[ZDCollectionViewCell alloc]init];
    }
