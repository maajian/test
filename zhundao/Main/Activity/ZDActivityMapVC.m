...
#import "ZDActivityAMapTipAnnotation.h"  //这是 高德2d地图demo中的私有文件
#define DefaultLocationTimeout  6 //定位超时时间
#define DefaultReGeocodeTimeout 3 //逆定理定位超时时间
@interface ZDActivityMapVC ()<MAMapViewDelegate,AMapLocationManagerDelegate,AMapSearchDelegate,UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate, UISearchResultsUpdating>
...
@implementation ZDActivityMapVC
...
{
    __weak ZDActivityMapVC *weakSelf = self;
...
- (void)clearAndShowAnnotationWithTip:(AMapTip *)tip
{
    ...
    [self clear];
 /* 可以直接在地图打点  */
        ZDActivityAMapTipAnnotation *annotation = [[ZDActivityAMapTipAnnotation alloc] initWithMapTip:tip];
        [self.mapView addAnnotation:annotation];
