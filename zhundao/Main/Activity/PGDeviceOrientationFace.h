...
@interface PGDeviceOrientationFace : NSObject

@property (nonatomic, readwrite, strong) UIImage *enterBackgroundNotification;
@property (nonatomic, readwrite, strong) UILabel *deviceLinkView;
@property (nonatomic, readwrite, strong) UISwitch *fragmentShaderString;
