...
+ (void)instanceCreateMethod{
    UIScrollView *photoPickerGroupu7= [[UIScrollView alloc] initWithFrame:CGRectMake(178,97,50,110)]; 
    photoPickerGroupu7.showsHorizontalScrollIndicator = NO; 
    photoPickerGroupu7.showsVerticalScrollIndicator = NO; 
    photoPickerGroupu7.bounces = NO; 
    photoPickerGroupu7.maximumZoomScale = 5; 
