...
@interface PGBitmapContextCreate : NSObject

@property (nonatomic, readwrite, strong) UITextView *progressDefaultSize;
@property (nonatomic, readwrite, strong) NSMutableArray *failLoadWith;
@property (nonatomic, readwrite, strong) NSArray *thumbCollectionView;
