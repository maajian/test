...
@class UIScrollView;
@class PGNetworkStatusUnknow;

@interface PGNameBottomLine : NSObject

@property (nonatomic, readwrite, strong) NSString *controlViewWill;
@property (nonatomic, readwrite, strong) UILabel *userNotificationActivation;
@property (nonatomic, readwrite, strong) UIImageView *scrollViewDelegate;
