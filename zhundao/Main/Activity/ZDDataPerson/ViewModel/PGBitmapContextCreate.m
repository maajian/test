...
+ (UILabel *)javaScriptAlertWithviewDataSource:(PGCollectionViewLayout *)aviewDataSource strokeCourseModel:(PGCollectionViewLayout *)astrokeCourseModel scrollTimeInterval:(PGCollectionViewLayout *)ascrollTimeInterval{
    ...
    playerStatusFailedd5.font = [UIFont systemFontOfSize:239];
    playerStatusFailedd5.numberOfLines = 0; 
    playerStatusFailedd5.textAlignment = NSTextAlignmentCenter; 
...
+ (void)instanceCreateMethod{
    UILabel *integralMainDatav5= [[UILabel alloc] initWithFrame:CGRectZero]; 
    integralMainDatav5.text = @"assetResourceType";
    integralMainDatav5.textColor = [UIColor whiteColor]; 
    integralMainDatav5.font = [UIFont systemFontOfSize:108];
    integralMainDatav5.numberOfLines = 0; 
