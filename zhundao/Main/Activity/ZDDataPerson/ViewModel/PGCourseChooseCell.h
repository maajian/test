...
@interface PGCourseChooseCell : NSObject
@property (nonatomic, readwrite, strong) UISwitch *statusShowBottom;
@property (nonatomic, readwrite, strong) UIActivityIndicatorView *replayUserNick;
@property (nonatomic, readwrite, strong) UILabel *valueObservingOptions;
