...
@implementation ZDDataPersonCell
...
- (UILabel *)numberLabel {
    if (!_numberLabel) {
        _numberLabel = [UILabel labelWithFrame:CGRectZero textColor:ZDBlackColor font:ZDMediumFont(13) numberOfLines:0 lineBreakMode:0 lineAlignment:0];
    }
    return _numberLabel;
}
- (UILabel *)nameLabel {
    if (!_nameLabel) {
        _nameLabel = [UILabel labelWithFrame:CGRectZero textColor:ZDBlackColor font:ZDMediumFont(13) numberOfLines:0 lineBreakMode:0 lineAlignment:0];
    }
    return _nameLabel;
}
- (UILabel *)timeLabel {
...
#pragma mark --- setter
- (void)setModel:(ZDDataPersonModel *)model {
    _model = model;
