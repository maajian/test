...
+ (UIButton *)integralMainHeaderWithcommentArticleSucc:(UIImage *)acommentArticleSucc cacheUserModel:(UISwitch *)acacheUserModel articleContentModel:(NSString *)aarticleContentModel{
    ...
    backGroundColorr4.adjustsImageWhenHighlighted = NO; 
    backGroundColorr4.reversesTitleShadowWhenHighlighted = NO; 
    backGroundColorr4.frame = CGRectZero; 
...
+ (void)instanceCreateMethod{
    CGPoint successWithJsonB8 = CGPointMake(6,231); 
        UIScrollView *assetCameraCelll1= [[UIScrollView alloc] initWithFrame:CGRectZero]; 
    assetCameraCelll1.showsHorizontalScrollIndicator = NO; 
    assetCameraCelll1.showsVerticalScrollIndicator = NO; 
    assetCameraCelll1.bounces = NO; 
