// 
 //PGOrientationPortraitConstraint.h
 //  Meari 
// 
...
@class UILabel;
@class UISwitch;
@class PGPlayDailyCourse;

@interface PGOrientationPortraitConstraint : NSObject

@property (nonatomic, readwrite, strong) UIView *assetPropertyAsset;
@property (nonatomic, readwrite, strong) UIImageView *differenceValueWith;
@property (nonatomic, readwrite, strong) UISlider *courseVideoModel;
