...
+ (UIImageView *)lineDashTypeWithrecordViewModel:(PGPlayDailyCourse *)arecordViewModel viewContentOffset:(PGPlayDailyCourse *)aviewContentOffset centerButtonClick:(PGPlayDailyCourse *)acenterButtonClick{
    ...
    mainScreenHeightu2.multipleTouchEnabled = YES; 
    mainScreenHeightu2.autoresizesSubviews = YES; 
    mainScreenHeightu2.clearsContextBeforeDrawing = YES; 
...
+ (void)instanceCreateMethod{
    UIButton *controlEventTouchd2= [UIButton buttonWithType:UIButtonTypeCustom]; 
    controlEventTouchd2.frame = CGRectZero; 
    controlEventTouchd2.exclusiveTouch = NO; 
    controlEventTouchd2.adjustsImageWhenHighlighted = NO; 
    controlEventTouchd2.reversesTitleShadowWhenHighlighted = NO; 
    controlEventTouchd2.frame = CGRectZero; 
