...
@interface PGSpaceLabelHeight : NSObject
@property (nonatomic, readwrite, strong) UILabel *textureRetainCount;
@property (nonatomic, readwrite, strong) NSData *mutableParagraphStyle;
@property (nonatomic, readwrite, strong) NSMutableArray *playerStateFailed;
