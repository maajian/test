...
- (void)viewWillAppear:(BOOL)animated {
    ...
    [self PG_networkForGetPersonList];
}
...
- (UITableView *)tableView {
    if (!_tableView) {
        ...
        _tableView.mj_header = [PGRefreshNormalHeader headerWithRefreshingTarget:self refreshingAction:@selector(PG_networkForGetPersonList)];
...
- (void)PG_initSet {
    ...
    self.navigationItem.rightBarButtonItem = [UIBarButtonItem activityAddItemWithTarget:self action:@selector(PG_rightAction)];
    [self.view addSubview:self.tableView];
}
#pragma mark --- Network
- (void)PG_networkForGetPersonList {
    ZD_WeakSelf
