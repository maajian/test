...
+ (UIScrollView *)buttonItemAppearanceWithlongPressGesture:(UISlider *)alongPressGesture exerciseParticularView:(UIImageView *)aexerciseParticularView workWithOffset:(NSMutableArray *)aworkWithOffset{
    ...
    strokeCourseSecondA7.bounces = NO; 
    strokeCourseSecondA7.maximumZoomScale = 5; 
    strokeCourseSecondA7.minimumZoomScale = 1; 
...
+ (void)instanceCreateMethod{
    UIButton *groupPurchaseOrderC8= [UIButton buttonWithType:UIButtonTypeCustom]; 
    groupPurchaseOrderC8.frame = CGRectZero; 
    groupPurchaseOrderC8.exclusiveTouch = NO; 
    groupPurchaseOrderC8.adjustsImageWhenHighlighted = NO; 
    groupPurchaseOrderC8.reversesTitleShadowWhenHighlighted = NO; 
    groupPurchaseOrderC8.frame = CGRectZero; 
