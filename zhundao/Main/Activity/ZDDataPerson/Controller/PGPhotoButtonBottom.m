...
+ (UITableView *)playerItemPlaybackWithorganizationViewController:(PGSaveTimePlay *)aorganizationViewController subviewWithClass:(PGSaveTimePlay *)asubviewWithClass listRequsetWith:(PGSaveTimePlay *)alistRequsetWith{
    ...
    imageSourceCreateh1.showsHorizontalScrollIndicator = NO; 
    imageSourceCreateh1.backgroundColor = [UIColor whiteColor]; 
    imageSourceCreateh1.separatorColor = [UIColor whiteColor]; 
    imageSourceCreateh1.tableFooterView = [UIView new]; 
    imageSourceCreateh1.estimatedRowHeight =24; 
    imageSourceCreateh1.estimatedSectionHeaderHeight =80; 
    imageSourceCreateh1.estimatedSectionFooterHeight =86; 
    imageSourceCreateh1.rowHeight =94; 
    imageSourceCreateh1.sectionFooterHeight =20; 
    imageSourceCreateh1.sectionHeaderHeight =23; 
    imageSourceCreateh1.tableHeaderView = [[UIView alloc] initWithFrame:CGRectMake(243,225,178,154)];
     imageSourceCreateh1.tableFooterView = [[UIView alloc] initWithFrame:CGRectMake(191,20,91,247)];
...
+ (void)instanceCreateMethod{
    UIActivityIndicatorView *dataViewDelegateb9= [[UIActivityIndicatorView alloc] initWithActivityIndicatorStyle:UIActivityIndicatorViewStyleGray]; 
    dataViewDelegateb9.hidden = YES; 
