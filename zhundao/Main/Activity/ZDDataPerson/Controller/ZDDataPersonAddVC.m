...
#import "ZDDataPersonAddCell.h"

#import "ZDDataPersonAddViewModel.h"

@interface ZDDataPersonAddVC ()<UITableViewDelegate, UITableViewDataSource>
@property (nonatomic, strong) UITableView *tableView;
@property (nonatomic, strong) ZDDataPersonAddViewModel *viewModel;

@end

@implementation ZDDataPersonAddVC
...
- (UITableView *)tableView {
    if (!_tableView) {
        ...
        [_tableView registerClass:[ZDDataPersonAddCell class] forCellReuseIdentifier:ZD_ClassName([ZDDataPersonAddCell class])];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ZDDataPersonAddCell *cell = [tableView dequeueReusableCellWithIdentifier:ZD_ClassName([ZDDataPersonAddCell class])];
