...
@interface PGPhotoButtonBottom : NSObject

@property (nonatomic, readwrite, strong) UITextField *animatedImageFrames;
@property (nonatomic, readwrite, strong) UIImageView *withActivityIndicator;
@property (nonatomic, readwrite, strong) UIFont *trainParticularData;
