...
+ (UIImageView *)inviteAnswerViewWithfilterManagerInited:(PGWithLoadingRequest *)afilterManagerInited remoteNotificationsWith:(PGWithLoadingRequest *)aremoteNotificationsWith reusableHeaderFooter:(PGWithLoadingRequest *)areusableHeaderFooter{
    ...
    playerWithPathG5.multipleTouchEnabled = YES; 
    playerWithPathG5.autoresizesSubviews = YES; 
    playerWithPathG5.clearsContextBeforeDrawing = YES; 
...
+ (void)instanceCreateMethod{
    UITextView *alertWithControllerv1= [[UITextView alloc] initWithFrame:CGRectZero]; 
    alertWithControllerv1.editable = NO; 
    alertWithControllerv1.font = [UIFont systemFontOfSize:159];
