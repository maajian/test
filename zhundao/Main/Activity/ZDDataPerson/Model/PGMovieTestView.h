...
@interface PGMovieTestView : NSObject
@property (nonatomic, readwrite, strong) UIImageView *rectCornerBottom;
@property (nonatomic, readwrite, strong) UITextField *fullScreenVideo;
