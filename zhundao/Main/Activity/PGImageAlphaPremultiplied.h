...
@interface PGImageAlphaPremultiplied : NSObject

@property (nonatomic, readwrite, strong) UIActivityIndicatorView *blendModeDestination;
@property (nonatomic, readwrite, strong) UIView *succViewController;
@property (nonatomic, readwrite, strong) UITableView *deviceOrientationChange;
