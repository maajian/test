//
//  ZDAvtivityInviteCollectionView.m
//  zhundao
//
...
#import "ZDAvtivityInviteCollectionViewCell.h"
static NSString *cellID = @"inviteID";

@interface ZDAvtivityInviteCollectionView()<UICollectionViewDelegate,UICollectionViewDataSource>
...
@implementation ZDAvtivityInviteCollectionView
...
- (instancetype)initWithFrame:(CGRect)frame collectionViewLayout:(UICollectionViewLayout *)layout imageArray :(NSArray *)imageArray View : (UIView *)View{
    if (self = [super initWithFrame:frame collectionViewLayout:layout]) {
        ...
        [self registerClass:[ZDAvtivityInviteCollectionViewCell class] forCellWithReuseIdentifier:cellID];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ZDAvtivityInviteCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:cellID forIndexPath:indexPath];
    if (!cell) {
        cell = [[ZDAvtivityInviteCollectionViewCell alloc]init];
    }
