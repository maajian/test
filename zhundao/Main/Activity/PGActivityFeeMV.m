...
{
    NSString *str = [NSString stringWithFormat:@"%@api/PerActivity/GetActivityFee?accessKey=%@&activityFeeId=%li",zhundaoApi,[[PGSignManager shareManager] getaccseekey],(long)feeID];
