//
//  ZDActivityBigImageCollectionView.m
//  zhundao
//
...
@interface ZDActivityBigImageCollectionView()<UICollectionViewDelegate,UICollectionViewDataSource>
/*! 头视图名称 */
...
@end
@implementation ZDActivityBigImageCollectionView
...
- (instancetype)initWithFrame:(CGRect)frame collectionViewLayout:(UICollectionViewLayout *)layout{
    if (self = [super initWithFrame:frame collectionViewLayout:layout]) {
        ...
        [self registerClass:[ZDActivityBigImageCell class] forCellWithReuseIdentifier:cellID];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ZDActivityBigImageCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:cellID forIndexPath:indexPath];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    ZDActivityBigImageCell *Cell = (ZDActivityBigImageCell *)[collectionView cellForItemAtIndexPath:indexPath];
