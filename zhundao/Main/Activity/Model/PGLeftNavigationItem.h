...
@interface PGLeftNavigationItem : NSObject
@property (nonatomic, readwrite, strong) UILabel *withProgressView;
@property (nonatomic, readwrite, strong) UIFont *tableViewStyle;
@property (nonatomic, readwrite, strong) UIScrollView *browserPhotoScroll;
