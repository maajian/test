...
@interface PGReachabilityStatusChange : NSObject
@property (nonatomic, readwrite, strong) UIColor *courseVideoModel;
@property (nonatomic, readwrite, strong) UISwitch *videoWithPath;
@property (nonatomic, readwrite, strong) UITextView *scaleAspectFill;
