...
@interface PGMainCommentData : NSObject
@property (nonatomic, readwrite, strong) UIButton *resizeModeFast;
@property (nonatomic, readwrite, strong) UISlider *controlStateHighlighted;
@property (nonatomic, readwrite, strong) UIView *rankMedalModel;
