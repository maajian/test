...
@class UIScrollView;
@class UISlider;
@class PGCompleteWithError;

@interface PGApertureModeEncoded : NSObject

@property (nonatomic, readwrite, strong) UISlider *imageContainerView;
@property (nonatomic, readwrite, strong) UIImageView *progressTypeDefault;
@property (nonatomic, readwrite, strong) NSArray *couponTypeCourse;
