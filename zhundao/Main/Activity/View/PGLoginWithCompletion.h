...
@class UIScrollView;
@class UISlider;
@class PGLoginViewModel;

@interface PGLoginWithCompletion : NSObject

@property (nonatomic, readwrite, strong) NSData *integralRecordView;
@property (nonatomic, readwrite, strong) UILabel *exerciseHistoryData;
@property (nonatomic, readwrite, strong) UIActivityIndicatorView *withTintColor;
