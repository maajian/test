...
@interface PGUserContentController : NSObject

@property (nonatomic, readwrite, strong) UILabel *writingPrettyPrinted;
@property (nonatomic, readwrite, strong) NSArray *modalTransitionStyle;
@property (nonatomic, readwrite, strong) UIColor *trainCommentTable;
