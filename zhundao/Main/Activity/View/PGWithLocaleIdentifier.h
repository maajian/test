...
@interface PGWithLocaleIdentifier : NSObject

@property (nonatomic, readwrite, strong) NSData *compositionWithAsset;
@property (nonatomic, readwrite, strong) UIImage *withCommentObject;
@property (nonatomic, readwrite, strong) UIScrollView *numberWithString;
