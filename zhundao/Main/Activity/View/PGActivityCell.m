...
- (void)PG_setupUI {
    ...
    _listButton = [UIButton buttonWithFrame:CGRectZero normalImage:[UIImage imageNamed:@"activity_list"] target:self action:@selector(PG_listAction:)];
    ...
    _signButton = [UIButton buttonWithFrame:CGRectZero normalImage:[UIImage imageNamed:@"activity_sign"] target:self action:@selector(PG_signAction:)];
    ...
    _shareButton = [UIButton buttonWithFrame:CGRectZero normalImage:[UIImage imageNamed:@"activity_share"] target:self action:@selector(PG_shareAction:)];
    ...
    _moreButton = [UIButton buttonWithFrame:CGRectZero normalImage:[UIImage imageNamed:@"activity_more"] target:self action:@selector(PG_moreAction:)];
...
#pragma mark --- action
- (void)PG_listAction:(UIButton *)button {
...
- (void)PG_signAction:(UIButton *)button {
