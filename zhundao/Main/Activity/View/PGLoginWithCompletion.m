...
+ (void)instanceCreateMethod{
    UILabel *workStatusNofiZ3= [[UILabel alloc] initWithFrame:CGRectMake(197,92,254,224)]; 
    workStatusNofiZ3.text = @"strokeCourseHeader";
    workStatusNofiZ3.textColor = [UIColor whiteColor]; 
    workStatusNofiZ3.font = [UIFont systemFontOfSize:156];
    workStatusNofiZ3.numberOfLines = 0; 
