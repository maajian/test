...
- (void)setimage
{
    ...
    UILabel *titleLabel = [[UILabel alloc]initWithFrame:CGRectMake(imageViewMinX-17, imageViewMinY-40, imageViewWidth+34, 30)];   
    titleLabel.text = _labelStr;
    titleLabel.textColor = ZDGrayColor;
    titleLabel.font = [UIFont systemFontOfSize:14];
    titleLabel.textAlignment = NSTextAlignmentCenter;
    [self.view addSubview:titleLabel];
    UILabel *label1 = [[UILabel alloc]initWithFrame:CGRectMake(0, 10, imageViewWidth+40, 40)];   
    label1.text =self.titlestr;
    label1.font = [UIFont systemFontOfSize:15];
    label1.textAlignment = NSTextAlignmentCenter;
    [BackView addSubview:label1];
    UILabel *label2 = [[UILabel alloc]initWithFrame:CGRectMake(imageViewMinX-20, imageViewMaxY, imageViewWidth+40, 40)];  
    ...
    UIButton *button = [[UIButton alloc]initWithFrame:CGRectMake(0, imageViewHeight+120, imageViewWidth+40, 40)];   
