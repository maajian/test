...
@interface ZDStatisticsBottomView()
...
@implementation ZDStatisticsBottomView
...
#pragma mark --- setter
- (void)setDataSource:(NSMutableArray<ZDStatisticsModel *> *)dataSource {
    ...
    for (int i = 0 ; i< self.dataSource.count; i++) {
        ZDStatisticsModel *model = self.dataSource[i];
