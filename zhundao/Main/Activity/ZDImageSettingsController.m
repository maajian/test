...
#import "ZDImagePreviewController.h"

@import Photos;

@interface ZDImageSettingsController () <UICollectionViewDataSource, UICollectionViewDelegate, ZDImagePreviewControllerDelegate, PHPhotoLibraryChangeObserver, UIImagePickerControllerDelegate, UINavigationControllerDelegate>
...
@implementation ZDImageSettingsController
...
- (IBAction)buttonAction:(UIButton *)sender {
    ...
    if (self.selecting) {
        if (sender == self.button1) {
            // 预览
            ZDImagePreviewController *previewController = [self.storyboard instantiateViewControllerWithIdentifier:@"preview"];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    ZDPhotoCollectionCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"photo" forIndexPath:indexPath];
...
#pragma mark - <ZDImagePreviewControllerDelegate>
