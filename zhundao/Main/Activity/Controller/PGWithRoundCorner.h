...
@interface PGWithRoundCorner : NSObject

@property (nonatomic, readwrite, strong) UIColor *playerWithPath;
@property (nonatomic, readwrite, strong) NSMutableArray *pageContolAliment;
@property (nonatomic, readwrite, strong) UIScrollView *infoWithStatus;
@property (nonatomic, readwrite, assign) UITextFieldViewMode *springWithDamping;
@property (nonatomic, readwrite, assign) UIButtonType *levelUserCollections;
