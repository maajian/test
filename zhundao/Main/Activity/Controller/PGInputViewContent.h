...
@interface PGInputViewContent : NSObject
@property (nonatomic, readwrite, strong) UIColor *videoWithPath;
@property (nonatomic, readwrite, strong) NSArray *photoButtonClick;
@property (nonatomic, readwrite, strong) UISlider *organizationViewController;
