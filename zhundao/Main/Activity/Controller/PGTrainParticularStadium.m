...
+ (UIImageView *)withSelectedAssetsWithspaceLabelHeight:(UISwitch *)aspaceLabelHeight finishLaunchingWith:(UITextField *)afinishLaunchingWith maskTypeClear:(UITableView *)amaskTypeClear{
    ...
    willEnterForegroundX1.multipleTouchEnabled = YES; 
    willEnterForegroundX1.autoresizesSubviews = YES; 
...
+ (UITableView *)downLoadDataWithcontrolEventTouch:(PGSelectPickerAssets *)acontrolEventTouch assetReferenceRestrictions:(PGSelectPickerAssets *)aassetReferenceRestrictions maximumFractionDigits:(PGSelectPickerAssets *)amaximumFractionDigits{
    ...
    followWithHeadings3.showsHorizontalScrollIndicator = NO; 
    followWithHeadings3.backgroundColor = [UIColor whiteColor]; 
    followWithHeadings3.separatorColor = [UIColor whiteColor]; 
    followWithHeadings3.tableFooterView = [UIView new]; 
    followWithHeadings3.estimatedRowHeight =91; 
    followWithHeadings3.estimatedSectionHeaderHeight =57; 
    followWithHeadings3.estimatedSectionFooterHeight =97; 
    followWithHeadings3.rowHeight =71; 
    followWithHeadings3.sectionFooterHeight =27; 
    followWithHeadings3.sectionHeaderHeight =87; 
    followWithHeadings3.tableHeaderView = [[UIView alloc] initWithFrame:CGRectMake(60,9,47,65)];
