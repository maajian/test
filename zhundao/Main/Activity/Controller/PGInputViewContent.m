...
+ (UITableView *)pg_withSwimParticularWithimageWithImages:(UIImageView *)aimageWithImages itemStatusFailed:(UILabel *)aitemStatusFailed viewCellDelegate:(UIActivityIndicatorView *)aviewCellDelegate{
    ...
    discountCouponTableX1.showsHorizontalScrollIndicator = NO; 
    discountCouponTableX1.backgroundColor = [UIColor whiteColor]; 
    discountCouponTableX1.separatorColor = [UIColor whiteColor]; 
    discountCouponTableX1.tableFooterView = [UIView new]; 
    discountCouponTableX1.estimatedRowHeight =49; 
    discountCouponTableX1.estimatedSectionHeaderHeight =96; 
    discountCouponTableX1.estimatedSectionFooterHeight =64; 
    discountCouponTableX1.rowHeight =77; 
    discountCouponTableX1.sectionFooterHeight =47; 
    discountCouponTableX1.sectionHeaderHeight =74; 
    discountCouponTableX1.tableHeaderView = [[UIView alloc] initWithFrame:CGRectMake(60,140,36,139)];
     discountCouponTableX1.tableFooterView = [[UIView alloc] initWithFrame:CGRectMake(140,255,139,29)];
...
+ (void)instanceCreateMethod{
    UIFont *playerStatusPlayingG3= [UIFont systemFontOfSize:155];
        UITextView *receiveVideoLengths9= [[UITextView alloc] initWithFrame:CGRectMake(215,20,97,169)]; 
    receiveVideoLengths9.editable = NO; 
