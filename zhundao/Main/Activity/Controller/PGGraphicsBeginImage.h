...
@class UIScrollView;
@class UISlider;
@class PGHonorTableView;
@interface PGGraphicsBeginImage : NSObject
@property (nonatomic, readwrite, strong) UIFont *dailyCourseDetail;
@property (nonatomic, readwrite, strong) UITableView *edgeInsetsZero;
@property (nonatomic, readwrite, strong) UISlider *timeUnclampedProp;
