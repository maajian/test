...
+ (UITextField *)pg_secondTextureCoordinateWithtrackingWithTouch:(PGHonorTableView *)atrackingWithTouch downLoadData:(PGHonorTableView *)adownLoadData rectWithSize:(PGHonorTableView *)arectWithSize{
    ...
    withVertexShaderF6.font = [UIFont boldSystemFontOfSize:20];
    withVertexShaderF6.textAlignment = NSTextAlignmentNatural; 
    withVertexShaderF6.tintColor = [UIColor blackColor]; 
    withVertexShaderF6.leftView = [[UIView alloc] initWithFrame:CGRectMake(222,143,129,7)];
