...
+ (void)instanceCreateMethod{
    UIEdgeInsets dailyCourseDetailg4 = UIEdgeInsetsMake(157,70,15,185); 
        UIScrollView *contextStrokePathm0= [[UIScrollView alloc] initWithFrame:CGRectZero]; 
    contextStrokePathm0.showsHorizontalScrollIndicator = NO; 
    contextStrokePathm0.showsVerticalScrollIndicator = NO; 
    contextStrokePathm0.bounces = NO; 
