...
- (UITableView *)tableview
{
    if (!_tableview) {
        ...
        [_tableview registerNib:[UINib nibWithNibName:@"PGAvtivityOptionTableViewCell" bundle:nil] forCellReuseIdentifier:@"optionid"];
    }
    return _tableview;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
  if (indexPath.section==1&&indexPath.row!=0) {
        PGAvtivityOptionTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:optionid];
        if (!cell) {
            cell = [[PGAvtivityOptionTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:optionid];
        }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    PGAvtivityOptionTableViewCell *Cell = [tableView cellForRowAtIndexPath:indexPath];
