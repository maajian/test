...
@implementation oneActivityViewController
...
- (void)signin
{
    PostSignViewController *one = [[PostSignViewController alloc]init];
...
- (void)changeModelswitchButton :(UISwitch *)switchButton{
    ...
    [[NSUserDefaults standardUserDefaults]synchronize];
    signinModel *model = [signinModel yy_modelWithDictionary:[changeDic copy] ];
