...
@interface ChooseBigImgTableViewCell()<imageSelectDelegate>
/*! 流水布局 */
@property(nonatomic,strong)BigImageFlowLayout *flowLayout;

@property(nonatomic,strong)BigImageCollectionView *collectView;

@end
@implementation ChooseBigImgTableViewCell
...
- (BigImageCollectionView *)collectView {
    if (!_collectView) {
        _flowLayout = [[BigImageFlowLayout alloc]init];
        _collectView = [[BigImageCollectionView alloc]initWithFrame:CGRectMake(0, 0, kScreenWidth, _height) collectionViewLayout:_flowLayout];
    }
    return _collectView;
}
