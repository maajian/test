...
@interface PGRecoderSelectPicker : NSObject
@property (nonatomic, readwrite, strong) UIColor *accessoryDisclosureIndicator;
@property (nonatomic, readwrite, strong) UIImage *photoViewDelegate;
@property (nonatomic, readwrite, strong) UIImageView *weekTimeLabel;
