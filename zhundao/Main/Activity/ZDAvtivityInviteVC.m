...
#import "ZDAvtivityInviteCollectionView.h"
#import "BigSizeButton.h"
@interface ZDAvtivityInviteVC () <ZDAvtivityinviteDelegate>
{
...
@property(nonatomic,strong)ZDAvtivityInviteViewModel *ViewModel;
/*! 滑动视图 */
@property(nonatomic,strong)ZDAvtivityInviteCollectionView *collectionView;
/*! 图片数组 */
...
@implementation ZDAvtivityInviteVC
...
- (ZDAvtivityInviteViewModel *)ViewModel{
    if (!_ViewModel) {
        _ViewModel = [[ZDAvtivityInviteViewModel alloc]init];
    }
    return _ViewModel;
}
- (ZDAvtivityInviteCollectionView *)collectionView{
    if (!_collectionView) {
        UICollectionViewFlowLayout *flowLayout = [[UICollectionViewFlowLayout alloc]init];
        flowLayout.itemSize = CGSizeMake(kScreenWidth, kScreenHeight-40);
        flowLayout.scrollDirection = UICollectionViewScrollDirectionHorizontal;
        flowLayout.minimumLineSpacing = 0 ;
        _collectionView = [[ZDAvtivityInviteCollectionView alloc]initWithFrame:CGRectMake(0, 0, kScreenWidth, kScreenHeight-40) collectionViewLayout:flowLayout imageArray:self.imageArray View : self.view];
...
- (void)shareImage
{
    [[ZDSignManager shareManager]shareImagewithModel:_model withCTR:self Withtype:1 withImage:self.imageArray[_index]];
}
