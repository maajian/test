...
- (void)awakeFromNib {
    ...
    for (UIButton *button in self.buttons) {
        [button addTarget:self action:@selector(PG_selectButton:) forControlEvents:UIControlEventTouchUpInside];
    }
}
...
- (void)PG_selectButton:(UIButton *)button {
