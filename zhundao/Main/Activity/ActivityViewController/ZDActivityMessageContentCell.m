//
//  ZDActivityMessageContentCell.m
//  zhundao
//
...
@interface ZDActivityMessageContentCell()
@property (nonatomic, strong) UILabel *titleLabel;
@property (nonatomic, strong) UILabel *statusLabel;

@end

@implementation ZDActivityMessageContentCell
...
#pragma mark --- 赋值
- (void)setModel:(ZDActivityMessageContentModel *)model {
    _model = model;
    ...
    if (model.isSystem) {
        ...
        switch (model.messageStatusType) {
            case ZDMessageStatusTypeSuccess:
