...
@interface ZDActivityGroupSendCell()<UITextViewDelegate>

@end
@implementation ZDActivityGroupSendCell
...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary<NSKeyValueChangeKey,id> *)change context:(void *)context{
    ...
    ZDActivityGroupSendCell *cell1 = [tableView cellForRowAtIndexPath:[NSIndexPath indexPathForRow:2 inSection:2]];
    ZDActivityGroupSendCell *cell2 = [tableView cellForRowAtIndexPath:[NSIndexPath indexPathForRow:3 inSection:2]];
    ...
    [self attributeForRightLabel:cell2.rightLabel];
     ZDActivityGroupSendCell *cell3 = [tableView cellForRowAtIndexPath:[NSIndexPath indexPathForRow:0 inSection:2]];
