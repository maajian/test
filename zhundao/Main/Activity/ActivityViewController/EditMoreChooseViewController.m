//
//  EditMoreChooseViewController.m
//  zhundao
//
...
@interface EditMoreChooseViewController ()<UITableViewDelegate,UITableViewDataSource>
@property(nonatomic,strong)UITableView *tableView ;
@property(nonnull,strong)EditMoreChooseViewModel *VM;
@property(nonatomic,strong)NSMutableArray *indexArray ;
@end

@implementation EditMoreChooseViewController
