//
//  ZDActivityMessageContentViewModel.m
//  zhundao
//
...
@implementation ZDActivityMessageContentViewModel
...
- (void)getSystemWithPageIndex:(NSInteger)pageIndex success:(ZDBlock_Dic)success failure:(ZDBlock_Error_Str)failure {
    ...
    [ZD_NetWorkM postDataWithMethod:str parameters:dic succ:^(NSDictionary *obj) {
        ...
        for (NSDictionary *dic in obj[@"data"]) {
            ZDActivityMessageContentModel *model = [[ZDActivityMessageContentModel alloc] initWithDic:dic];
            model.isSystem = YES;
