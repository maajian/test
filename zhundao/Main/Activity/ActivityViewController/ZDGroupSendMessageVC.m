...
@interface ZDGroupSendMessageVC ()<UITableViewDelegate,UITableViewDataSource,successSendViewDeleagte, GroupSendTableViewCellDelegate> {
    NSInteger _es_id;
}
...
@implementation ZDGroupSendMessageVC
