...
@interface ZDActivityMessageContentVC ()<ZDSegmentViewDelegate> {
    NSInteger _index;
}
...
@implementation ZDActivityMessageContentVC
...
#pragma mark --- 新增文案
- (void)addContent{
    ZDActivityChangeContentVC *content = [[ZDActivityChangeContentVC alloc]init];
