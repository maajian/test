...
- (void)setUI{
    ...
    UIButton *button = [MyButton initWithButtonFrame:CGRectMake(10, 200, kScreenWidth-20, 44) title:@"提交" textcolor:[UIColor whiteColor] Target:self action:@selector(sureAction) BackgroundColor:zhundaoGreenColor cornerRadius:4 masksToBounds:1];
