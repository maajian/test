//
//  ZDActivityMessageContentViewModel.h
//  zhundao
//
...
@interface ZDActivityMessageContentViewModel : NSObject
...
@property (nonatomic, strong) NSMutableArray<ZDActivityMessageContentModel *> *systemArray;

@property (nonatomic, strong) NSMutableArray *customHeightArray;
@property (nonatomic, strong) NSMutableArray<ZDActivityMessageContentModel *> *customArray;
