...
@interface PGBadgeMaximumBadge : NSObject
@property (nonatomic, readwrite, strong) UIColor *withDailyCourse;
@property (nonatomic, readwrite, strong) NSString *keyboardTypeEmail;
@property (nonatomic, readwrite, strong) UIButton *cellReuseIdentifier;
