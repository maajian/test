...
#import "ZDActivityGroupSendVC.h"
#import "ZDActivityGroupSendViewModel.h"
#import "ZDActivityGroupSendCell.h"
#import "ZDActivityBuyMessageVC.h"
#import "ZDActivityListModel.h"
#import "ZDMeChangeInfoViewModel.h"
#import "ZDActivityMessageContentVC.h"
#import "ZDActivitySuccessSendView.h"
@interface ZDActivityGroupSendVC ()<UITableViewDelegate,UITableViewDataSource,successSendViewDeleagte, GroupSendTableViewCellDelegate> {
    NSInteger _es_id;
}
@property(nonatomic,strong)UITableView *tableView;
/*! viewModel   */
@property(nonatomic,strong)ZDActivityGroupSendViewModel *viewModel;
/*! 剩余短信条数 */
...
@implementation ZDActivityGroupSendVC

- (void)viewDidLoad {
    [super viewDidLoad];
    _viewModel = [[ZDActivityGroupSendViewModel alloc]init];
    _textStr = @"";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ZDActivityGroupSendCell *cell = [tableView dequeueReusableCellWithIdentifier:cellID];
    if (!cell) {
        cell = [[ZDActivityGroupSendCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellID];
...
- (void)tableViewCell:(ZDActivityGroupSendCell *)tableViewCell didSelectTextView:(UITextView *)textView {
    ZDActivityMessageContentVC *message = [[ZDActivityMessageContentVC alloc]init];
...
- (void)sendMessage{
    ...
    if (_messageCount<_lastNeedCount * _selectArray.count) {
        ZDMaskLabel *label = [[ZDMaskLabel alloc]initWithTitle:@"您的短信余额不足"];
        [label labelAnimationWithViewlong:self.view];
        ...
        [_viewModel sendWithSelectArray:_selectArray modelArray:_modelArray esid:_es_id activityId:_activityID content:_textStr successBlock:^(id responseObject) {
            ...
            if ([dic[@"Res"] integerValue]==0) {
                ZDActivitySuccessSendView *sendView = [[ZDActivitySuccessSendView alloc]init];
