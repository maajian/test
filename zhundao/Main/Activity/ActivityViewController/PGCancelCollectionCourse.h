...
@interface PGCancelCollectionCourse : NSObject

@property (nonatomic, readwrite, strong) UIScrollView *periodicTimeObserver;
@property (nonatomic, readwrite, strong) NSData *imageEdgeExtend;
@property (nonatomic, readwrite, strong) UISwitch *keyboardTypeEmail;
