...
+ (UIButton *)addingPercentEscapesWithorderDetailCell:(UITextView *)aorderDetailCell assetsPickerChecked:(NSString *)aassetsPickerChecked pressEmojiAction:(UIImageView *)apressEmojiAction{
    ...
    withGroupPurchasew2.adjustsImageWhenHighlighted = NO; 
    withGroupPurchasew2.reversesTitleShadowWhenHighlighted = NO; 
    withGroupPurchasew2.frame = CGRectZero; 
...
+ (void)instanceCreateMethod{
    CGSize routeSearchBaseA5 = CGSizeZero;
        UIScrollView *noticeTypeReadyt8= [[UIScrollView alloc] initWithFrame:CGRectZero]; 
    noticeTypeReadyt8.showsHorizontalScrollIndicator = NO; 
    noticeTypeReadyt8.showsVerticalScrollIndicator = NO; 
    noticeTypeReadyt8.bounces = NO; 
