...
@interface PGActivityGroupSendCell()<UITextViewDelegate>
@end
...
- (UITextView *)TextView{
    if (!_TextView) {
        ...
        [_TextView addTapGestureTarget:self action:@selector(PG_textViewAction:)];
    }
    return _TextView;
}
- (UILabel *)wordLabel{
...
- (void)textViewDidChange:(UITextView *)textView{
    ...
    [self PG_attributeForWordLabel:_wordLabel.text];
}
#pragma mark --- 存取器重写
- (void)setIndexPath:(NSIndexPath *)indexPath{
    ...
    if (_indexPath.section==0) {
        ...
        if (indexPath.row==1) {
            ...
            [self PG_attributeForRightLabel:_rightLabel];
        }
    }
}
- (void)PG_attributeForWordLabel:(NSString *)str{
    NSMutableAttributedString *attributedString = [[NSMutableAttributedString alloc]initWithString:str];
...
- (void)PG_attributeForRightLabel:(UILabel *)label{
...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary<NSKeyValueChangeKey,id> *)change context:(void *)context{
    ...
    PGActivityGroupSendCell *cell1 = [tableView cellForRowAtIndexPath:[NSIndexPath indexPathForRow:2 inSection:2]];
    PGActivityGroupSendCell *cell2 = [tableView cellForRowAtIndexPath:[NSIndexPath indexPathForRow:3 inSection:2]];
    ...
    [self PG_attributeForRightLabel:cell2.rightLabel];
     PGActivityGroupSendCell *cell3 = [tableView cellForRowAtIndexPath:[NSIndexPath indexPathForRow:0 inSection:2]];
...
#pragma mark --- action
- (void)PG_textViewAction:(UITextView *)textview {
