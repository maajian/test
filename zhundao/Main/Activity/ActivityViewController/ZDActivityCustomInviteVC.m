...
@interface ZDActivityCustomInviteVC ()



@property(nonatomic,strong)ZDActivityCustomInviteVM *customViewModel;
/*! 显示的数据 */
...
@implementation ZDActivityCustomInviteVC

- (void)viewDidLoad {
    [super viewDidLoad];
    _customViewModel = [[ZDActivityCustomInviteVM alloc]init];
