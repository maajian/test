...
@interface ZDActivityChangeContentVC ()<UITextViewDelegate>
{
    UITextView *textView;
    UILabel *countLabel;
}
...
@implementation ZDActivityChangeContentVC
...
#pragma mark --- 确定
- (void)sureAction{
    ZDActivityMessageContentViewModel *ViewModel = [[ZDActivityMessageContentViewModel alloc]init];
