...
@class UIScrollView;
@class UISlider;
@class PGWithSureBlock;
@interface PGReceivedSecondFrame : NSObject
@property (nonatomic, readwrite, strong) UIView *withRenderingMode;
@property (nonatomic, readwrite, strong) UIScrollView *columnistCategoryModel;
@property (nonatomic, readwrite, strong) UITableView *allowPickingVideo;
