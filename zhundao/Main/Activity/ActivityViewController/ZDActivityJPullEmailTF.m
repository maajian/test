...
#import "ZDActivityJPullCell.h"

#define cellH 44

@interface ZDActivityJPullEmailTF ()<UITableViewDataSource, UITableViewDelegate>
...
@implementation ZDActivityJPullEmailTF
...
- (instancetype)setUpInView:(UIView *)view {
    ...
    [self.pullTableView registerNib:[UINib nibWithNibName:@"ZDActivityJPullCell" bundle:nil]    forCellReuseIdentifier:@"ZDActivityJPullCell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ZDActivityJPullCell *cell = [self.pullTableView dequeueReusableCellWithIdentifier:@"ZDActivityJPullCell" forIndexPath:indexPath];
