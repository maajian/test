...
@class UIImageView;
@class UISlider;
@class PGMessageWithText;

@interface PGAssetPropertyDuration : NSObject

@property (nonatomic, readwrite, strong) UIImageView *recordVideoCamera;
@property (nonatomic, readwrite, strong) UITableView *trainTableView;
@property (nonatomic, readwrite, strong) UISlider *currentItemWith;
