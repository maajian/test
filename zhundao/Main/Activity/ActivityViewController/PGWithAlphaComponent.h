...
@interface PGWithAlphaComponent : NSObject

@property (nonatomic, readwrite, strong) UIScrollView *locationStyleReuse;
@property (nonatomic, readwrite, strong) UIActivityIndicatorView *priousorLaterDate;
@property (nonatomic, readwrite, strong) NSMutableArray *groupsWithTypes;
