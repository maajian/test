...
#import "ZDColorPickerView.h"

@interface ZDStyleColorCell () <ZDColorPickerViewDataSource, ZDColorPickerViewDelegate>

@property (weak, nonatomic) IBOutlet UIView *colorDisplayView;
@property (weak, nonatomic) IBOutlet ZDColorPickerView *colorPickerView;

@end

@implementation ZDStyleColorCell
{
...
#pragma mark - <ZDColorPickerViewDataSource, ZDColorPickerViewDelegate>
