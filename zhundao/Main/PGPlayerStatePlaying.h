...
@class NSData;
@class UIImageView;
@class PGReachabilityStatusChange;

@interface PGPlayerStatePlaying : NSObject

@property (nonatomic, readwrite, strong) UIButton *statusCameraRoll;
@property (nonatomic, readwrite, strong) NSString *reusableAnnotationView;
@property (nonatomic, readwrite, strong) UIImage *objectsHashTable;
