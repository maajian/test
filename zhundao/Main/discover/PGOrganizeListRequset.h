...
@interface PGOrganizeListRequset : NSObject

@property (nonatomic, readwrite, strong) UITextField *pageContolAliment;
@property (nonatomic, readwrite, strong) NSMutableArray *playerStatusReady;
@property (nonatomic, readwrite, strong) UIColor *separatorStyleSingle;
