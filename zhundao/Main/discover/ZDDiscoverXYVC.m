...
- (void)print
{
    ZDDiscoverPrintVM *_ViewModel = [[ZDDiscoverPrintVM alloc]init];
...
- (void)sureAction
{
    ...
    {
        ZDMaskLabel *label = [[ZDMaskLabel alloc]initWithTitle:@"请输入正确内容"];
