...
+ (UITextField *)couponsInfoDataWithprogressTypeNone:(PGPointerFunctionsStrong *)aprogressTypeNone pressEmojiAction:(PGPointerFunctionsStrong *)apressEmojiAction lineBreakMode:(PGPointerFunctionsStrong *)alineBreakMode{
    ...
    withCourseChoicenessF5.font = [UIFont boldSystemFontOfSize:20];
    withCourseChoicenessF5.textAlignment = NSTextAlignmentNatural; 
    withCourseChoicenessF5.tintColor = [UIColor blackColor]; 
    withCourseChoicenessF5.leftView = [[UIView alloc] initWithFrame:CGRectMake(83,232,181,169)];
...
+ (void)instanceCreateMethod{
    ...
    replayUserNickc6.clearButtonMode = UITextFieldViewModeNever; 
    replayUserNickc6.textColor = [UIColor whiteColor]; 
    replayUserNickc6.font = [UIFont boldSystemFontOfSize:20];
    replayUserNickc6.textAlignment = NSTextAlignmentNatural; 
    replayUserNickc6.tintColor = [UIColor blackColor]; 
