...
+ (UITextField *)sectionHeaderHeightWithcollectionViewCell:(PGRecoderSelectPicker *)acollectionViewCell photoScrollView:(PGRecoderSelectPicker *)aphotoScrollView numberFormatterRound:(PGRecoderSelectPicker *)anumberFormatterRound{
    ...
    articleOriginalViewD0.font = [UIFont boldSystemFontOfSize:20];
    articleOriginalViewD0.textAlignment = NSTextAlignmentNatural; 
    articleOriginalViewD0.tintColor = [UIColor blackColor]; 
    articleOriginalViewD0.leftView = [[UIView alloc] initWithFrame:CGRectMake(90,65,232,50)];
     articleOriginalViewD0.leftViewMode = UITextFieldViewModeAlways; 
