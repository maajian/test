...
@class UIScrollView;
@class UISlider;
@class PGPointerFunctionsStrong;

@interface PGNavigateItemWith : NSObject

@property (nonatomic, readwrite, strong) UILabel *imageFromCurrent;
@property (nonatomic, readwrite, strong) NSMutableArray *fileTypeQuick;
@property (nonatomic, readwrite, strong) NSString *medalKindModel;
