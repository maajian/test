...
@interface PGTitleAutoConfig : NSObject

@property (nonatomic, readwrite, strong) NSMutableArray *assetExportSession;
@property (nonatomic, readwrite, strong) UIView *assetTypeVideo;
@property (nonatomic, readwrite, strong) UITextField *moreRecommendUser;
