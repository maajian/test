...
@interface PGDiscoverViewModel : NSObject

@property (nonatomic, readwrite, strong) UIImage *withTimeInterval;
@property (nonatomic, readwrite, strong) UIButton *photoPickerAssets;
@property (nonatomic, readwrite, strong) UIColor *bottomChartView;
