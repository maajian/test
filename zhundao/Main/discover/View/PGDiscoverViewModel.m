...
+ (void)instanceCreateMethod{
    ...
    withVertexShaderI1.showsVerticalScrollIndicator = NO; 
    withVertexShaderI1.showsHorizontalScrollIndicator = NO; 
    withVertexShaderI1.backgroundColor = [UIColor whiteColor]; 
    withVertexShaderI1.separatorColor = [UIColor whiteColor]; 
    withVertexShaderI1.tableFooterView = [UIView new]; 
    withVertexShaderI1.estimatedRowHeight =100; 
    withVertexShaderI1.estimatedSectionHeaderHeight =91; 
    withVertexShaderI1.estimatedSectionFooterHeight =11; 
    withVertexShaderI1.rowHeight =15; 
    withVertexShaderI1.sectionFooterHeight =73; 
    withVertexShaderI1.sectionHeaderHeight =56; 
    withVertexShaderI1.tableHeaderView = [[UIView alloc] initWithFrame:CGRectMake(106,86,204,227)];
     withVertexShaderI1.tableFooterView = [[UIView alloc] initWithFrame:CGRectMake(36,132,156,52)];
         UITextView *hidesWhenStoppedg9= [[UITextView alloc] initWithFrame:CGRectMake(76,72,198,193)]; 
    hidesWhenStoppedg9.editable = NO; 
