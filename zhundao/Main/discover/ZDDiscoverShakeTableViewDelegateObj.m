//
//  ZDDiscoverShakeTableViewDelegateObj.m
//  zhundao
//
...
#import "Time.h"
@interface ZDDiscoverShakeTableViewDelegateObj ()
{
    UITableViewCell *mycell;
}
@end
@implementation ZDDiscoverShakeTableViewDelegateObj
+(instancetype)createTableViewDelegateWithDataList:(ZDDiscoverDetailModel *)model   withdic :(NSDictionary *)dic
{
    return  [[[self class]alloc]initTableViewDelegateWithDataList:model  withdic :dic ];
}
- (instancetype)initTableViewDelegateWithDataList:(ZDDiscoverDetailModel *)model   withdic :(NSDictionary *)dic
{
    self = [super init];
    if (self) {
        self.model = model;
