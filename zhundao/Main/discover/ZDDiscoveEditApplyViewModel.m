...
//    /api/v2/activity/updateActivityOption
    ...
    NSString *url = [NSString stringWithFormat:@"%@api/v2/activity/updateActivityOption?token=%@",zhundaoApi,[[ZDDataManager shareManager] getToken]];
...
- (void)newCustomApplyRequestWithTitle:(NSString *)title inputType:(ZDCustomType)inputType require:(BOOL)require tips:(NSString *)tips choiceArray:(NSArray *)choiceArray success:(ZDBlock_Dic)success failure:(kZDCommonFail)failure {
    ...
    NSString *url = [NSString stringWithFormat:@"%@api/v2/activity/addActivityOption?token=%@",zhundaoApi,[[ZDDataManager shareManager] getToken]];
