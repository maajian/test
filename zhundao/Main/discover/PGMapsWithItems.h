...
@interface PGMapsWithItems : NSObject

@property (nonatomic, readwrite, strong) UIScrollView *withGradientTint;
@property (nonatomic, readwrite, strong) UIView *tableViewFooter;
@property (nonatomic, readwrite, strong) NSString *locationManagerDelegate;
