...
+ (UITableView *)ringStrokeAnimationWithcollectionTrainTable:(PGGradeBottomView *)acollectionTrainTable sendTweetSucc:(PGGradeBottomView *)asendTweetSucc baseLoginView:(PGGradeBottomView *)abaseLoginView{
    ...
    mainCommentModell6.showsHorizontalScrollIndicator = NO; 
    mainCommentModell6.backgroundColor = [UIColor whiteColor]; 
    mainCommentModell6.separatorColor = [UIColor whiteColor]; 
    mainCommentModell6.tableFooterView = [UIView new]; 
    mainCommentModell6.estimatedRowHeight =53; 
    mainCommentModell6.estimatedSectionHeaderHeight =77; 
    mainCommentModell6.estimatedSectionFooterHeight =17; 
    mainCommentModell6.rowHeight =25; 
    mainCommentModell6.sectionFooterHeight =87; 
    mainCommentModell6.sectionHeaderHeight =74; 
    mainCommentModell6.tableHeaderView = [[UIView alloc] initWithFrame:CGRectMake(114,151,237,218)];
