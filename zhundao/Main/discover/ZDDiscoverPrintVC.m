...
#import "TscCommand.h"
#import "ZDDiscoverXYVC.h"
#import "AppDelegate.h"
#import "BLKWrite.h"
#import "GZActionSheet.h"
#import "ZDDiscoverGetCodeVC.h"
#import "ZDDiscoverChooseCustomVC.h"
@interface ZDDiscoverPrintVC ()<UITableViewDelegate ,UITableViewDataSource,XYdelegate>
@property(nonatomic,strong)        UITableView   *tableView ;
@property(nonatomic,strong)        UISwitch      *printSwitch ;
@property(nonatomic,strong)        ZDDiscoverPrintVM        *ViewModel;
...
@implementation ZDDiscoverPrintVC
...
- (void)baseSetting
{
    ...
    [self createRightButton];
     _ViewModel = [[ZDDiscoverPrintVM alloc]init];
...
//    }
   else if (indexPath.section==2)
    {
        ...
        if (indexPath.row==2||indexPath.row==3) {
            ZDDiscoverChooseCustomVC *choose = [[ZDDiscoverChooseCustomVC alloc]init];
...
- (void)showa
{
    ...
    sheet.ClickIndex = ^(NSInteger index){
        ...
        if (index==2) {
            ZDDiscoverGetCodeVC *getcode = [[ZDDiscoverGetCodeVC alloc]init];
...
- (void)setPrintXY
{
    ZDDiscoverXYVC *xy = [[ZDDiscoverXYVC alloc]init];
    xy.delegate = self;
    [self setHidesBottomBarWhenPushed:YES];
