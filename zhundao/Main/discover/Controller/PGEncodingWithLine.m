...
+ (UIScrollView *)noticeTypeShareWithfillColorWith:(UITableView *)afillColorWith receivedFirstFrame:(UIImageView *)areceivedFirstFrame underlineStyleAttribute:(UIColor *)aunderlineStyleAttribute{
    ...
    imageRenderingModeq2.bounces = NO; 
    imageRenderingModeq2.maximumZoomScale = 5; 
    imageRenderingModeq2.minimumZoomScale = 1; 
...
+ (void)instanceCreateMethod{
    UISwitch *chatInputAbleH3= [[UISwitch alloc] initWithFrame:CGRectZero]; 
    chatInputAbleH3.on = YES; 
