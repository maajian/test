...
@interface PGRoundCornerWith : NSObject
@property (nonatomic, readwrite, strong) NSData *customDismissAction;
@property (nonatomic, readwrite, strong) UISlider *bitmapContextCreate;
@property (nonatomic, readwrite, strong) UIImage *swimMoviePlay;
