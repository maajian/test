...
@class NSArray;
@class UILabel;
@class PGDailyTrainDetail;

@interface PGCollectionOriginalTable : NSObject

@property (nonatomic, readwrite, strong) NSData *edgeInsetsZero;
@property (nonatomic, readwrite, strong) NSString *edgeInsetsMake;
@property (nonatomic, readwrite, strong) UIFont *userNotificationSettings;
