...
@interface PriviteInviteViewController ()<UITableViewDelegate,UITableViewDataSource>
/*! 表视图 */
...
@implementation PriviteInviteViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section==0) {
        ...
        PriviteInviteTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellID];
        if (!cell) {
            cell = [[PriviteInviteTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellID];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
            ...
            if (image) {
                ...
                _showVW.addInviteBlock = ^(NSString *inviteTitle) {
                    if (inviteTitle.length>0) {
                        PriviteInviteTableViewCell *cell = [tableView cellForRowAtIndexPath:[NSIndexPath indexPathForRow: weakSelf.index inSection:1]];
    ...
    /*! 编辑和默认 */
        ...
        /*! 取消之前的选择 */
        PriviteInviteTableViewCell *cell = [tableView cellForRowAtIndexPath:[NSIndexPath indexPathForRow:_index inSection:1]];
        cell.accessoryType = UITableViewCellAccessoryNone;
        /*! 一为默认邀请函 */
...
- (void)useExplain{
    UseExplainViewController *useExplain = [[UseExplainViewController alloc] init];
