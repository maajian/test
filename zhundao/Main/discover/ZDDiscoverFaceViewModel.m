...
@implementation ZDDiscoverFaceViewModel
...
{
    NSString *str = [NSString stringWithFormat:@"https://face.zhundao.net/api/Core/GetDeviceList?accessKey=%@&userId=2",[[ZDSignManager shareManager] getaccseekey]];
