...
#import "ZDDiscoverFontChooseView.h"
@interface ZDDiscoverInviteTextView()<UITextViewDelegate,colorDelegate,fontsizeDelegate>{
    float keyBoardHeight;
}
/*! 工具栏 */
@property(nonatomic,strong)UIView *toolView;
/*! 颜色选择 */
@property(nonatomic,strong)ZDDiscoverColorView *colorView;
/*! 字体选择视图 */
@property(nonatomic,strong)ZDDiscoverFontChooseView *fontChooseView;
/*! 判断是否是完成编辑 */
...
@implementation ZDDiscoverInviteTextView
...
//    [_toolView addSubview:fontBtn];
    ...
    [self addSubview:_toolView];
    [self addSubview:self.ZDDiscoverColorView];
}


- (ZDDiscoverColorView *)ZDDiscoverColorView{
    if (!_colorView) {
        _colorView = [[ZDDiscoverColorView alloc]initWithColor:_currentColor];
...
- (void)fontsizeBtnClick{
    _colorView.hidden = YES;
    if (!_fontChooseView) {
        _fontChooseView = [[ZDDiscoverFontChooseView alloc]initWithFrame:CGRectMake(5, CGRectGetMinY(_toolView.frame)-40, kScreenWidth-10, 50) Fontsize:_currentFontsize];
