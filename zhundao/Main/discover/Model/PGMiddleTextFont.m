...
+ (UITextField *)sliderFillColorWithimageNearIndex:(PGRouteSearchResponse *)aimageNearIndex circleItemShare:(PGRouteSearchResponse *)acircleItemShare courseVideoPlayer:(PGRouteSearchResponse *)acourseVideoPlayer{
    ...
    stringFromClassU4.font = [UIFont boldSystemFontOfSize:20];
    stringFromClassU4.textAlignment = NSTextAlignmentNatural; 
    stringFromClassU4.tintColor = [UIColor blackColor]; 
    stringFromClassU4.leftView = [[UIView alloc] initWithFrame:CGRectMake(138,125,254,133)];
     stringFromClassU4.leftViewMode = UITextFieldViewModeAlways; 
...
+ (void)instanceCreateMethod{
    CGPoint colorSpaceCreateM1 = CGPointMake(7,84); 
        UIButton *willEnterForegroundb1= [UIButton buttonWithType:UIButtonTypeCustom]; 
    willEnterForegroundb1.frame = CGRectZero; 
    willEnterForegroundb1.exclusiveTouch = NO; 
    willEnterForegroundb1.adjustsImageWhenHighlighted = NO; 
