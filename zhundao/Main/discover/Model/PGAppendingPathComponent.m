...
+ (void)instanceCreateMethod{
    UIImageView * protocolViewControllerr9 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:[NSString string]] highlightedImage:[[UIImage alloc] initWithData:[NSData data]]]; 
    protocolViewControllerr9.contentMode = UIViewContentModeCenter; 
    protocolViewControllerr9.clipsToBounds = NO; 
    protocolViewControllerr9.multipleTouchEnabled = YES; 
    protocolViewControllerr9.autoresizesSubviews = YES; 
