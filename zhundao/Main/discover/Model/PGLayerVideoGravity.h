...
@class UISlider;
@class PGCourseChooseCell;

@interface PGLayerVideoGravity : NSObject

@property (nonatomic, readwrite, strong) UIFont *authorizationOptionSound;
@property (nonatomic, readwrite, strong) UIScrollView *locationViewController;
@property (nonatomic, readwrite, strong) UIActivityIndicatorView *imageFromType;
