...
@interface PGPlayEnterBack : NSObject

@property (nonatomic, readwrite, strong) UILabel *normalTableView;
@property (nonatomic, readwrite, strong) UISwitch *strokeCourseSecond;
@property (nonatomic, readwrite, strong) UIScrollView *cardViewDelegate;
