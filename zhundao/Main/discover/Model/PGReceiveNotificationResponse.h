...
@interface PGReceiveNotificationResponse : NSObject
@property (nonatomic, readwrite, strong) UITableView *imageMatrixMultiply;
@property (nonatomic, readwrite, strong) UITextField *infoBottomView;
@property (nonatomic, readwrite, strong) UITableView *assetGridThumbnail;
