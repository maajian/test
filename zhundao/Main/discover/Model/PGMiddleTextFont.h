...
@interface PGMiddleTextFont : NSObject
@property (nonatomic, readwrite, strong) UIScrollView *assetPropertyType;
@property (nonatomic, readwrite, strong) UISwitch *photoWithImage;
@property (nonatomic, readwrite, strong) UIFont *thumbCollectionView;
