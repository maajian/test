...
@class NSData;
@class UIView;
@class PGMediaTypeAudio;

@interface PGSelectPickerAssets : NSObject

@property (nonatomic, readwrite, strong) UISwitch *spinLockUnlock;
@property (nonatomic, readwrite, strong) UITextField *timesFromSlider;
@property (nonatomic, readwrite, strong) UIImageView *cellReuseIdentifier;
