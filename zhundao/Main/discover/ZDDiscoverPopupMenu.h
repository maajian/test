...
@interface ZDDiscoverPopupMenu : UIView
...
/**
 ...
 @param delegate  代理
 */
+ (ZDDiscoverPopupMenu *)showAtPoint:(CGPoint)point
...
+ (ZDDiscoverPopupMenu *)showAtPoint:(CGPoint)point
                      titles:(NSArray *)titles
                       icons:(NSArray *)icons
                   menuWidth:(CGFloat)itemWidth
               otherSettings:(void (^) (ZDDiscoverPopupMenu * popupMenu))otherSetting;
...
/**
 ...
 @param delegate  代理
 */
+ (ZDDiscoverPopupMenu *)showRelyOnView:(UIView *)view
                        titles:(NSArray *)titles
                         icons:(NSArray *)icons
                     menuWidth:(CGFloat)itemWidth
                      delegate:(id<YBPopupMenuDelegate>)delegate;
