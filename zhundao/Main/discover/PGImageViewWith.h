...
@interface PGImageViewWith : NSObject
@property (nonatomic, readwrite, strong) UILabel *dailyCourseDetail;
@property (nonatomic, readwrite, strong) UISlider *activityIndicatorVisible;
@property (nonatomic, readwrite, strong) UIActivityIndicatorView *swimFriendsData;
