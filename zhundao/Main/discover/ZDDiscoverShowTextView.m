...
@interface ZDDiscoverShowTextView()<UIGestureRecognizerDelegate>{
    NSInteger tag;
}

@end

@implementation ZDDiscoverShowTextView
...
- (void)myDelete:(UIMenuController *)menu{
    ZDDiscoverShowTextView *textView = [self viewWithTag:tag];
