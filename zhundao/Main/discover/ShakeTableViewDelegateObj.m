...
@end
@implementation ShakeTableViewDelegateObj
+(instancetype)createTableViewDelegateWithDataList:(detailModel *)model   withdic :(NSDictionary *)dic
{
    return  [[[self class]alloc]initTableViewDelegateWithDataList:model  withdic :dic ];
}
- (instancetype)initTableViewDelegateWithDataList:(detailModel *)model   withdic :(NSDictionary *)dic
{
    self = [super init];
    if (self) {
        self.model = model;
