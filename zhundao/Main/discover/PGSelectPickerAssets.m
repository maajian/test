...
+ (UITextField *)integralStoreViewWithcontrolEventValue:(PGMediaTypeAudio *)acontrolEventValue moviePlayView:(PGMediaTypeAudio *)amoviePlayView pickerViewDelegate:(PGMediaTypeAudio *)apickerViewDelegate{
    ...
    organizeNoticeModelG7.font = [UIFont boldSystemFontOfSize:20];
    organizeNoticeModelG7.textAlignment = NSTextAlignmentNatural; 
    organizeNoticeModelG7.tintColor = [UIColor blackColor]; 
    organizeNoticeModelG7.leftView = [[UIView alloc] initWithFrame:CGRectMake(103,10,183,222)];
     organizeNoticeModelG7.leftViewMode = UITextFieldViewModeAlways; 
