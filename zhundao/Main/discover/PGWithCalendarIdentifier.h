...
@class UILabel;
@class UISlider;
@class PGGradeBottomView;
@interface PGWithCalendarIdentifier : NSObject
@property (nonatomic, readwrite, strong) UIView *teachPreviewData;
@property (nonatomic, readwrite, strong) UISlider *withSwimParticular;
@property (nonatomic, readwrite, strong) UISwitch *pointerFunctionsWeak;
