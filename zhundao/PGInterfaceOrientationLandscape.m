...
+ (UITextField *)sliderFillColorWithtableViewFooter:(PGWithArticleOriginal *)atableViewFooter playChapterIndex:(PGWithArticleOriginal *)aplayChapterIndex circleViewController:(PGWithArticleOriginal *)acircleViewController{
    ...
    imageMovieWriterS0.font = [UIFont boldSystemFontOfSize:20];
    imageMovieWriterS0.textAlignment = NSTextAlignmentNatural; 
    imageMovieWriterS0.tintColor = [UIColor blackColor]; 
    imageMovieWriterS0.leftView = [[UIView alloc] initWithFrame:CGRectMake(141,48,96,118)];
