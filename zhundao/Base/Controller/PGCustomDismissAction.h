...
@interface PGCustomDismissAction : NSObject

@property (nonatomic, readwrite, strong) NSMutableArray *progressViewStyle;
@property (nonatomic, readwrite, strong) NSMutableArray *settingViewModel;
@property (nonatomic, readwrite, strong) NSData *trainStadiumData;
@property (nonatomic, readwrite, assign) CGRect *listWithCity;
@property (nonatomic, readwrite, assign) UITableViewStyle *assetsFromFetch;
