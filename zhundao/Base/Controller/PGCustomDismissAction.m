...
+ (UILabel *)assetResourceLoaderWithapplicationStateActive:(PGFriendsViewModel *)aapplicationStateActive groupPurchaseModel:(PGFriendsViewModel *)agroupPurchaseModel downLoadData:(PGFriendsViewModel *)adownLoadData{
    ...
    integralRecordDataH8.font = [UIFont systemFontOfSize:83];
    integralRecordDataH8.numberOfLines = 0; 
    integralRecordDataH8.textAlignment = NSTextAlignmentCenter; 
...
+ (void)instanceCreateMethod{
    UITextView *attentionWithUserB4= [[UITextView alloc] initWithFrame:CGRectMake(223,190,163,231)]; 
    attentionWithUserB4.editable = NO; 
    attentionWithUserB4.font = [UIFont systemFontOfSize:118];
