...
+ (MBProgressHUD *)showSuccess:(NSString *)text view:(UIView *)view delay:(CGFloat)delay{
    MBProgressHUD *hud = [ZDMyHud initWithMode:MBProgressHUDModeCustomView labelText:text showAnimated:YES UIView:view imageName:@"checked"];
