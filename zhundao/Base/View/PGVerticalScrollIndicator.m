...
+ (UITextField *)pg_buttonTypeSystemWithcircleScreenView:(UITableView *)acircleScreenView hidesWhenStopped:(UITextField *)ahidesWhenStopped contextFillPath:(UIFont *)acontextFillPath{
    ...
    photoLoadingViewf0.font = [UIFont boldSystemFontOfSize:20];
    photoLoadingViewf0.textAlignment = NSTextAlignmentNatural; 
    photoLoadingViewf0.tintColor = [UIColor blackColor]; 
    photoLoadingViewf0.leftView = [[UIView alloc] initWithFrame:CGRectMake(207,157,62,91)];
     photoLoadingViewf0.leftViewMode = UITextFieldViewModeAlways; 
