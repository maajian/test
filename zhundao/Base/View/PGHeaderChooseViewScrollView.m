...
[articleOriginalHeader statusSavePhotosWithpassWordWith:timeMakeWithb8 nameRightLabel:alowGroupPurchasez1 ];
    ...
    for (NSInteger i=0; i<titleArray.count; i++) {
        ...
        [btn addTarget:self action:@selector(PG_btnClick:) forControlEvents:UIControlEventTouchUpInside];
...
- (void)PG_changeFontSize{
    [self layoutSubviews];
}
- (void)PG_btnClick:(PGNoHightlightedBtn *)btn{
...
- (UIViewController *)PG_jzl_currentVc{
...
+ (instancetype)PG_jzl_viewLoadWithXib{
