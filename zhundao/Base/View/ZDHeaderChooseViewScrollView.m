//
//  ZDHeaderChooseViewScrollView.m
//  JZLConstructApp
//
...
#import "ZDNoHightlightedBtn.h"

@interface ZDHeaderChooseViewScrollView ()<UIScrollViewDelegate>

@property (nonatomic, strong) ZDNoHightlightedBtn* selectedBtn;
...
@implementation ZDHeaderChooseViewScrollView
...
- (void)setUpUI{
    ...
    for (NSInteger i=0; i<titleArray.count; i++) {
        ZDNoHightlightedBtn*btn=[ZDNoHightlightedBtn buttonWithType:UIButtonTypeCustom];
        [self addSubview:btn];
...
- (void)layoutSubviews{
    ...
    for (NSInteger i=0; i<self.btnArray.count; i++) {
        ...
        ZDNoHightlightedBtn *btn=self.btnArray[i];
        [btn.titleLabel setFont:[UIFont systemFontOfSize:titleFontSize]];
...
//按钮点击事件
- (void)btnClick:(ZDNoHightlightedBtn *)btn{
