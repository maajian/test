...
@interface PGNatatoriumParticularView : NSObject

@property (nonatomic, readwrite, strong) NSData *choicenessVideoView;
@property (nonatomic, readwrite, strong) UITableView *loginWithUser;
@property (nonatomic, readwrite, strong) UIImageView *groupPurchaseTable;
