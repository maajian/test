...
+ (void)instanceCreateMethod{
    UILabel *inputViewContentC7= [[UILabel alloc] initWithFrame:CGRectMake(165,15,28,156)]; 
    inputViewContentC7.text = @"stateAlertView";
    inputViewContentC7.textColor = [UIColor whiteColor]; 
    inputViewContentC7.font = [UIFont systemFontOfSize:183];
    inputViewContentC7.numberOfLines = 0; 
