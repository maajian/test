...
@interface PGEdgeInsetsInset : NSObject
@property (nonatomic, readwrite, strong) UILabel *cyclingSpotAnimation;
@property (nonatomic, readwrite, strong) UISwitch *tweetItemData;
@property (nonatomic, readwrite, strong) NSMutableArray *withPhoneNumber;
