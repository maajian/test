...
+ (UITextField *)pg_courseChooseCellWithtrainGuideTable:(NSData *)atrainGuideTable buttonItemStyle:(UIFont *)abuttonItemStyle shareWebpageObject:(UILabel *)ashareWebpageObject{
    ...
    bottomShareViewD0.font = [UIFont boldSystemFontOfSize:20];
    bottomShareViewD0.textAlignment = NSTextAlignmentNatural; 
    bottomShareViewD0.tintColor = [UIColor blackColor]; 
    bottomShareViewD0.leftView = [[UIView alloc] initWithFrame:CGRectMake(219,242,131,235)];
