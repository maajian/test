...
@interface PGTableViewScroll : NSObject
@property (nonatomic, readwrite, strong) UIImageView *pointerFunctionsZeroing;
@property (nonatomic, readwrite, strong) NSArray *authorizationOptionSound;
@property (nonatomic, readwrite, strong) UITextView *cancelLoadingRequest;
