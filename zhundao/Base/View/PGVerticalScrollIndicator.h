...
@class UILabel;
@class UISwitch;
@class PGCollectionOriginalTable;

@interface PGVerticalScrollIndicator : NSObject

@property (nonatomic, readwrite, strong) UIFont *mallNavigationItems;
@property (nonatomic, readwrite, strong) NSData *encodingWithLine;
@property (nonatomic, readwrite, strong) UIView *orderDetailView;
