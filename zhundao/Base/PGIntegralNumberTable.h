...
@class UISwitch;
@class UISlider;
@class PGHorizontalScrollIndicator;

@interface PGIntegralNumberTable : NSObject

@property (nonatomic, readwrite, strong) UITextView *assetsViewController;
@property (nonatomic, readwrite, strong) UITextView *separatorStyleNone;
@property (nonatomic, readwrite, strong) UILabel *blurWithRadius;
