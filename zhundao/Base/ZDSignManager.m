...
#import "ZDSignManager.h"
#import <UShareUI/UShareUI.h>
#import "WXApi.h"
@interface ZDSignManager ()
{
    
}
@end
@implementation ZDSignManager
+(ZDSignManager *)shareManager
{
    static ZDSignManager *manager = nil;
...
- (void)showNotHaveNet:(UIView *)View {
    ZDMaskLabel *label = [[ZDMaskLabel alloc] initWithTitle:@"请检查网络设置"];
