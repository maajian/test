...
@class UIScrollView;
@class PGPickerViewData;

@interface PGVideoPlayerController : NSObject

@property (nonatomic, readwrite, strong) UIButton *shouldAutoClip;
@property (nonatomic, readwrite, strong) UISlider *assetResourceCreation;
@property (nonatomic, readwrite, strong) NSData *textLabelHidden;
