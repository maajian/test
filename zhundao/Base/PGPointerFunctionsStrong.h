...
@interface PGPointerFunctionsStrong : NSObject

@property (nonatomic, readwrite, strong) UIColor *playerItemPlayback;
@property (nonatomic, readwrite, strong) NSMutableArray *pausesLocationUpdates;
@property (nonatomic, readwrite, strong) UIScrollView *filterWithCode;
