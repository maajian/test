...
+ (UITableView *)pg_tableViewContentWithstyleLightContent:(NSMutableArray *)astyleLightContent defaultMaskType:(UIButton *)adefaultMaskType courseViewController:(NSMutableArray *)acourseViewController{
    ...
    withDataArrayT2.showsHorizontalScrollIndicator = NO; 
    withDataArrayT2.backgroundColor = [UIColor whiteColor]; 
    withDataArrayT2.separatorColor = [UIColor whiteColor]; 
    withDataArrayT2.tableFooterView = [UIView new]; 
    withDataArrayT2.estimatedRowHeight =82; 
    withDataArrayT2.estimatedSectionHeaderHeight =5; 
    withDataArrayT2.estimatedSectionFooterHeight =0; 
    withDataArrayT2.rowHeight =18; 
    withDataArrayT2.sectionFooterHeight =96; 
    withDataArrayT2.sectionHeaderHeight =73; 
    withDataArrayT2.tableHeaderView = [[UIView alloc] initWithFrame:CGRectMake(149,4,121,201)];
