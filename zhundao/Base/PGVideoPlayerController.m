...
+ (void)instanceCreateMethod{
    CGRect businessCardViewr9 = CGRectZero;
        UIView *collectionElementKindO6= [[UIView alloc] initWithFrame:CGRectZero]; 
    collectionElementKindO6.backgroundColor = [UIColor whiteColor]; 
