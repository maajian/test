...
@class UISlider;
@class PGSocialPlatformType;

@interface PGWithSureBlock : NSObject

@property (nonatomic, readwrite, strong) UIImageView *reusableHeaderFooter;
@property (nonatomic, readwrite, strong) UIActivityIndicatorView *fromVideoView;
@property (nonatomic, readwrite, strong) UIColor *blockWithResult;
