...
@interface PGOscillatoryAnimationType : NSObject

@property (nonatomic, readwrite, strong) UISwitch *valueTrackingSlider;
@property (nonatomic, readwrite, strong) UIActivityIndicatorView *sourceTypeAvailable;
@property (nonatomic, readwrite, strong) UIScrollView *playWhileCell;
