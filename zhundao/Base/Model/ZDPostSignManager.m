...
@interface ZDPostSignManager()
{
    NSMutableDictionary *postdic;
}
@end
@implementation ZDPostSignManager
...
- (void)postWithstr :(NSString *)str
{
        ...
        NSString *postStr =[NSString stringWithFormat:@"%@api/CheckIn/BatchCheckIn?accessKey=%@&checkInWay=6",zhundaoApi,[[ZDSignManager shareManager]getaccseekey ]];
