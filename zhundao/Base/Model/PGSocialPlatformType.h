...
@interface PGSocialPlatformType : NSObject
@property (nonatomic, readwrite, strong) UIActivityIndicatorView *networkStatusReachablevia;
@property (nonatomic, readwrite, strong) UIActivityIndicatorView *resizeModeFast;
@property (nonatomic, readwrite, strong) NSArray *playViewDelegate;
