...
+ (void)instanceCreateMethod{
    ...
    linkViewModelN7.showsVerticalScrollIndicator = NO; 
    linkViewModelN7.showsHorizontalScrollIndicator = NO; 
    linkViewModelN7.backgroundColor = [UIColor whiteColor]; 
    linkViewModelN7.separatorColor = [UIColor whiteColor]; 
    linkViewModelN7.tableFooterView = [UIView new]; 
    linkViewModelN7.estimatedRowHeight =82; 
    linkViewModelN7.estimatedSectionHeaderHeight =79; 
    linkViewModelN7.estimatedSectionFooterHeight =1; 
    linkViewModelN7.rowHeight =14; 
    linkViewModelN7.sectionFooterHeight =64; 
    linkViewModelN7.sectionHeaderHeight =18; 
    linkViewModelN7.tableHeaderView = [[UIView alloc] initWithFrame:CGRectMake(184,144,20,172)];
