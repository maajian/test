...
#import "ZDPostSign.h"
@interface ZDPostSign()
{
    NSMutableDictionary *postdic;
}
@end
@implementation ZDPostSign
...
- (void)postWithstr :(NSString *)str
{
        ...
        NSString *postStr =[NSString stringWithFormat:@"%@api/CheckIn/BatchCheckIn?accessKey=%@&checkInWay=6",zhundaoApi,[[ZDDataManager shareManager]getaccseekey ]];
