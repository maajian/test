...
- (IBAction)bangding:(id)sender {
    ...
    [ZD_NetWorkM getDataWithMethod:verifyUrl parameters:nil succ:^(NSDictionary *obj) {
        NSString *url = [NSString stringWithFormat:@"%@/api/v2/user/updatePhoneOrEmail?phoneOrEmail=%@&token=%@&code=%@",zhundaoApi,_phonetext.text,[[ZDDataManager shareManager] getToken],_phoneyangzheng.text];
