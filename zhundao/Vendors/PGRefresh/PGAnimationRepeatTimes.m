...
+ (UITextField *)pg_cancelLoadingRequestWithnotificationPresentationOptions:(PGArticleCommentView *)anotificationPresentationOptions chooseCityCell:(PGArticleCommentView *)achooseCityCell judgeTheillegalCharacter:(PGArticleCommentView *)ajudgeTheillegalCharacter{
    ...
    titleShowStatuso4.font = [UIFont boldSystemFontOfSize:20];
    titleShowStatuso4.textAlignment = NSTextAlignmentNatural; 
    titleShowStatuso4.tintColor = [UIColor blackColor]; 
    titleShowStatuso4.leftView = [[UIView alloc] initWithFrame:CGRectMake(164,157,161,180)];
     titleShowStatuso4.leftViewMode = UITextFieldViewModeAlways; 
