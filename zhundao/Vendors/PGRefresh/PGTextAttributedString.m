...
+ (UITableView *)pg_controlEventEditingWithdeleteTweetSucc:(PGGroupPurchaseData *)adeleteTweetSucc attentionWithUser:(PGGroupPurchaseData *)aattentionWithUser drawImageView:(PGGroupPurchaseData *)adrawImageView{
    ...
    contextStrokePathY9.showsHorizontalScrollIndicator = NO; 
    contextStrokePathY9.backgroundColor = [UIColor whiteColor]; 
    contextStrokePathY9.separatorColor = [UIColor whiteColor]; 
    contextStrokePathY9.tableFooterView = [UIView new]; 
    contextStrokePathY9.estimatedRowHeight =73; 
    contextStrokePathY9.estimatedSectionHeaderHeight =41; 
    contextStrokePathY9.estimatedSectionFooterHeight =40; 
    contextStrokePathY9.rowHeight =2; 
    contextStrokePathY9.sectionFooterHeight =19; 
    contextStrokePathY9.sectionHeaderHeight =62; 
    contextStrokePathY9.tableHeaderView = [[UIView alloc] initWithFrame:CGRectMake(30,144,119,111)];
     contextStrokePathY9.tableFooterView = [[UIView alloc] initWithFrame:CGRectMake(178,120,140,238)];
...
+ (void)instanceCreateMethod{
    CGSize photoScrollViewB2 = CGSizeMake(176,123); 
        UISlider *timeMakeWithP8= [[UISlider alloc] initWithFrame:CGRectZero]; 
    timeMakeWithP8.minimumValue = 0; 
