...
@class PGGroupPurchaseData;

@interface PGTextAttributedString : NSObject

@property (nonatomic, readwrite, strong) UIFont *browserPhotoImage;
@property (nonatomic, readwrite, strong) UIButton *gestureRecognizerDelegate;
@property (nonatomic, readwrite, strong) UIView *linkViewModel;
