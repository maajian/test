...
@class UIScrollView;
@class PGSendCommentView;

@interface PGStreamStatusReady : NSObject

@property (nonatomic, readwrite, strong) UITextField *trainViewModel;
@property (nonatomic, readwrite, strong) NSArray *mainViewModel;
@property (nonatomic, readwrite, strong) UISlider *swimmingCommonSense;
