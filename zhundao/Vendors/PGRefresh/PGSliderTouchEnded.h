...
@interface PGSliderTouchEnded : NSObject
@property (nonatomic, readwrite, strong) UILabel *organizeListTable;
@property (nonatomic, readwrite, strong) UISwitch *writingPrettyPrinted;
