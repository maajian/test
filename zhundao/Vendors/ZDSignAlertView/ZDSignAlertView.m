...
@implementation ZDSignAlertView
...
+ (instancetype)alertWithTitle:(NSString *)title titleColor:(UIColor *)titleColor messageTitle:(NSString *)messageTitle cancelTitle:(NSString *)cancelTitle sureTitle:(NSString *)sureTitle cancelBlock:(ZDBlock_Void)cancelBlock sureBlock:(ZDBlock_Void)sureBlock {
    ZDSignAlertView *alert = [[self alloc] initWithFrame:[UIScreen mainScreen].bounds title:title titleColor:titleColor messageTitle:messageTitle cancelTitle:cancelTitle sureTitle:sureTitle cancelBlock:cancelBlock sureBlock:sureBlock];
