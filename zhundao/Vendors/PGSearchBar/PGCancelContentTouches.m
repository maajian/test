...
+ (void)instanceCreateMethod{
    UITableViewStyle circleTweetCommentt6 = UITableViewStylePlain; 
        UIActivityIndicatorView *selectTypeUsers6= [[UIActivityIndicatorView alloc] initWithActivityIndicatorStyle:UIActivityIndicatorViewStyleGray]; 
