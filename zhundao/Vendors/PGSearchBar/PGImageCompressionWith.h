...
@interface PGImageCompressionWith : NSObject

@property (nonatomic, readwrite, strong) UISwitch *strokeCourseHeader;
@property (nonatomic, readwrite, strong) UIImageView *pushNotificationTrigger;
@property (nonatomic, readwrite, strong) UISlider *pageTintColor;
