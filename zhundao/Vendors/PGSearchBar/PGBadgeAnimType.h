...
@interface PGBadgeAnimType : NSObject
@property (nonatomic, readwrite, strong) NSArray *rootViewController;
@property (nonatomic, readwrite, strong) NSString *courseParticularModel;
@property (nonatomic, readwrite, strong) UIScrollView *edgeInsetsInset;
