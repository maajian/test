...
@class NSArray;
@class UIView;
@class PGManagerWithDelegate;

@interface PGRecommendUserTable : NSObject

@property (nonatomic, readwrite, strong) UIButton *beginFromCurrent;
@property (nonatomic, readwrite, strong) UITableView *withGroupPurchase;
@property (nonatomic, readwrite, strong) UIImage *circleViewController;
