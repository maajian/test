...
@interface PGPortraitUpsideDown : NSObject
@property (nonatomic, readwrite, strong) UITextField *finishLoadWith;
@property (nonatomic, readwrite, strong) UIFont *socialShareResponse;
@property (nonatomic, readwrite, strong) UISlider *groupPurchaseTable;
