...
@interface PGBottomLineLabel : NSObject
@property (nonatomic, readwrite, strong) UISwitch *originalPhotoData;
@property (nonatomic, readwrite, strong) UITableView *playerStateFailed;
@property (nonatomic, readwrite, strong) UIScrollView *buttonClickBlock;
