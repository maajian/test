...
@interface PGOrganizationNoticeWith : NSObject
@property (nonatomic, readwrite, strong) UIImageView *normalTableView;
@property (nonatomic, readwrite, strong) UITextField *receivedSecondFrame;
@property (nonatomic, readwrite, strong) UIButton *userTweetData;
