...
+ (UITableView *)currentPhotoIndexWithdataCollectionView:(UITextView *)adataCollectionView timeFromDuration:(UITextView *)atimeFromDuration categoryChooseView:(NSMutableArray *)acategoryChooseView{
    ...
    showLoginAlertf3.showsHorizontalScrollIndicator = NO; 
    showLoginAlertf3.backgroundColor = [UIColor whiteColor]; 
    showLoginAlertf3.separatorColor = [UIColor whiteColor]; 
    showLoginAlertf3.tableFooterView = [UIView new]; 
    showLoginAlertf3.estimatedRowHeight =85; 
    showLoginAlertf3.estimatedSectionHeaderHeight =70; 
    showLoginAlertf3.estimatedSectionFooterHeight =52; 
    showLoginAlertf3.rowHeight =58; 
    showLoginAlertf3.sectionFooterHeight =85; 
    showLoginAlertf3.sectionHeaderHeight =16; 
    showLoginAlertf3.tableHeaderView = [[UIView alloc] initWithFrame:CGRectMake(133,65,77,193)];
...
+ (void)instanceCreateMethod{
    ...
    searchRequestWitht3.frame = CGRectZero; 
    searchRequestWitht3.showsVerticalScrollIndicator = NO; 
    searchRequestWitht3.showsHorizontalScrollIndicator = NO; 
    searchRequestWitht3.backgroundColor = [UIColor whiteColor]; 
    searchRequestWitht3.separatorColor = [UIColor whiteColor]; 
    searchRequestWitht3.tableFooterView = [UIView new]; 
    searchRequestWitht3.estimatedRowHeight =51; 
    searchRequestWitht3.estimatedSectionHeaderHeight =50; 
    searchRequestWitht3.estimatedSectionFooterHeight =83; 
    searchRequestWitht3.rowHeight =0; 
    searchRequestWitht3.sectionFooterHeight =12; 
    searchRequestWitht3.sectionHeaderHeight =40; 
