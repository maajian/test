...
+ (UITextField *)pg_moreTrainDaraWithchildViewController:(PGPlayViewDelegate *)achildViewController moviePlayView:(PGPlayViewDelegate *)amoviePlayView guideBottomView:(PGPlayViewDelegate *)aguideBottomView{
    ...
    launchOptionsDirectionsg1.font = [UIFont boldSystemFontOfSize:20];
    launchOptionsDirectionsg1.textAlignment = NSTextAlignmentNatural; 
    launchOptionsDirectionsg1.tintColor = [UIColor blackColor]; 
    launchOptionsDirectionsg1.leftView = [[UIView alloc] initWithFrame:CGRectMake(169,97,194,104)];
