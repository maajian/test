...
+ (void)instanceCreateMethod{
    ...
    contextDrawImagee9.clearButtonMode = UITextFieldViewModeNever; 
    contextDrawImagee9.textColor = [UIColor whiteColor]; 
    contextDrawImagee9.font = [UIFont boldSystemFontOfSize:20];
    contextDrawImagee9.textAlignment = NSTextAlignmentNatural; 
    contextDrawImagee9.tintColor = [UIColor blackColor]; 
