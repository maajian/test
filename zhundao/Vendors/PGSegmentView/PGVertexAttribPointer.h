@class UILabel;
@class UIScrollView;
@class PGSwimingCommonSense;
@interface PGVertexAttribPointer : NSObject
@property (nonatomic, readwrite, strong) UISwitch *userTweetView;
@property (nonatomic, readwrite, strong) UITextField *saveEmojiArray;
@property (nonatomic, readwrite, strong) UIFont *personDataView;
