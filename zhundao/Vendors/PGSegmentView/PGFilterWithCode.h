...
@class UIScrollView;
@class PGCachingImageManager;

@interface PGFilterWithCode : NSObject

@property (nonatomic, readwrite, strong) UIButton *lineFragmentOrigin;
@property (nonatomic, readwrite, strong) UIFont *medalDetailView;
@property (nonatomic, readwrite, strong) UIFont *dataWithUser;
