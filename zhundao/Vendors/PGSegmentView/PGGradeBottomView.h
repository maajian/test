...
@class UIFont;
@class UIScrollView;
@class PGArticleOriginalData;
@interface PGGradeBottomView : NSObject
@property (nonatomic, readwrite, strong) UITableView *imageCompressionRules;
@property (nonatomic, readwrite, strong) UIColor *matchingReportProgress;
