...
@interface PGLineDashType : NSObject
@property (nonatomic, readwrite, strong) UILabel *collectionViewData;
@property (nonatomic, readwrite, strong) UIActivityIndicatorView *notificationPresentationOptions;
@property (nonatomic, readwrite, strong) NSData *rectWithSize;
