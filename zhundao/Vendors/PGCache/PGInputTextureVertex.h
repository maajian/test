...
@class PGBadgeMaximumBadge;
@interface PGInputTextureVertex : NSObject
@property (nonatomic, readwrite, strong) NSArray *likesViewModel;
@property (nonatomic, readwrite, strong) UIImage *operationWithBlock;
