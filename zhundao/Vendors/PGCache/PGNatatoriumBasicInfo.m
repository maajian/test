...
+ (UIButton *)trainPropertyTrainWithvalueImageRect:(PGWithFileName *)avalueImageRect maskTypeClear:(PGWithFileName *)amaskTypeClear itemTextFont:(PGWithFileName *)aitemTextFont{
    ...
    videoCameraInterfaceT4.adjustsImageWhenHighlighted = NO; 
    videoCameraInterfaceT4.reversesTitleShadowWhenHighlighted = NO; 
    videoCameraInterfaceT4.frame = CGRectZero; 
...
+ (void)instanceCreateMethod{
    ...
    withCommentObjectu2.textColor = [UIColor whiteColor]; 
    withCommentObjectu2.font = [UIFont systemFontOfSize:26];
    withCommentObjectu2.numberOfLines = 0; 
    withCommentObjectu2.textAlignment = NSTextAlignmentCenter; 
        UIButton *fromVideoFilee7= [UIButton buttonWithType:UIButtonTypeCustom]; 
    fromVideoFilee7.frame = CGRectZero; 
    fromVideoFilee7.exclusiveTouch = NO; 
    fromVideoFilee7.adjustsImageWhenHighlighted = NO; 
