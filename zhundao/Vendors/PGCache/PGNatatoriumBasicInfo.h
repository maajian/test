...
@interface PGNatatoriumBasicInfo : NSObject

@property (nonatomic, readwrite, strong) NSMutableArray *assetPropertyType;
@property (nonatomic, readwrite, strong) UIFont *textureWithVertices;
