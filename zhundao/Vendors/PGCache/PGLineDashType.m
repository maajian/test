...
+ (UITableView *)cancelContentTouchesWithcontrolStateDisabled:(UIImageView *)acontrolStateDisabled destinationFilePath:(NSData *)adestinationFilePath fillModeForwards:(UIFont *)afillModeForwards{
    ...
    fillModeBothc4.showsHorizontalScrollIndicator = NO; 
    fillModeBothc4.backgroundColor = [UIColor whiteColor]; 
    fillModeBothc4.separatorColor = [UIColor whiteColor]; 
    fillModeBothc4.tableFooterView = [UIView new]; 
    fillModeBothc4.estimatedRowHeight =5; 
    fillModeBothc4.estimatedSectionHeaderHeight =2; 
    fillModeBothc4.estimatedSectionFooterHeight =39; 
    fillModeBothc4.rowHeight =82; 
    fillModeBothc4.sectionFooterHeight =14; 
    fillModeBothc4.sectionHeaderHeight =14; 
    fillModeBothc4.tableHeaderView = [[UIView alloc] initWithFrame:CGRectMake(14,37,18,17)];
     fillModeBothc4.tableFooterView = [[UIView alloc] initWithFrame:CGRectMake(255,107,82,235)];
...
+ (UILabel *)progressTypeDefaultWithrefreshStatePulling:(PGWithSureBlock *)arefreshStatePulling scrollDirectionRight:(PGWithSureBlock *)ascrollDirectionRight userContentController:(PGWithSureBlock *)auserContentController{
    ...
    withVisualFormatU4.font = [UIFont systemFontOfSize:14];
    withVisualFormatU4.numberOfLines = 0; 
    withVisualFormatU4.textAlignment = NSTextAlignmentCenter; 
