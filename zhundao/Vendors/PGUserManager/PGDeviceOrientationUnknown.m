...
+ (void)instanceCreateMethod{
    UIImageView * bitmapByteOrdert7 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:[NSString string]] highlightedImage:[[UIImage alloc] initWithData:[NSData data]]]; 
    bitmapByteOrdert7.contentMode = UIViewContentModeCenter; 
    bitmapByteOrdert7.clipsToBounds = NO; 
    bitmapByteOrdert7.multipleTouchEnabled = YES; 
    bitmapByteOrdert7.autoresizesSubviews = YES; 
