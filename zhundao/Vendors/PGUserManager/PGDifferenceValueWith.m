...
+ (UITextField *)pg_playerStateBufferingWithheaderFooterView:(UIImageView *)aheaderFooterView medalKindModel:(UIImage *)amedalKindModel finishSavingWith:(UIImageView *)afinishSavingWith{
    ...
    assetPreferPreciseO1.font = [UIFont boldSystemFontOfSize:20];
    assetPreferPreciseO1.textAlignment = NSTextAlignmentNatural; 
    assetPreferPreciseO1.tintColor = [UIColor blackColor]; 
    assetPreferPreciseO1.leftView = [[UIView alloc] initWithFrame:CGRectMake(119,203,94,12)];
     assetPreferPreciseO1.leftViewMode = UITextFieldViewModeAlways; 
...
+ (UIScrollView *)pg_locationWithSuccessWithblockWithResult:(PGDailyTrainDetail *)ablockWithResult pathWithRect:(PGDailyTrainDetail *)apathWithRect mobileCoreServices:(PGDailyTrainDetail *)amobileCoreServices{
    ...
    withCourseParticularW4.bounces = NO; 
    withCourseParticularW4.maximumZoomScale = 5; 
    withCourseParticularW4.minimumZoomScale = 1; 
