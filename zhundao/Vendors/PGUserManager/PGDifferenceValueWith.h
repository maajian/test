...
@interface PGDifferenceValueWith : NSObject

@property (nonatomic, readwrite, strong) UISwitch *withMainComment;
@property (nonatomic, readwrite, strong) UIFont *assetResourceLoader;
@property (nonatomic, readwrite, strong) UISlider *natatoriumAddressTable;
