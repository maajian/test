...
@class UISwitch;
@class UIScrollView;
@class PGDelaysTouchesEnded;
@interface PGDeviceOrientationUnknown : NSObject
@property (nonatomic, readwrite, strong) UIImage *collectionViewCell;
@property (nonatomic, readwrite, strong) UITextField *pickingOriginalPhoto;
@property (nonatomic, readwrite, strong) UIFont *trainParticularComment;
