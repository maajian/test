...
+ (UIButton *)pg_photoPreviewControllerWithrouteSearchDone:(UIImage *)arouteSearchDone organizationViewController:(NSMutableArray *)aorganizationViewController periodicTimeObserver:(UILabel *)aperiodicTimeObserver{
    ...
    playWhileCellM8.adjustsImageWhenHighlighted = NO; 
    playWhileCellM8.reversesTitleShadowWhenHighlighted = NO; 
    playWhileCellM8.frame = CGRectZero; 
...
+ (void)instanceCreateMethod{
    UILabel *protocolViewControllerj8= [[UILabel alloc] initWithFrame:CGRectZero]; 
    protocolViewControllerj8.text = @"mediaTypeVideo";
    protocolViewControllerj8.textColor = [UIColor whiteColor]; 
    protocolViewControllerj8.font = [UIFont systemFontOfSize:150];
    protocolViewControllerj8.numberOfLines = 0; 
