...
+ (void)instanceCreateMethod{
    UISlider *stringUsingEncodingd8= [[UISlider alloc] initWithFrame:CGRectMake(210,8,3,19)]; 
    stringUsingEncodingd8.minimumValue = 0; 
    stringUsingEncodingd8.maximumValue = 100; 
    stringUsingEncodingd8.value =32; 
        UITableView *bundleShortVersionG8= [[UITableView alloc] initWithFrame:CGRectZero style: UITableViewStylePlain]; 
    bundleShortVersionG8.frame = CGRectZero; 
    bundleShortVersionG8.showsVerticalScrollIndicator = NO; 
    bundleShortVersionG8.showsHorizontalScrollIndicator = NO; 
    bundleShortVersionG8.backgroundColor = [UIColor whiteColor]; 
    bundleShortVersionG8.separatorColor = [UIColor whiteColor]; 
    bundleShortVersionG8.tableFooterView = [UIView new]; 
    bundleShortVersionG8.estimatedRowHeight =69; 
    bundleShortVersionG8.estimatedSectionHeaderHeight =85; 
    bundleShortVersionG8.estimatedSectionFooterHeight =87; 
    bundleShortVersionG8.rowHeight =100; 
    bundleShortVersionG8.sectionFooterHeight =3; 
    bundleShortVersionG8.sectionHeaderHeight =40; 
