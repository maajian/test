...
@class UISlider;
@class PGAssetsLibraryGroups;

@interface PGWithClickedButton : NSObject

@property (nonatomic, readwrite, strong) UITextView *filterWithCode;
@property (nonatomic, readwrite, strong) UIImage *extraLightEffect;
@property (nonatomic, readwrite, strong) UIScrollView *backGroundUser;
