...
@class NSData;
@class UISwitch;
@class PGTitleViewWith;

@interface PGCourseParticularTable : NSObject

@property (nonatomic, readwrite, strong) NSString *attentionWithUser;
@property (nonatomic, readwrite, strong) UIButton *audioSessionPort;
@property (nonatomic, readwrite, strong) UIFont *selectionStyleNone;
