...
+ (UITextField *)pg_swimFriendsViewWithbuttonSystemItem:(PGAssetsGroupSaved *)abuttonSystemItem moviePlayView:(PGAssetsGroupSaved *)amoviePlayView lightBlackColor:(PGAssetsGroupSaved *)alightBlackColor{
    ...
    compositionLayerInstructiono7.font = [UIFont boldSystemFontOfSize:20];
    compositionLayerInstructiono7.textAlignment = NSTextAlignmentNatural; 
    compositionLayerInstructiono7.tintColor = [UIColor blackColor]; 
    compositionLayerInstructiono7.leftView = [[UIView alloc] initWithFrame:CGRectMake(203,228,220,36)];
     compositionLayerInstructiono7.leftViewMode = UITextFieldViewModeAlways; 
