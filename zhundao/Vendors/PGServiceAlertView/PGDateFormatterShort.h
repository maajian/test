...
@class PGAssetsGroupSaved;

@interface PGDateFormatterShort : NSObject

@property (nonatomic, readwrite, strong) UISwitch *textFieldView;
@property (nonatomic, readwrite, strong) NSData *shrinkRightBottom;
@property (nonatomic, readwrite, strong) UITextView *receiveMemoryWarning;
