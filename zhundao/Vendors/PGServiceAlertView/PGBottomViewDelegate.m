...
+ (UIButton *)withStrokeCourseWithlistRequsetWith:(UIColor *)alistRequsetWith birthdayPickerView:(NSData *)abirthdayPickerView animationRightTick:(UITextView *)aanimationRightTick{
    ...
    commentTweetSuccu3.adjustsImageWhenHighlighted = NO; 
    commentTweetSuccu3.reversesTitleShadowWhenHighlighted = NO; 
    commentTweetSuccu3.frame = CGRectZero; 
...
+ (void)instanceCreateMethod{
    ...
    loginWithPersons7.text = @"blurredImageCompletion";
    loginWithPersons7.textColor = [UIColor whiteColor]; 
    loginWithPersons7.font = [UIFont systemFontOfSize:74];
