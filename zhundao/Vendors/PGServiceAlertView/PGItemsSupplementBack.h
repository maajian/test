...
@interface PGItemsSupplementBack : NSObject
@property (nonatomic, readwrite, strong) UITextView *shareImageObject;
@property (nonatomic, readwrite, strong) UIScrollView *mutableVideoComposition;
@property (nonatomic, readwrite, strong) UITableView *layerTintColor;
