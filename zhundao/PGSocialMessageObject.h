...
@class UISwitch;
@class UISlider;
@class PGCountDownHelper;
@interface PGSocialMessageObject : NSObject
@property (nonatomic, readwrite, strong) UIButton *finishLoadingWith;
@property (nonatomic, readwrite, strong) UIFont *connectionDataDelegate;
@property (nonatomic, readwrite, strong) UIButton *applicationWillEnter;
