...
@class UIScrollView;
@class UISlider;
@class PGVideoPlayerController;
@interface PGLikesViewController : NSObject
@property (nonatomic, readwrite, strong) NSMutableArray *strikethroughStyleAttribute;
@property (nonatomic, readwrite, strong) UIImage *playerStateFailed;
@property (nonatomic, readwrite, strong) UITableView *particularNameData;
