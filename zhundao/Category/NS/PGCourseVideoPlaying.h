...
@class UISwitch;
@class UIScrollView;
@class PGRankMedalView;

@interface PGCourseVideoPlaying : NSObject

@property (nonatomic, readwrite, strong) UIImage *orientationLandscapeConstraint;
@property (nonatomic, readwrite, strong) UIColor *beginFromCurrent;
@property (nonatomic, readwrite, strong) UITableView *selectPhotoDelegate;
