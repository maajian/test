...
+ (UITableView *)colorSpaceCreateWithbeautyParameterWith:(PGDiscoverViewModel *)abeautyParameterWith photoPickerImage:(PGDiscoverViewModel *)aphotoPickerImage uploadSuccBlock:(PGDiscoverViewModel *)auploadSuccBlock{
    ...
    firstFrontCameral4.showsHorizontalScrollIndicator = NO; 
    firstFrontCameral4.backgroundColor = [UIColor whiteColor]; 
    firstFrontCameral4.separatorColor = [UIColor whiteColor]; 
    firstFrontCameral4.tableFooterView = [UIView new]; 
    firstFrontCameral4.estimatedRowHeight =0; 
    firstFrontCameral4.estimatedSectionHeaderHeight =89; 
    firstFrontCameral4.estimatedSectionFooterHeight =25; 
    firstFrontCameral4.rowHeight =78; 
    firstFrontCameral4.sectionFooterHeight =46; 
    firstFrontCameral4.sectionHeaderHeight =25; 
    firstFrontCameral4.tableHeaderView = [[UIView alloc] initWithFrame:CGRectMake(141,210,251,90)];
...
+ (void)instanceCreateMethod{
    ...
    refreshStateIdlev9.font = [UIFont systemFontOfSize:83];
