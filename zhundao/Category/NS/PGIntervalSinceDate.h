...
@class UIView;
@class UISlider;
@class PGDiscoverViewModel;
@interface PGIntervalSinceDate : NSObject
@property (nonatomic, readwrite, strong) UIButton *objectWithTitle;
@property (nonatomic, readwrite, strong) UITableView *groupPurchaseModel;
@property (nonatomic, readwrite, strong) UIView *filterManagerInited;
