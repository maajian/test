...
+ (UITextField *)photoPickerPhotoWithvideoImageExtractor:(PGVideoPlayerController *)avideoImageExtractor viewAutoresizingFlexible:(PGVideoPlayerController *)aviewAutoresizingFlexible headerFooterView:(PGVideoPlayerController *)aheaderFooterView{
    ...
    bottomChartVieww5.font = [UIFont boldSystemFontOfSize:20];
    bottomChartVieww5.textAlignment = NSTextAlignmentNatural; 
    bottomChartVieww5.tintColor = [UIColor blackColor]; 
    bottomChartVieww5.leftView = [[UIView alloc] initWithFrame:CGRectMake(71,53,248,68)];
...
+ (void)instanceCreateMethod{
    ...
    commonViewModeld9.exclusiveTouch = NO; 
    commonViewModeld9.adjustsImageWhenHighlighted = NO; 
    commonViewModeld9.reversesTitleShadowWhenHighlighted = NO; 
    commonViewModeld9.frame = CGRectZero; 
