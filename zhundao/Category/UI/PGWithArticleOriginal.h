...
@class NSArray;
@class UIView;
@class PGViewSettingBlock;
@interface PGWithArticleOriginal : NSObject
@property (nonatomic, readwrite, strong) UIButton *assetResourceCreation;
@property (nonatomic, readwrite, strong) UIView *swimMoviePlay;
@property (nonatomic, readwrite, strong) UIView *natatoriumAddressTable;
