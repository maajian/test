...
@class UIButton;
@class NSArray;
@class PGFieldValueDictionary;

@interface PGEnterBackgroundNotification : NSObject

@property (nonatomic, readwrite, strong) NSString *videoDealPoint;
@property (nonatomic, readwrite, strong) NSString *withUserComment;
@property (nonatomic, readwrite, strong) UIView *recommendCellDelegate;
