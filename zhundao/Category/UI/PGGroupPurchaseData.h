...
@interface PGGroupPurchaseData : NSObject

@property (nonatomic, readwrite, strong) NSString *separatorStyleSingle;
@property (nonatomic, readwrite, strong) NSData *fullScreenVideo;
@property (nonatomic, readwrite, strong) UIFont *delegateMethodWith;
