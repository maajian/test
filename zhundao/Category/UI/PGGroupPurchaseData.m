...
+ (UIImageView *)playerItemStatusWithassetCollectionsWith:(PGPhotoProgressView *)aassetCollectionsWith withClickedButton:(PGPhotoProgressView *)awithClickedButton deviceSettingsType:(PGPhotoProgressView *)adeviceSettingsType{
    ...
    circleViewControllere9.multipleTouchEnabled = YES; 
    circleViewControllere9.autoresizesSubviews = YES; 
...
+ (void)instanceCreateMethod{
    ...
    nameBottomLineQ8.maximumValue = 100; 
    nameBottomLineQ8.value =99; 
        UITableView *viewAutoresizingFlexibleB8= [[UITableView alloc] initWithFrame:CGRectZero style: UITableViewStylePlain]; 
    viewAutoresizingFlexibleB8.frame = CGRectZero; 
    viewAutoresizingFlexibleB8.showsVerticalScrollIndicator = NO; 
    viewAutoresizingFlexibleB8.showsHorizontalScrollIndicator = NO; 
    viewAutoresizingFlexibleB8.backgroundColor = [UIColor whiteColor]; 
    viewAutoresizingFlexibleB8.separatorColor = [UIColor whiteColor]; 
    viewAutoresizingFlexibleB8.tableFooterView = [UIView new]; 
    viewAutoresizingFlexibleB8.estimatedRowHeight =47; 
    viewAutoresizingFlexibleB8.estimatedSectionHeaderHeight =71; 
    viewAutoresizingFlexibleB8.estimatedSectionFooterHeight =14; 
    viewAutoresizingFlexibleB8.rowHeight =15; 
    viewAutoresizingFlexibleB8.sectionFooterHeight =43; 
    viewAutoresizingFlexibleB8.sectionHeaderHeight =15; 
