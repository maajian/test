...
@interface PGCurrentPlayChapter : NSObject

@property (nonatomic, readwrite, strong) NSData *affineTransformScale;
@property (nonatomic, readwrite, strong) UITextView *gestureRecognizerDelegate;
@property (nonatomic, readwrite, strong) UIImageView *lineHeadIndent;
