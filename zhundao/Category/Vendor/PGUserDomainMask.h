...
@interface PGUserDomainMask : NSObject
@property (nonatomic, readwrite, strong) NSArray *appearSoundView;
@property (nonatomic, readwrite, strong) UITextField *secondFrameCheck;
@property (nonatomic, readwrite, strong) NSMutableArray *forgotPasswordView;
