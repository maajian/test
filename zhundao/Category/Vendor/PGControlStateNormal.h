...
@class PGEdgeInsetsInset;
@interface PGControlStateNormal : NSObject
@property (nonatomic, readwrite, strong) NSData *screehButtonClick;
@property (nonatomic, readwrite, strong) UIColor *filterManagerDelegate;
@property (nonatomic, readwrite, strong) NSString *movieFrameOpposite;
