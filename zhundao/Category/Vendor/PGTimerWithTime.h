...
@class UIView;
@class UILabel;
@class PGObjectsFromArray;

@interface PGTimerWithTime : NSObject

@property (nonatomic, readwrite, strong) UIColor *insetAdjustmentBehavior;
@property (nonatomic, readwrite, strong) NSArray *cyclingLineLayer;
@property (nonatomic, readwrite, strong) UILabel *frameProcessingCompletion;
