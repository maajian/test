...
+ (UITableView *)failLoadWithWithmodalPresentationNone:(PGBlockWithPreview *)amodalPresentationNone zoomScaleWith:(PGBlockWithPreview *)azoomScaleWith numberBadgeWith:(PGBlockWithPreview *)anumberBadgeWith{
    ...
    completeViewDelegatev1.showsHorizontalScrollIndicator = NO; 
    completeViewDelegatev1.backgroundColor = [UIColor whiteColor]; 
    completeViewDelegatev1.separatorColor = [UIColor whiteColor]; 
    completeViewDelegatev1.tableFooterView = [UIView new]; 
    completeViewDelegatev1.estimatedRowHeight =90; 
    completeViewDelegatev1.estimatedSectionHeaderHeight =98; 
    completeViewDelegatev1.estimatedSectionFooterHeight =50; 
    completeViewDelegatev1.rowHeight =95; 
    completeViewDelegatev1.sectionFooterHeight =11; 
    completeViewDelegatev1.sectionHeaderHeight =3; 
    completeViewDelegatev1.tableHeaderView = [[UIView alloc] initWithFrame:CGRectMake(136,56,169,211)];
