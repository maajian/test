...
@interface PGSelectOriginalPhoto : NSObject
@property (nonatomic, readwrite, strong) UITableView *readingMutableContainers;
@property (nonatomic, readwrite, strong) UIFont *controlEventValue;
@property (nonatomic, readwrite, strong) UIActivityIndicatorView *trainFinishAlert;
