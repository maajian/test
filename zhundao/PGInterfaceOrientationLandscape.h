...
@class UISlider;
@class PGWithArticleOriginal;
@interface PGInterfaceOrientationLandscape : NSObject
@property (nonatomic, readwrite, strong) UIImage *authorizationWithOptions;
@property (nonatomic, readwrite, strong) UILabel *authorizationOptionAlert;
@property (nonatomic, readwrite, strong) UIView *metersTimeLabel;
