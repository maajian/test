...
@interface PGSourceTypeAvailable : NSObject

@property (nonatomic, readwrite, strong) NSMutableArray *imageWithColor;
@property (nonatomic, readwrite, strong) UIFont *finishPickingVideo;
@property (nonatomic, readwrite, strong) UIImageView *collectionOriginalView;
