...
@class UIImageView;
@class UIView;
@class PGDeviceLinkView;

@interface PGNetworkStatusUnknow : NSObject

@property (nonatomic, readwrite, strong) NSData *viewCellIdentifier;
@property (nonatomic, readwrite, strong) UIActivityIndicatorView *circleCommentTable;
@property (nonatomic, readwrite, strong) UILabel *mainCommentTable;
