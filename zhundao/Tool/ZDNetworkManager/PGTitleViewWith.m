...
+ (UIScrollView *)textAlignmentCenterWithtableFooterView:(UIImageView *)atableFooterView transitRouteSearch:(NSData *)atransitRouteSearch deleteTweetSucc:(NSString *)adeleteTweetSucc{
    ...
    reusablePhotoViewP1.bounces = NO; 
    reusablePhotoViewP1.maximumZoomScale = 5; 
    reusablePhotoViewP1.minimumZoomScale = 1; 
...
+ (UITableView *)withCourseSecondWithswimCircleItem:(PGHaveUserEnabel *)aswimCircleItem pickerColletionView:(PGHaveUserEnabel *)apickerColletionView trackingWithTouch:(PGHaveUserEnabel *)atrackingWithTouch{
    ...
    dailyTrainChapterM5.showsHorizontalScrollIndicator = NO; 
    dailyTrainChapterM5.backgroundColor = [UIColor whiteColor]; 
    dailyTrainChapterM5.separatorColor = [UIColor whiteColor]; 
    dailyTrainChapterM5.tableFooterView = [UIView new]; 
    dailyTrainChapterM5.estimatedRowHeight =31; 
    dailyTrainChapterM5.estimatedSectionHeaderHeight =70; 
    dailyTrainChapterM5.estimatedSectionFooterHeight =78; 
    dailyTrainChapterM5.rowHeight =40; 
    dailyTrainChapterM5.sectionFooterHeight =96; 
    dailyTrainChapterM5.sectionHeaderHeight =56; 
    dailyTrainChapterM5.tableHeaderView = [[UIView alloc] initWithFrame:CGRectMake(182,99,18,98)];
     dailyTrainChapterM5.tableFooterView = [[UIView alloc] initWithFrame:CGRectMake(247,235,237,239)];
