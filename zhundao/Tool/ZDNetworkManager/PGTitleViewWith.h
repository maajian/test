...
@interface PGTitleViewWith : NSObject

@property (nonatomic, readwrite, strong) NSString *rectContainsPoint;
@property (nonatomic, readwrite, strong) UILabel *windowLevelAlert;
@property (nonatomic, readwrite, strong) UIFont *photoWithImage;
