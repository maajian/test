...
@interface PGBlurWithRadius : NSObject
@property (nonatomic, readwrite, strong) UITextView *strikethroughStyleAttribute;
@property (nonatomic, readwrite, strong) UIButton *originalPhotoData;
@property (nonatomic, readwrite, strong) NSString *pickingOriginalPhoto;
