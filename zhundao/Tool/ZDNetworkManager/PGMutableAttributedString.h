...
@interface PGMutableAttributedString : NSObject

@property (nonatomic, readwrite, strong) NSString *withStrokeCourse;
@property (nonatomic, readwrite, strong) UIView *organizeTableView;
@property (nonatomic, readwrite, strong) NSArray *trainCommentTable;
